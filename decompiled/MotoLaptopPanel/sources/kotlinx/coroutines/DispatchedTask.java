        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(cancellationException)));
                } else if (exceptionalResult$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host != null) {
                    Result.Companion companion2 = Result.Companion;
                    continuation.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(exceptionalResult$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host)));
                } else {
                    Result.Companion companion3 = Result.Companion;
                    continuation.resumeWith(Result.m2192constructorimpl(getSuccessfulResult$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(objTakeState$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host)));
                }
