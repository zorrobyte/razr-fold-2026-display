...
public class BufferedChannel implements Channel {
    ...
    final class BufferedChannelIterator implements ChannelIterator, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                ...
                cancellableContinuationImpl.resumeWith(Result.m2192constructorimpl(Boolean.FALSE));
            } else {
                Result.Companion companion2 = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(closeCause)));
            }
        }
    ...
    final /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function3 {
        ...
        @Override // kotlin.jvm.functions.Function3
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
            m2217invoke5_sEAP8((Throwable) obj, ((ChannelResult) obj2).m2227unboximpl(), (CoroutineContext) obj3);
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-5_sEAP8, reason: not valid java name */
        public final void m2217invoke5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
            th.getClass();
            coroutineContext.getClass();
            ((BufferedChannel) this.receiver).m2210onCancellationChannelResultImplDoNotCall5_sEAP8(th, obj, coroutineContext);
        }
    }
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment channelSegment, long j) {
        Object objM2238constructorimpl$default = InlineList.m2238constructorimpl$default(null, 1, null);
                    ...
                    if (state$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host != null && state$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host != BufferedChannelKt.IN_BUFFER) {
                        if (!(state$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host instanceof WaiterEB)) {
                            ...
                            if (channelSegment.casState$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(i, state$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                objM2238constructorimpl$default = InlineList.m2239plusFjFbRPM(objM2238constructorimpl$default, state$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host);
                                channelSegment.onCancelledRequest(i, true);
                                break;
                            }
                        } else {
                            if (channelSegment.casState$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(i, state$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                objM2238constructorimpl$default = InlineList.m2239plusFjFbRPM(objM2238constructorimpl$default, ((WaiterEB) state$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host).waiter);
                                channelSegment.onCancelledRequest(i, true);
                                break;
                            }
                        }
        ...
        if (objM2238constructorimpl$default != null) {
            if (!(objM2238constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) objM2238constructorimpl$default);
                return;
            }
            ArrayList arrayList = (ArrayList) objM2238constructorimpl$default;
    ...
    private final ChannelSegment findSegmentBufferEnd(long j, ChannelSegment channelSegment, long j2) {
        ...
        ChannelSegment channelSegment2 = (ChannelSegment) SegmentOrClosed.m2241getSegmentimpl(objFindSegmentInternal);
    ...
    */
    ...
    public final void m2210onCancellationChannelResultImplDoNotCall5_sEAP8(Throwable th, Object obj, CoroutineContext coroutineContext) {
        Function1 function1 = this.onUndeliveredElement;
        function1.getClass();
        Object objM2222getOrNullimpl = ChannelResult.m2222getOrNullimpl(obj);
        objM2222getOrNullimpl.getClass();
        OnUndeliveredElementKt.callUndeliveredElement(function1, objM2222getOrNullimpl, coroutineContext);
    }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m2192constructorimpl(ChannelResult.m2218boximpl(ChannelResult.Companion.m2228closedJP2dKIU(getCloseCause()))));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    private final Object onClosedSend(Object obj, Continuation continuation) {
        ...
        if (function1 == null || (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, obj, null, 2, null)) == null) {
            ...
            Result.Companion companion = Result.Companion;
            cancellableContinuationImpl.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(sendException)));
        } else {
            ExceptionsKt.addSuppressed(undeliveredElementExceptionCallUndeliveredElementCatchingException$default, getSendException());
            Result.Companion companion2 = Result.Companion;
            cancellableContinuationImpl.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(undeliveredElementExceptionCallUndeliveredElementCatchingException$default)));
        }
    ...
    public final void onClosedSendOnNoWaiterSuspend(Object obj, CancellableContinuation cancellableContinuation) {
        ...
        Throwable sendException = getSendException();
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    public final Object processResultSelectReceiveCatching(Object obj, Object obj2) {
        return ChannelResult.m2218boximpl(obj2 == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.Companion.m2228closedJP2dKIU(getCloseCause()) : ChannelResult.Companion.m2230successJP2dKIU(obj2));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static /* synthetic */ java.lang.Object m2211receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel r13, kotlin.coroutines.Continuation r14) {
        /*
        ...
        L1a:
            ...
            java.lang.Object r13 = r14.m2227unboximpl()
            return r13
        L31:
        ...
        L46:
            ...
            java.lang.Object r13 = r14.m2228closedJP2dKIU(r13)
            return r13
        L57:
        ...
        L9b:
            ...
            r6.label = r2
            r2 = r8
            java.lang.Object r13 = r1.m2212receiveCatchingOnNoWaiterSuspendGKJJFZk(r2, r3, r4, r6)
            if (r13 != r0) goto Lab
            return r0
        Lab:
            return r13
        Lac:
            r8.cleanPrev()
            kotlinx.coroutines.channels.ChannelResult$Companion r14 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r13 = r14.m2230successJP2dKIU(r13)
            return r13
        Lb6:
            java.lang.IllegalStateException r13 = new java.lang.IllegalStateException
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m2211receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m2212receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment r11, int r12, long r13, kotlin.coroutines.Continuation r15) {
        /*
            Method dump skipped, instruction units count: 308
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m2212receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final void registerSelectForReceive(SelectInstance selectInstance, Object obj) {
        ...
        while (!this.isClosedForReceive()) {
            ...
            Object objUpdateCellReceive = bufferedChannel.updateCellReceive(channelSegment, i2, andIncrement, selectInstance2);
            channelSegment2 = channelSegment;
            if (objUpdateCellReceive == BufferedChannelKt.SUSPEND) {
    ...
    */
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof CancellableContinuation) {
            ...
            Result.Companion companion = Result.Companion;
            continuation.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
        } else if (waiter instanceof ReceiveCatching) {
            CancellableContinuationImpl cancellableContinuationImpl = ((ReceiveCatching) waiter).cont;
            Result.Companion companion2 = Result.Companion;
            cancellableContinuationImpl.resumeWith(Result.m2192constructorimpl(ChannelResult.m2218boximpl(ChannelResult.Companion.m2228closedJP2dKIU(getCloseCause()))));
    ...
    */
    ...
    private final boolean tryResumeReceiver(Object obj, Object obj2) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM2218boximpl = ChannelResult.m2218boximpl(ChannelResult.Companion.m2230successJP2dKIU(obj2));
            Function1 function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM2218boximpl, (Function3) (function1 != null ? bindCancellationFunResult(function1) : null));
        }
    ...
    public Object mo2213receiveCatchingJP2dKIU(Continuation continuation) {
        return m2211receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    */
    ...
    public Object mo2214tryReceivePtdJZtk() {
        ...
        if (isClosedForReceive0(value2)) {
            return ChannelResult.Companion.m2228closedJP2dKIU(getCloseCause());
        }
        if (value >= (value2 & 1152921504606846975L)) {
            return ChannelResult.Companion.m2229failurePtdJZtk();
        }
        ...
        while (!this.isClosedForReceive()) {
            ...
            if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                ...
                channelSegment.cleanPrev();
                return ChannelResult.Companion.m2230successJP2dKIU(objUpdateCellReceive);
            }
            if (andIncrement < bufferedChannel.getSendersCounter$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host()) {
                channelSegment.cleanPrev();
            }
        ...
        return ChannelResult.Companion.m2228closedJP2dKIU(this.getCloseCause());
    }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.Companion.m2228closedJP2dKIU(this.getSendException());
                }
            } else {
                obj2 = obj;
                i = i3;
            ...
            if (iUpdateCellSend == 2) {
                if (zIsClosedForSend0) {
                    ...
                    return ChannelResult.Companion.m2228closedJP2dKIU(bufferedChannel2.getSendException());
                }
    ...
    protected final Object m2216trySendDropOldestJP2dKIU(Object obj) {
        ChannelSegment channelSegmentFindSegmentSend;
        int i;
        BufferedChannel bufferedChannel;
