...
public class EllipseContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public EllipseContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, CircleShape circleShape) {
        ...
        BaseKeyframeAnimation baseKeyframeAnimationCreateAnimation = circleShape.getSize().createAnimation();
        this.sizeAnimation = baseKeyframeAnimationCreateAnimation;
        BaseKeyframeAnimation baseKeyframeAnimationCreateAnimation2 = circleShape.getPosition().createAnimation();
