...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
                ...
                if (lottieDrawable.mainThreadHandler == null) {
                    ...
                    lottieDrawable.invalidateSelfRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda17
                        ...
                        public final void run() {
                            LottieDrawable.m2064$r8$lambda$qVOJAuCYN_sh5dMlsJC4mC_iE(this.f$0);
                        }
                    };
                }
    ...
    /* JADX INFO: renamed from: $r8$lambda$qVOJAuCYN-_sh5dM-lsJC4mC_iE, reason: not valid java name */
    public static /* synthetic */ void m2064$r8$lambda$qVOJAuCYN_sh5dMlsJC4mC_iE(LottieDrawable lottieDrawable) {
    ...
    public void addValueCallback(final KeyPath keyPath, final Object obj, final LottieValueCallback lottieValueCallback) {
        ...
        if (keyPath == KeyPath.COMPOSITION) {
            ...
            for (int i = 0; i < listResolveKeyPath.size(); i++) {
                ((KeyPath) listResolveKeyPath.get(i)).getResolvedElement().addValueCallback(obj, lottieValueCallback);
            }
