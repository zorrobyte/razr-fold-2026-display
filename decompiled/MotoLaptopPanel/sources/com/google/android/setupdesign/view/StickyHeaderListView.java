...
public class StickyHeaderListView extends ListView {
    ...
    private void init(AttributeSet attributeSet, int i) {
        ...
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(R$styleable.SudStickyHeaderListView_sudHeader, 0);
        this.shouldApplyAdditionalMargin = typedArrayObtainStyledAttributes.getBoolean(R$styleable.SudStickyHeaderListView_sudShouldApplyAdditionalMargin, false);
        if (resourceId != 0) {
