...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            int height = (CollapsingToolbarLayout.this.getHeight() - CollapsingToolbarLayout.this.getMinimumHeight()) - systemWindowInsetTop;
            float f = height;
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i12)) {
            collapsingTextHelper.setExpandedMaxLines(typedArrayObtainStyledAttributes.getInt(i12, 1));
        }
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.screenOrientation != configuration.orientation && this.extraMultilineHeightEnabled && this.collapsingTextHelper.getExpansionFraction() == 1.0f) {
            ViewParent parent = getParent();
            if (parent instanceof AppBarLayout) {
                AppBarLayout appBarLayout = (AppBarLayout) parent;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.extraMultilineHeightEnabled || this.collapsingTextHelper.getExpandedMaxLines() <= 1) {
            ...
            if (expandedLineCount > 1) {
                collapsingToolbarLayout.extraMultilineHeight = Math.round(collapsingToolbarLayout.collapsingTextHelper.getExpandedTextFullSingleLineHeight()) * (expandedLineCount - 1);
                ...
                collapsingToolbarLayout.extraMultilineHeight = 0;
            }
        }
