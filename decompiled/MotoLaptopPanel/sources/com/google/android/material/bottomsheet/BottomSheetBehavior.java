...
public class BottomSheetBehavior extends CoordinatorLayout.Behavior {
    ...
    public class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.fitToContents = parcel.readInt() == BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW ? BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW : false;
            this.hideable = parcel.readInt() == BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW ? BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW : false;
            this.skipCollapsed = parcel.readInt() == BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW ? BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW : false;
        }
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.5
            ...
            public void onViewDragStateChanged(int i) {
                if (i == BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW && BottomSheetBehavior.this.draggable) {
                    BottomSheetBehavior.this.setStateInternal(BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW);
                }
            }
            ...
            */
            ...
            public boolean tryCaptureView(View view, int i) {
                ...
                if (i2 == BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW || bottomSheetBehavior.touchingScrollingChild) {
                    return false;
                }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.5
            ...
            public void onViewDragStateChanged(int i2) {
                if (i2 == BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW && BottomSheetBehavior.this.draggable) {
                    BottomSheetBehavior.this.setStateInternal(BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW);
                }
            }
            ...
            */
            ...
            public boolean tryCaptureView(View view, int i2) {
                ...
                if (i22 == BottomSheetBehavior.VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW || bottomSheetBehavior.touchingScrollingChild) {
                    return false;
                }
    ...
    private float calculateInterpolationWithCornersRemoved() {
        ...
        return Math.max(calculateCornerInterpolation(this.materialShapeDrawable.getTopLeftCornerResolvedSize(), rootWindowInsets.getRoundedCorner(0)), calculateCornerInterpolation(this.materialShapeDrawable.getTopRightCornerResolvedSize(), rootWindowInsets.getRoundedCorner(VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW)));
    }
    ...
    private boolean isAtTopOfScreen() {
        ...
        if (weakReference != null && weakReference.get() != null) {
            ...
            if (iArr[VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW] == 0) {
                return true;
            }
        }
        return false;
    ...
    private void restoreOptionalState(SavedState savedState) {
        ...
        if (i == -1 || (i & VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW) == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW) {
    ...
    private boolean shouldHandleDraggingWithHelper() {
        if (this.viewDragHelper != null) {
            return this.draggable || this.state == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW;
        }
        return false;
    }
    ...
    private void updateAccessibilityActions() {
        ...
        if (weakReference2 != null) {
            updateAccessibilityActions((View) weakReference2.get(), VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW);
        }
    }
    ...
    private void updateImportantForAccessibility(boolean z) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i += VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW) {
    ...
    void dispatchOnSlide(int i) {
        ...
        MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(this.callbacks.get(0));
        throw null;
    }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, View view, MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            this.ignoreEvents = (this.activePointerId != -1 || coordinatorLayout.isPointInChildBounds(view, x, this.initialY)) ? false : VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW;
        } else if (actionMasked == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW || actionMasked == 3) {
        ...
        return (actionMasked != 2 || view3 == null || this.ignoreEvents || this.state == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW || coordinatorLayout.isPointInChildBounds(view3, (int) motionEvent.getX(), (int) motionEvent.getY()) || this.viewDragHelper == null || (i = this.initialY) == -1 || Math.abs(((float) i) - motionEvent.getY()) <= ((float) this.viewDragHelper.getTouchSlop())) ? false : true;
    }
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (this.viewRef == null) {
            ...
            if (view.getImportantForAccessibility() == 0) {
                view.setImportantForAccessibility(VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW);
            }
        }
        if (this.viewDragHelper == null) {
        ...
        } else if (i6 == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW || i6 == 2) {
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, View view, View view2, int i, int i2, int[] iArr, int i3) {
        if (i3 == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW) {
            return;
        }
        WeakReference weakReference = this.nestedScrollingChildRef;
        ...
        if (!isNestedScrollingCheckEnabled() || view2 == view3) {
            ...
            int i4 = top - i2;
            if (i2 > 0) {
                if (!this.nestedScrolled && !this.draggableOnNestedScroll && view2 == view3 && view2.canScrollVertically(VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW)) {
                    this.draggableOnNestedScrollLastDragIgnored = true;
                    return;
                }
                if (i4 < getExpandedOffset()) {
                    int expandedOffset = top - getExpandedOffset();
                    iArr[VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW] = expandedOffset;
                    ...
                    iArr[VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW] = i2;
                    ViewCompat.offsetTopAndBottom(view, -i2);
                    setStateInternal(VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW);
                }
            } else if (i2 < 0) {
                ...
                if (!zCanScrollVertically) {
                    if (i4 > this.collapsedOffset && !canBeHiddenByDragging()) {
                        ...
                        iArr[VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW] = i5;
    ...
    public void onRestoreInstanceState(CoordinatorLayout coordinatorLayout, View view, Parcelable parcelable) {
        ...
        if (i == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW || i == 2) {
            this.state = 4;
            this.lastStableState = 4;
        } else {
            this.state = i;
    ...
    */
    ...
    public boolean onTouchEvent(CoordinatorLayout coordinatorLayout, View view, MotionEvent motionEvent) {
        ...
        int actionMasked = motionEvent.getActionMasked();
        if (this.state == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW && actionMasked == 0) {
            return true;
        }
        ...
        return this.ignoreEvents ^ VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW;
    }
    ...
    public void setState(int i) {
        if (i == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW || i == 2) {
            ...
            sb.append("STATE_");
            sb.append(i == VIEW_INDEX_ACCESSIBILITY_DELEGATE_VIEW ? "DRAGGING" : "SETTLING");
