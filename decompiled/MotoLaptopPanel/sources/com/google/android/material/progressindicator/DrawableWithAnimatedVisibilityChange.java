    ...
    float getPhaseFraction() {
        ...
        if (this.baseSpec.hasWavyEffect(isDeterminateDrawable()) && this.baseSpec.waveSpeed != 0) {
            ...
            if (systemAnimatorDurationScale > 0.0f) {
                float fCurrentTimeMillis = (System.currentTimeMillis() % ((long) r6)) / ((int) ((((isDeterminateDrawable() ? this.baseSpec.wavelengthDeterminate : this.baseSpec.wavelengthIndeterminate) * 1000.0f) / this.baseSpec.waveSpeed) * systemAnimatorDurationScale));
                return fCurrentTimeMillis < 0.0f ? (fCurrentTimeMillis % 1.0f) + 1.0f : fCurrentTimeMillis;
            }
        }
        return 0.0f;
    }
