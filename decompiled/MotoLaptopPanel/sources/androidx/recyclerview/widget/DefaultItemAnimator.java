    ...
    public void runPendingAnimations() {
        ...
        if (!zIsEmpty2) {
            ...
            if (zIsEmpty) {
                ...
                ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList2.get(0)).holder.itemView, runnable, getRemoveDuration());
            }
        }
        if (!zIsEmpty3) {
            ...
            Runnable runnable2 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.2
                ...
                public void run() {
                    ...
                    while (i2 < size2) {
                        ...
                        i2++;
                        DefaultItemAnimator.this.animateChangeImpl((ChangeInfo) obj2);
                    }
                    arrayList3.clear();
        ...
        Runnable runnable3 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.3
            ...
            public void run() {
                ...
                while (i2 < size2) {
                    ...
                    i2++;
                    DefaultItemAnimator.this.animateAddImpl((RecyclerView.ViewHolder) obj2);
                }
                arrayList4.clear();
        ...
        if (zIsEmpty && zIsEmpty2 && zIsEmpty3) {
            ...
            ViewCompat.postOnAnimationDelayed(((RecyclerView.ViewHolder) arrayList4.get(0)).itemView, runnable3, (!zIsEmpty ? getRemoveDuration() : 0L) + Math.max(!zIsEmpty2 ? getMoveDuration() : 0L, zIsEmpty3 ? 0L : getChangeDuration()));
        }
    }
}
