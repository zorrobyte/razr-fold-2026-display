...
public abstract class ShapesKt {
    ...
    private static final float[] starVerticesFromNumVerts(int i, float f, float f2, float f3, float f4) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            float f5 = i;
            long jM1995radialToCartesianL6JJ3z0$default = Utils.m1995radialToCartesianL6JJ3z0$default(f, (Utils.getFloatPi() / f5) * 2 * i3, 0L, 4, null);
            fArr[i2] = PointKt.m1983getXDnnuFBc(jM1995radialToCartesianL6JJ3z0$default) + f3;
            fArr[i2 + 1] = PointKt.m1984getYDnnuFBc(jM1995radialToCartesianL6JJ3z0$default) + f4;
            long jM1995radialToCartesianL6JJ3z0$default2 = Utils.m1995radialToCartesianL6JJ3z0$default(f2, (Utils.getFloatPi() / f5) * ((i3 * 2) + 1), 0L, 4, null);
            int i4 = i2 + 3;
            fArr[i2 + 2] = PointKt.m1983getXDnnuFBc(jM1995radialToCartesianL6JJ3z0$default2) + f3;
            i2 += 4;
            fArr[i4] = PointKt.m1984getYDnnuFBc(jM1995radialToCartesianL6JJ3z0$default2) + f4;
        }
        return fArr;
    }
}
