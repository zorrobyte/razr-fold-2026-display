...
public abstract class CollectionInfo_androidKt {
    private static final boolean calculateIfHorizontallyStacked(List list) {
        ...
        if (list.size() <= 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayList.add(Offset.m751boximpl(Offset.m752constructorimpl((((long) Float.floatToRawIntBits(Math.abs(Float.intBitsToFloat((int) (semanticsNode2.getBoundsInRoot().m772getCenterF1C5BW0() >> 32)) - Float.intBitsToFloat((int) (semanticsNode.getBoundsInRoot().m772getCenterF1C5BW0() >> 32))))) << 32) | (((long) Float.floatToRawIntBits(Math.abs(Float.intBitsToFloat((int) (semanticsNode2.getBoundsInRoot().m772getCenterF1C5BW0() & 4294967295L)) - Float.intBitsToFloat((int) (semanticsNode.getBoundsInRoot().m772getCenterF1C5BW0() & 4294967295L))))) & 4294967295L))));
                obj = obj2;
            }
            listEmptyList = arrayList;
        }
        if (listEmptyList.size() == 1) {
            jM767unboximpl = ((Offset) CollectionsKt.first(listEmptyList)).m767unboximpl();
        } else {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m751boximpl(Offset.m764plusMKHz9U(((Offset) objFirst).m767unboximpl(), ((Offset) listEmptyList.get(i2)).m767unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            jM767unboximpl = ((Offset) objFirst).m767unboximpl();
        }
        return Float.intBitsToFloat((int) (4294967295L & jM767unboximpl)) < Float.intBitsToFloat((int) (jM767unboximpl >> 32));
    }
    ...
    public static final void setCollectionInfo(SemanticsNode semanticsNode, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(SemanticsConfigurationKt.getOrNull(config, semanticsProperties.getCollectionInfo()));
        ArrayList arrayList = new ArrayList();
    ...
    public static final void setCollectionItemInfo(SemanticsNode semanticsNode, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        SemanticsConfiguration config = semanticsNode.getConfig();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
        MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(SemanticsConfigurationKt.getOrNull(config, semanticsProperties.getCollectionItemInfo()));
        SemanticsNode parent = semanticsNode.getParent();
        if (parent == null || SemanticsConfigurationKt.getOrNull(parent.getConfig(), semanticsProperties.getSelectableGroup()) == null) {
            return;
        }
        MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(SemanticsConfigurationKt.getOrNull(parent.getConfig(), semanticsProperties.getCollectionInfo()));
