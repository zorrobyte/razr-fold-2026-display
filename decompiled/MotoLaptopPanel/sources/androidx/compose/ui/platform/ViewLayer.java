...
public final class ViewLayer extends View implements OwnedLayer {
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function2 function2, Function0 function0) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m1017getCenterSzJe1aQ();
    ...
    public float[] mo1406getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m1468calculateMatrixGrdbGEg(this);
    }
    ...
    public boolean mo1407isInLayerk4lQ0M(long j) {
        ...
        if (getClipToOutline()) {
            return this.outlineResolver.m1473isInOutlinek4lQ0M(j);
        }
        return true;
    }
    ...
    public long mo1408mapOffset8S9VItk(long j, boolean z) {
        return z ? this.matrixCache.m1470mapInverseR5De75A(this, j) : this.matrixCache.m1469mapR5De75A(this, j);
    }
    ...
    public void mo1409movegyyYBs(long j) {
        ...
        if (iM1905getXimpl != getLeft()) {
            offsetLeftAndRight(iM1905getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int iM1906getYimpl = IntOffset.m1906getYimpl(j);
        if (iM1906getYimpl != getTop()) {
            offsetTopAndBottom(iM1906getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public void mo1410resizeozmzZPI(long j) {
        ...
        setPivotX(TransformOrigin.m1012getPivotFractionXimpl(this.mTransformOrigin) * i);
        setPivotY(TransformOrigin.m1013getPivotFractionYimpl(this.mTransformOrigin) * i2);
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope reusableGraphicsLayerScope) {
        ...
        if ((mutatedFields$ui_release & 4096) != 0) {
            long jMo919getTransformOriginSzJe1aQ = reusableGraphicsLayerScope.mo919getTransformOriginSzJe1aQ();
            this.mTransformOrigin = jMo919getTransformOriginSzJe1aQ;
            setPivotX(TransformOrigin.m1012getPivotFractionXimpl(jMo919getTransformOriginSzJe1aQ) * getWidth());
            setPivotY(TransformOrigin.m1013getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        boolean zM1474updateS_szKao = this.outlineResolver.m1474updateS_szKao(reusableGraphicsLayerScope.getOutline$ui_release(), reusableGraphicsLayerScope.getAlpha(), z3, reusableGraphicsLayerScope.getShadowElevation(), reusableGraphicsLayerScope.m978getSizeNHjbRc());
        if (this.outlineResolver.getCacheIsDirty$ui_release()) {
            updateOutlineResolver();
        }
        boolean z4 = getManualClipPath() != null;
        if (z2 != z4 || (z4 && zM1474updateS_szKao)) {
            invalidate();
        }
        ...
        if ((mutatedFields$ui_release & 64) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m900toArgb8_81llA(reusableGraphicsLayerScope.m975getAmbientShadowColor0d7_KjU()));
        }
        if ((mutatedFields$ui_release & 128) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m900toArgb8_81llA(reusableGraphicsLayerScope.m979getSpotShadowColor0d7_KjU()));
        }
        ...
        if ((mutatedFields$ui_release & 32768) != 0 || z5) {
            int iM908getOffscreenNrFUSI = z5 ? CompositingStrategy.Companion.m908getOffscreenNrFUSI() : reusableGraphicsLayerScope.m977getCompositingStrategyNrFUSI();
            CompositingStrategy.Companion companion = CompositingStrategy.Companion;
            if (CompositingStrategy.m903equalsimpl0(iM908getOffscreenNrFUSI, companion.m908getOffscreenNrFUSI())) {
                if (z5) {
                    ...
                    paintObtainLayerPaint.mo815setBlendModes9anfk8(reusableGraphicsLayerScope.m976getBlendMode0nO6VwU());
                    paintAsFrameworkPaint = paintObtainLayerPaint.asFrameworkPaint();
                }
                setLayerType(2, paintAsFrameworkPaint);
            } else if (CompositingStrategy.m903equalsimpl0(iM908getOffscreenNrFUSI, companion.m907getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
