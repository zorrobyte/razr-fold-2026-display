...
public final class RenderNodeLayer implements OwnedLayer {
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        canvas.mo800concat58bKbWc(this.matrixCache.m1468calculateMatrixGrdbGEg(this.renderNode));
    ...
    public float[] mo1406getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m1468calculateMatrixGrdbGEg(this.renderNode);
    }
    ...
    public long mo1408mapOffset8S9VItk(long j, boolean z) {
        return z ? this.matrixCache.m1470mapInverseR5De75A(this.renderNode, j) : this.matrixCache.m1469mapR5De75A(this.renderNode, j);
    }
    ...
    public void mo1409movegyyYBs(long j) {
        ...
        if (left == iM1905getXimpl && top == iM1906getYimpl) {
            return;
        }
        if (left != iM1905getXimpl) {
            this.renderNode.offsetLeftAndRight(iM1905getXimpl - left);
        }
        if (top != iM1906getYimpl) {
            this.renderNode.offsetTopAndBottom(iM1906getYimpl - top);
        }
        triggerRepaint();
    ...
    public void mo1410resizeozmzZPI(long j) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m1012getPivotFractionXimpl(this.transformOrigin) * i);
        this.renderNode.setPivotY(TransformOrigin.m1013getPivotFractionYimpl(this.transformOrigin) * i2);
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope reusableGraphicsLayerScope) {
        ...
        if ((mutatedFields$ui_release & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m900toArgb8_81llA(reusableGraphicsLayerScope.m975getAmbientShadowColor0d7_KjU()));
        }
        if ((mutatedFields$ui_release & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m900toArgb8_81llA(reusableGraphicsLayerScope.m979getSpotShadowColor0d7_KjU()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m1012getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m1013getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((524288 & mutatedFields$ui_release) != 0) {
            this.renderNode.mo1459setBlendModes9anfk8(reusableGraphicsLayerScope.m976getBlendMode0nO6VwU());
        }
        if ((32768 & mutatedFields$ui_release) != 0) {
            this.renderNode.mo1460setCompositingStrategyaDBOjCE(reusableGraphicsLayerScope.m977getCompositingStrategyNrFUSI());
        }
