...
public final class AndroidComposeViewAccessibilityDelegateCompat extends AccessibilityDelegateCompat {
    ...
    final class Api29Impl {
        ...
        public static final void addPageActions(AccessibilityNodeInfoCompat accessibilityNodeInfoCompat, SemanticsNode semanticsNode) {
            ...
            if (AndroidComposeViewAccessibilityDelegateCompat_androidKt.enabled(semanticsNode)) {
                if (role == null ? false : Role.m1485equalsimpl0(role.m1488unboximpl(), Role.Companion.m1490getCarouselo7Vup1c())) {
                    return;
                }
    ...
    public final Rect boundsInScreen(SemanticsNodeWithAdjustedBounds semanticsNodeWithAdjustedBounds) {
        ...
        long jM1438localToScreenMKHz9U = androidComposeView.m1438localToScreenMKHz9U(Offset.m752constructorimpl((((long) Float.floatToRawIntBits(adjustedBounds.top)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32)));
        long jM1438localToScreenMKHz9U2 = this.view.m1438localToScreenMKHz9U(Offset.m752constructorimpl((((long) Float.floatToRawIntBits(adjustedBounds.right)) << 32) | (((long) Float.floatToRawIntBits(adjustedBounds.bottom)) & 4294967295L)));
        return new Rect((int) Math.floor(Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U >> 32))), (int) Math.floor(Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U & 4294967295L))), (int) Math.ceil(Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U2 >> 32))), (int) Math.ceil(Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U2 & 4294967295L))));
    }
    ...
    */
    private final boolean m1449canScrollmoWRBKg(androidx.collection.IntObjectMap r18, boolean r19, int r20, long r21) {
        /*
            r17 = this;
            r0 = r18
            r1 = r19
            ...
            long r4 = r4.m769getUnspecifiedF1C5BW0()
            boolean r4 = androidx.compose.ui.geometry.Offset.m757equalsimpl0(r2, r4)
            r5 = 0
            if (r4 != 0) goto La3
        ...
        L61:
            ...
            boolean r14 = r14.m771containsk4lQ0M(r2)
            if (r14 != 0) goto L82
            goto L91
        L82:
            ...
            android.support.v4.media.session.MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(r13)
        L91:
            long r8 = r8 >> r11
            int r12 = r12 + 1
            goto L61
        ...
        La3:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat.m1449canScrollmoWRBKg(androidx.collection.IntObjectMap, boolean, int, long):boolean");
    }
    ...
    private final int getAccessibilitySelectionEnd(SemanticsNode semanticsNode) {
        SemanticsConfiguration unmergedConfig$ui_release = semanticsNode.getUnmergedConfig$ui_release();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
        return (unmergedConfig$ui_release.contains(semanticsProperties.getContentDescription()) || !semanticsNode.getUnmergedConfig$ui_release().contains(semanticsProperties.getTextSelectionRange())) ? this.accessibilityCursorPosition : TextRange.m1593getEndimpl(((TextRange) semanticsNode.getUnmergedConfig$ui_release().get(semanticsProperties.getTextSelectionRange())).m1599unboximpl());
    }

    private final int getAccessibilitySelectionStart(SemanticsNode semanticsNode) {
        SemanticsConfiguration unmergedConfig$ui_release = semanticsNode.getUnmergedConfig$ui_release();
        SemanticsProperties semanticsProperties = SemanticsProperties.INSTANCE;
        return (unmergedConfig$ui_release.contains(semanticsProperties.getContentDescription()) || !semanticsNode.getUnmergedConfig$ui_release().contains(semanticsProperties.getTextSelectionRange())) ? this.accessibilityCursorPosition : TextRange.m1596getStartimpl(((TextRange) semanticsNode.getUnmergedConfig$ui_release().get(semanticsProperties.getTextSelectionRange())).m1599unboximpl());
    }
    ...
    */
    ...
    private final void sendSubtreeChangeAccessibilityEvents(LayoutNode layoutNode, MutableIntSet mutableIntSet) {
        ...
        if (layoutNode.isAttached() && !this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().containsKey(layoutNode)) {
            if (!layoutNode.getNodes$ui_release().m1369hasH91voCI$ui_release(NodeKind.m1404constructorimpl(8))) {
                layoutNode = AndroidComposeViewAccessibilityDelegateCompat_androidKt.findClosestParentNode(layoutNode, new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat$sendSubtreeChangeAccessibilityEvents$semanticsNode$1
                    ...
                    public final Boolean invoke(LayoutNode layoutNode2) {
                        return Boolean.valueOf(layoutNode2.getNodes$ui_release().m1369hasH91voCI$ui_release(NodeKind.m1404constructorimpl(8)));
                    }
                });
            }
    ...
    private final void sendTypeViewScrolledAccessibilityEvent(LayoutNode layoutNode) {
        if (layoutNode.isAttached() && !this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().containsKey(layoutNode)) {
            int semanticsId = layoutNode.getSemanticsId();
            MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(this.pendingHorizontalScrollEvents.get(semanticsId));
            MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(this.pendingVerticalScrollEvents.get(semanticsId));
        }
    }
    ...
    private final RectF toScreenCoords(SemanticsNode semanticsNode, androidx.compose.ui.geometry.Rect rect) {
        ...
        androidx.compose.ui.geometry.Rect rectM774translatek4lQ0M = rect.m774translatek4lQ0M(semanticsNode.m1499getPositionInRootF1C5BW0());
        androidx.compose.ui.geometry.Rect boundsInRoot = semanticsNode.getBoundsInRoot();
        androidx.compose.ui.geometry.Rect rectIntersect = rectM774translatek4lQ0M.overlaps(boundsInRoot) ? rectM774translatek4lQ0M.intersect(boundsInRoot) : null;
        if (rectIntersect == null) {
            return null;
        }
        AndroidComposeView androidComposeView = this.view;
        float left = rectIntersect.getLeft();
        long jM1438localToScreenMKHz9U = androidComposeView.m1438localToScreenMKHz9U(Offset.m752constructorimpl((((long) Float.floatToRawIntBits(rectIntersect.getTop())) & 4294967295L) | (((long) Float.floatToRawIntBits(left)) << 32)));
        AndroidComposeView androidComposeView2 = this.view;
        float right = rectIntersect.getRight();
        long jM1438localToScreenMKHz9U2 = androidComposeView2.m1438localToScreenMKHz9U(Offset.m752constructorimpl((((long) Float.floatToRawIntBits(rectIntersect.getBottom())) & 4294967295L) | (((long) Float.floatToRawIntBits(right)) << 32)));
        return new RectF(Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U >> 32)), Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U & 4294967295L)), Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U2 >> 32)), Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U2 & 4294967295L)));
    }
    ...
    */
    ...
    public final boolean m1450canScroll0AR0LA0$ui_release(boolean z, int i, long j) {
        if (Intrinsics.areEqual(Looper.getMainLooper().getThread(), Thread.currentThread())) {
            return m1449canScrollmoWRBKg(getCurrentSemanticsNodes(), z, i, j);
        }
        return false;
    }
    ...
    public final int hitTestSemanticsAt$ui_release(float f, float f2) {
        ...
        LayoutNode.m1318hitTestSemantics6fMxITs$ui_release$default(this.view.getRoot(), Offset.m752constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32)), hitTestResult, 0, false, 12, null);
        for (int lastIndex = CollectionsKt.getLastIndex(hitTestResult); -1 < lastIndex; lastIndex--) {
            ...
            MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(this.view.getAndroidViewsHandler$ui_release().getLayoutNodeToHolder().get(layoutNodeRequireLayoutNode));
            if (layoutNodeRequireLayoutNode.getNodes$ui_release().m1369hasH91voCI$ui_release(NodeKind.m1404constructorimpl(8))) {
