...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.Companion.m906getAutoNrFUSI();
    ...
    private final void m1475applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
        CompositingStrategy.Companion companion = CompositingStrategy.Companion;
        if (CompositingStrategy.m903equalsimpl0(i, companion.m908getOffscreenNrFUSI())) {
            Paint paint = this.layerPaint;
            renderNode.setUseCompositingLayer(true, paint != null ? paint.asFrameworkPaint() : null);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m903equalsimpl0(i, companion.m907getModulateAlphaNrFUSI())) {
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m903equalsimpl0(m1477getCompositingStrategyNrFUSI(), CompositingStrategy.Companion.m908getOffscreenNrFUSI()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m832equalsimpl0(m1476getBlendMode0nO6VwU(), BlendMode.Companion.m862getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m1475applyCompositingStrategyQu9p0E8(this.renderNode, CompositingStrategy.Companion.m908getOffscreenNrFUSI());
        } else {
            m1475applyCompositingStrategyQu9p0E8(this.renderNode, this.internalCompositingStrategy);
        }
    }
    ...
    public int m1476getBlendMode0nO6VwU() {
    ...
    public int m1477getCompositingStrategyNrFUSI() {
    ...
    public void record(CanvasHolder canvasHolder, Path path, Function1 function1) {
        ...
        if (path != null) {
            androidCanvas.save();
            androidx.compose.ui.graphics.Canvas.m868clipPathmtrdDE$default(androidCanvas, path, 0, 2, null);
        }
    ...
    public void mo1459setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().mo815setBlendModes9anfk8(i);
    ...
    public void mo1460setCompositingStrategyaDBOjCE(int i) {
