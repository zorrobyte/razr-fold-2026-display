...
public final class AndroidComposeView extends ViewGroup implements Owner, ViewRootForTest, MatrixPositionCalculator, DefaultLifecycleObserver {
    ...
    public AndroidComposeView(Context context, CoroutineContext coroutineContext) {
        ...
        this.lastDownPointerPosition = companion.m769getUnspecifiedF1C5BW0();
        int i = 1;
        ...
        Modifier modifierOnKeyEvent = KeyInputModifierKt.onKeyEvent(companion2, new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                return m1444invokeZmokQxo(((KeyEvent) obj).m1188unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m1444invokeZmokQxo(android.view.KeyEvent keyEvent) {
                final FocusDirection focusDirectionM1437getFocusDirectionP8AzH3I = this.this$0.m1437getFocusDirectionP8AzH3I(keyEvent);
                if (focusDirectionM1437getFocusDirectionP8AzH3I == null || !KeyEventType.m1190equalsimpl0(KeyEvent_androidKt.m1195getTypeZmokQxo(keyEvent), KeyEventType.Companion.m1191getKeyDownCS__XNY())) {
                    return Boolean.FALSE;
                }
                Integer numM699toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m699toAndroidFocusDirection3ESFkO8(focusDirectionM1437getFocusDirectionP8AzH3I.m690unboximpl());
                if (ComposeUiFlags.isViewFocusFixEnabled && this.this$0.hasFocus() && numM699toAndroidFocusDirection3ESFkO8 != null && this.this$0.m1432onMoveFocusInChildren3ESFkO8(focusDirectionM1437getFocusDirectionP8AzH3I.m690unboximpl())) {
                    return Boolean.TRUE;
                }
                Rect rectOnFetchFocusRect = this.this$0.onFetchFocusRect();
                Boolean boolMo706focusSearchULY8qGw = this.this$0.getFocusOwner().mo706focusSearchULY8qGw(focusDirectionM1437getFocusDirectionP8AzH3I.m690unboximpl(), rectOnFetchFocusRect, new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1$focusWasMovedOrCancelled$1
                    {
                        super(1);
                    }
                    ...
                    public final Boolean invoke(FocusTargetNode focusTargetNode) {
                        return Boolean.valueOf(focusTargetNode.mo715requestFocus3ESFkO8(focusDirectionM1437getFocusDirectionP8AzH3I.m690unboximpl()));
                    }
                });
                if (boolMo706focusSearchULY8qGw != null ? boolMo706focusSearchULY8qGw.booleanValue() : true) {
                    return Boolean.TRUE;
                }
                if (!FocusOwnerImplKt.m711is1dFocusSearch3ESFkO8(focusDirectionM1437getFocusDirectionP8AzH3I.m690unboximpl())) {
                    return Boolean.FALSE;
                }
                if (numM699toAndroidFocusDirection3ESFkO8 != null) {
                    View viewFindNextNonChildView = this.this$0.findNextNonChildView(numM699toAndroidFocusDirection3ESFkO8.intValue());
                    ...
                    if (viewFindNextNonChildView != null) {
                        ...
                        if (FocusInteropUtils_androidKt.requestInteropFocus(viewFindNextNonChildView, numM699toAndroidFocusDirection3ESFkO8, androidRect)) {
                            return Boolean.TRUE;
                        }
                    }
                }
                if (!this.this$0.getFocusOwner().mo703clearFocusI7lrPNg(false, true, false, focusDirectionM1437getFocusDirectionP8AzH3I.m690unboximpl())) {
                    return Boolean.TRUE;
                }
                Boolean boolMo706focusSearchULY8qGw2 = this.this$0.getFocusOwner().mo706focusSearchULY8qGw(focusDirectionM1437getFocusDirectionP8AzH3I.m690unboximpl(), null, new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeView$keyInputModifier$1.1
                    {
                        super(1);
                    }
                ...
                return Boolean.valueOf(boolMo706focusSearchULY8qGw2 != null ? boolMo706focusSearchULY8qGw2.booleanValue() : true);
            }
        });
        ...
        androidComposeView.globalPosition = IntOffset.m1902constructorimpl((j & 4294967295L) | (j << 32));
        androidComposeView.tmpPositionArray = new int[]{0, 0};
        androidComposeView.tmpMatrix = Matrix.m941constructorimpl$default(null, 1, null);
        androidComposeView.viewToWindowMatrix = Matrix.m941constructorimpl$default(null, 1, null);
        androidComposeView.windowToViewMatrix = Matrix.m941constructorimpl$default(null, 1, null);
        androidComposeView.lastMatrixRecalculationAnimationTime = -1L;
        androidComposeView.windowPosition = companion.m768getInfiniteF1C5BW0();
        ...
        androidComposeView.textInputSessionMutex = SessionMutex.m663constructorimpl();
        ...
        androidComposeView._inputModeManager = new InputModeManagerImpl(androidComposeView.isInTouchMode() ? InputMode.Companion.m1161getTouchaOaMEAU() : InputMode.Companion.m1160getKeyboardaOaMEAU(), new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                return m1439invokeiuPiT84(((InputMode) obj).m1159unboximpl());
            }

            /* JADX INFO: renamed from: invoke-iuPiT84, reason: not valid java name */
            public final Boolean m1439invokeiuPiT84(int i2) {
                InputMode.Companion companion3 = InputMode.Companion;
                return Boolean.valueOf(InputMode.m1156equalsimpl0(i2, companion3.m1161getTouchaOaMEAU()) ? this.this$0.isInTouchMode() : InputMode.m1156equalsimpl0(i2, companion3.m1160getKeyboardaOaMEAU()) ? this.this$0.isInTouchMode() ? this.this$0.requestFocusFromTouch() : true : false);
            }
        }, objArr2 == true ? 1 : 0);
    ...
    private final long m1430convertMeasureSpecI7RO_PI(int i) {
        int mode = View.MeasureSpec.getMode(i);
        int size = View.MeasureSpec.getSize(i);
        if (mode == Integer.MIN_VALUE) {
            return m1434packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m1434packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m1434packZIaKswc(size, size);
        }
    ...
    */
    private final int m1431handleMotionEvent8iAsVTc(android.view.MotionEvent r17) {
        /*
            Method dump skipped, instruction units count: 302
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.AndroidComposeView.m1431handleMotionEvent8iAsVTc(android.view.MotionEvent):int");
    }
    ...
    public final boolean m1432onMoveFocusInChildren3ESFkO8(int i) {
        AndroidViewsHandler androidViewsHandler;
        if (!ComposeUiFlags.isViewFocusFixEnabled) {
            FocusDirection.Companion companion = FocusDirection.Companion;
            if (FocusDirection.m687equalsimpl0(i, companion.m692getEnterdhqQ8s()) || FocusDirection.m687equalsimpl0(i, companion.m693getExitdhqQ8s())) {
                return false;
            }
            Integer numM699toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m699toAndroidFocusDirection3ESFkO8(i);
            if (numM699toAndroidFocusDirection3ESFkO8 == null) {
                throw new IllegalStateException("Invalid focus direction");
            }
            int iIntValue = numM699toAndroidFocusDirection3ESFkO8.intValue();
        ...
        if (FocusDirection.m687equalsimpl0(i, companion3.m692getEnterdhqQ8s()) || FocusDirection.m687equalsimpl0(i, companion3.m693getExitdhqQ8s()) || !hasFocus() || (androidViewsHandler = this._androidViewsHandler) == null) {
            return false;
        }
        Integer numM699toAndroidFocusDirection3ESFkO82 = FocusInteropUtils_androidKt.m699toAndroidFocusDirection3ESFkO8(i);
        if (numM699toAndroidFocusDirection3ESFkO82 == null) {
            throw new IllegalStateException("Invalid focus direction");
        }
        int iIntValue2 = numM699toAndroidFocusDirection3ESFkO82.intValue();
        View rootView = getRootView();
        rootView.getClass();
        ViewGroup viewGroup = (ViewGroup) rootView;
        ...
        if (!FocusOwnerImplKt.m711is1dFocusSearch3ESFkO8(i) || !androidViewsHandler.hasFocus()) {
    ...
    public final boolean m1433onRequestFocusForOwner7o62pno(FocusDirection focusDirection, Rect rect) {
        Integer numM699toAndroidFocusDirection3ESFkO8;
        if (isFocused() || hasFocus()) {
            return true;
        }
        return super.requestFocus((focusDirection == null || (numM699toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m699toAndroidFocusDirection3ESFkO8(focusDirection.m690unboximpl())) == null) ? 130 : numM699toAndroidFocusDirection3ESFkO8.intValue(), rect != null ? RectHelper_androidKt.toAndroidRect(rect) : null);
    }

    /* JADX INFO: renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m1434packZIaKswc(int i, int i2) {
        return ULong.m2196constructorimpl(ULong.m2196constructorimpl(ULong.m2196constructorimpl(i) << 32) | ULong.m2196constructorimpl(i2));
    }
    ...
    private final void recalculateWindowPosition() {
        ...
        if (jCurrentAnimationTimeMillis != this.lastMatrixRecalculationAnimationTime) {
            ...
            this.windowPosition = Offset.m752constructorimpl((((long) Float.floatToRawIntBits(f - this.tmpPositionArray[0])) << 32) | (((long) Float.floatToRawIntBits(f2 - r0[1])) & 4294967295L));
        }
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        float x = motionEvent.getX();
        long jM944mapMKHz9U = Matrix.m944mapMKHz9U(fArr, Offset.m752constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getY())) & 4294967295L) | (Float.floatToRawIntBits(x) << 32)));
        this.windowPosition = Offset.m752constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getRawX() - Float.intBitsToFloat((int) (jM944mapMKHz9U >> 32)))) << 32) | (((long) Float.floatToRawIntBits(motionEvent.getRawY() - Float.intBitsToFloat((int) (jM944mapMKHz9U & 4294967295L)))) & 4294967295L));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo1457calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m1466invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public static final void sendHoverExitEvent$lambda$10(AndroidComposeView androidComposeView) {
        ...
        androidComposeView.m1435sendMotionEvent8iAsVTc(motionEvent);
    }

    /* JADX INFO: renamed from: sendMotionEvent-8iAsVTc, reason: not valid java name */
    private final int m1435sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        Object obj;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            this._windowInfo.m1471setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m1249constructorimpl(motionEvent.getMetaState()));
        }
        ...
        if (pointerInputEventData != null) {
            this.lastDownPointerPosition = pointerInputEventData.m1239getPositionF1C5BW0();
        }
        int iM1243processBIzXfog = this.pointerInputEventProcessor.m1243processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, this, isInBounds(motionEvent));
        int actionMasked = motionEvent.getActionMasked();
        if ((actionMasked != 0 && actionMasked != 5) || (iM1243processBIzXfog & 1) != 0) {
            return iM1243processBIzXfog;
        }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int i, long j, boolean z) {
        ...
        while (i4 < pointerCount) {
            ...
            long jM1438localToScreenMKHz9U = m1438localToScreenMKHz9U(Offset.m752constructorimpl((((long) Float.floatToRawIntBits(pointerCoords.y)) & 4294967295L) | (((long) Float.floatToRawIntBits(f)) << 32)));
            pointerCoords.x = Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U >> 32));
            pointerCoords.y = Float.intBitsToFloat((int) (jM1438localToScreenMKHz9U & 4294967295L));
            i4++;
        }
        ...
        this.pointerInputEventProcessor.m1243processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui_release, this, true);
    ...
    public final boolean m1436startDrag12SF9DM(DragAndDropTransferData dragAndDropTransferData, long j, Function1 function1) {
    ...
    public static final void touchModeChangeListener$lambda$8(AndroidComposeView androidComposeView, boolean z) {
        androidComposeView._inputModeManager.m1163setInputModeiuPiT84(z ? InputMode.Companion.m1161getTouchaOaMEAU() : InputMode.Companion.m1160getKeyboardaOaMEAU());
    }
    ...
    public final void updatePositionCacheAndDispatch() {
        ...
        int iM1905getXimpl = IntOffset.m1905getXimpl(j);
        int iM1906getYimpl = IntOffset.m1906getYimpl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        int i = iArr[0];
        if (iM1905getXimpl != i || iM1906getYimpl != iArr[1] || this.lastMatrixRecalculationAnimationTime < 0) {
            this.globalPosition = IntOffset.m1902constructorimpl((((long) i) << 32) | (((long) iArr[1]) & 4294967295L));
            if (iM1905getXimpl != Integer.MAX_VALUE && iM1906getYimpl != Integer.MAX_VALUE) {
                getRoot().getLayoutDelegate$ui_release().getMeasurePassDelegate$ui_release().notifyChildrenUsingCoordinatesWhilePlacing();
                z = true;
            }
        }
        recalculateWindowPosition();
        getRectManager().m1507updateOffsetsucfNpQE(this.globalPosition, IntOffsetKt.m1916roundk4lQ0M(this.windowPosition), this.viewToWindowMatrix);
    ...
    private final void updateWindowMetrics() {
        ...
        if (mutableState != null) {
            mutableState.setValue(IntSize.m1918boximpl(AndroidWindowInfo_androidKt.calculateWindowSize(this)));
        }
    }
    ...
    public long mo1411calculatePositionInWindowMKHz9U(long j) {
        recalculateWindowPosition();
        return Matrix.m944mapMKHz9U(this.viewToWindowMatrix, j);
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int i) {
        return this.composeAccessibilityDelegate.m1450canScroll0AR0LA0$ui_release(false, i, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int i) {
        return this.composeAccessibilityDelegate.m1450canScroll0AR0LA0$ui_release(true, i, this.lastDownPointerPosition);
    }
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        return motionEvent.getActionMasked() == 8 ? (isBadMotionEvent(motionEvent) || !isAttachedToWindow()) ? super.dispatchGenericMotionEvent(motionEvent) : motionEvent.isFromSource(4194304) ? handleRotaryEvent(motionEvent) : (m1431handleMotionEvent8iAsVTc(motionEvent) & 1) != 0 : super.dispatchGenericMotionEvent(motionEvent);
    }
    ...
    public boolean dispatchHoverEvent(MotionEvent motionEvent) {
        ...
        if (!isBadMotionEvent(motionEvent) && isAttachedToWindow()) {
            ...
            if ((m1431handleMotionEvent8iAsVTc(motionEvent) & 1) != 0) {
                return true;
            }
        }
        return false;
    ...
    public boolean dispatchKeyEvent(final android.view.KeyEvent keyEvent) {
        if (!isFocused()) {
            return getFocusOwner().mo705dispatchKeyEventYhN2O0w(KeyEvent.m1184constructorimpl(keyEvent), new Function0() { // from class: androidx.compose.ui.platform.AndroidComposeView.dispatchKeyEvent.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
        ...
        this._windowInfo.m1471setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m1249constructorimpl(keyEvent.getMetaState()));
        return FocusOwner.m702dispatchKeyEventYhN2O0w$default(getFocusOwner(), KeyEvent.m1184constructorimpl(keyEvent), null, 2, null) || super.dispatchKeyEvent(keyEvent);
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchKeyEventPreIme(android.view.KeyEvent keyEvent) {
        return (isFocused() && getFocusOwner().mo704dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent.m1184constructorimpl(keyEvent))) || super.dispatchKeyEventPreIme(keyEvent);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int iM1431handleMotionEvent8iAsVTc = m1431handleMotionEvent8iAsVTc(motionEvent);
        if ((iM1431handleMotionEvent8iAsVTc & 2) != 0) {
            getParent().requestDisallowInterceptTouchEvent(true);
        }
        return (iM1431handleMotionEvent8iAsVTc & 1) != 0;
    }
    ...
    public View focusSearch(View view, int i) {
        ...
        int iM690unboximpl = focusDirection != null ? focusDirection.m690unboximpl() : FocusDirection.Companion.m691getDowndhqQ8s();
        final Ref$ObjectRef ref$ObjectRef = new Ref$ObjectRef();
        if (getFocusOwner().mo706focusSearchULY8qGw(iM690unboximpl, rectCalculateBoundingRectRelativeTo, new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeView$focusSearch$searchResult$1
            {
                super(1);
            }
            ...
            if (ref$ObjectRef.element != null) {
                if (viewFindNextFocus != null) {
                    if (FocusOwnerImplKt.m711is1dFocusSearch3ESFkO8(iM690unboximpl)) {
                        return super.focusSearch(view, i);
                    }
                    Object obj = ref$ObjectRef.element;
                    obj.getClass();
                    if (TwoDimensionalFocusSearchKt.m742isBetterCandidateI7lrPNg(FocusTraversalKt.focusRect((FocusTargetNode) obj), FocusInteropUtils_androidKt.calculateBoundingRectRelativeTo(viewFindNextFocus, this), rectCalculateBoundingRectRelativeTo, iM690unboximpl)) {
                    }
                }
                return this;
            }
    ...
    public FocusDirection m1437getFocusDirectionP8AzH3I(android.view.KeyEvent keyEvent) {
        long jM1194getKeyZmokQxo = KeyEvent_androidKt.m1194getKeyZmokQxo(keyEvent);
        Key.Companion companion = Key.Companion;
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1177getNavigatePreviousEK5gGoQ())) {
            return FocusDirection.m684boximpl(FocusDirection.Companion.m696getPreviousdhqQ8s());
        }
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1176getNavigateNextEK5gGoQ())) {
            return FocusDirection.m684boximpl(FocusDirection.Companion.m695getNextdhqQ8s());
        }
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1182getTabEK5gGoQ())) {
            return FocusDirection.m684boximpl(KeyEvent_androidKt.m1196isShiftPressedZmokQxo(keyEvent) ? FocusDirection.Companion.m696getPreviousdhqQ8s() : FocusDirection.Companion.m695getNextdhqQ8s());
        }
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1170getDirectionRightEK5gGoQ())) {
            return FocusDirection.m684boximpl(FocusDirection.Companion.m697getRightdhqQ8s());
        }
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1169getDirectionLeftEK5gGoQ())) {
            return FocusDirection.m684boximpl(FocusDirection.Companion.m694getLeftdhqQ8s());
        }
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1171getDirectionUpEK5gGoQ()) ? true : Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1180getPageUpEK5gGoQ())) {
            return FocusDirection.m684boximpl(FocusDirection.Companion.m698getUpdhqQ8s());
        }
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1168getDirectionDownEK5gGoQ()) ? true : Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1179getPageDownEK5gGoQ())) {
        ...
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1167getDirectionCenterEK5gGoQ()) ? true : Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1172getEnterEK5gGoQ()) ? true : Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1178getNumPadEnterEK5gGoQ())) {
            return FocusDirection.m684boximpl(FocusDirection.Companion.m692getEnterdhqQ8s());
        }
        if (Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1166getBackEK5gGoQ()) ? true : Key.m1165equalsimpl0(jM1194getKeyZmokQxo, companion.m1173getEscapeEK5gGoQ())) {
            return FocusDirection.m684boximpl(FocusDirection.Companion.m693getExitdhqQ8s());
        }
        return null;
    }
    ...
    public void mo1204localToScreen58bKbWc(float[] fArr) {
        recalculateWindowPosition();
        Matrix.m950timesAssign58bKbWc(fArr, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m1455preTranslatecG2Xzmc(fArr, Float.intBitsToFloat((int) (this.windowPosition >> 32)), Float.intBitsToFloat((int) (this.windowPosition & 4294967295L)), this.tmpMatrix);
    }

    /* JADX INFO: renamed from: localToScreen-MK-Hz9U, reason: not valid java name */
    public long m1438localToScreenMKHz9U(long j) {
        recalculateWindowPosition();
        long jM944mapMKHz9U = Matrix.m944mapMKHz9U(this.viewToWindowMatrix, j);
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM944mapMKHz9U >> 32)) + Float.intBitsToFloat((int) (this.windowPosition >> 32));
        return Offset.m752constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jM944mapMKHz9U & 4294967295L)) + Float.intBitsToFloat((int) (this.windowPosition & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32));
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this._windowInfo.setOnInitializeContainerSize(new Function0() { // from class: androidx.compose.ui.platform.AndroidComposeView.onAttachedToWindow.1
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Object invoke() {
                return IntSize.m1918boximpl(m1445invokeYbymL2g());
            }

            /* JADX INFO: renamed from: invoke-YbymL2g, reason: not valid java name */
            public final long m1445invokeYbymL2g() {
        ...
        this._inputModeManager.m1163setInputModeiuPiT84(isInTouchMode() ? InputMode.Companion.m1161getTouchaOaMEAU() : InputMode.Companion.m1160getKeyboardaOaMEAU());
    ...
    public boolean onCheckIsTextEditor() {
        MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(SessionMutex.m665getCurrentSessionimpl(this.textInputSessionMutex));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        try {
            ...
            long jM1430convertMeasureSpecI7RO_PI = m1430convertMeasureSpecI7RO_PI(i);
            int iM2196constructorimpl = (int) ULong.m2196constructorimpl(jM1430convertMeasureSpecI7RO_PI >>> 32);
            int iM2196constructorimpl2 = (int) ULong.m2196constructorimpl(jM1430convertMeasureSpecI7RO_PI & 4294967295L);
            long jM1430convertMeasureSpecI7RO_PI2 = m1430convertMeasureSpecI7RO_PI(i2);
            long jM1866fitPrioritizingHeightZbe2FdA = Constraints.Companion.m1866fitPrioritizingHeightZbe2FdA(iM2196constructorimpl, iM2196constructorimpl2, (int) ULong.m2196constructorimpl(jM1430convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m2196constructorimpl(4294967295L & jM1430convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            boolean zM1854equalsimpl0 = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m1849boximpl(jM1866fitPrioritizingHeightZbe2FdA);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    zM1854equalsimpl0 = Constraints.m1854equalsimpl0(constraints.m1865unboximpl(), jM1866fitPrioritizingHeightZbe2FdA);
                }
                if (!zM1854equalsimpl0) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m1357updateRootConstraintsBRTryo0(jM1866fitPrioritizingHeightZbe2FdA);
    ...
    public boolean requestFocus(int i, android.graphics.Rect rect) {
        ...
        if (!ComposeUiFlags.isViewFocusFixEnabled) {
            ...
            FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(i);
            final int iM690unboximpl = focusDirection != null ? focusDirection.m690unboximpl() : FocusDirection.Companion.m692getEnterdhqQ8s();
            return Intrinsics.areEqual(getFocusOwner().mo706focusSearchULY8qGw(iM690unboximpl, rect != null ? RectHelper_androidKt.toComposeRect(rect) : null, new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeView.requestFocus.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public final Boolean invoke(FocusTargetNode focusTargetNode) {
                    return Boolean.valueOf(focusTargetNode.mo715requestFocus3ESFkO8(iM690unboximpl));
                }
            }), Boolean.TRUE);
        }
        if (isFocused()) {
        ...
        final int iM690unboximpl2 = focusDirection2 != null ? focusDirection2.m690unboximpl() : FocusDirection.Companion.m692getEnterdhqQ8s();
        if (hasFocus() && m1432onMoveFocusInChildren3ESFkO8(iM690unboximpl2)) {
            return true;
        }
        final Ref$BooleanRef ref$BooleanRef = new Ref$BooleanRef();
        Boolean boolMo706focusSearchULY8qGw = getFocusOwner().mo706focusSearchULY8qGw(iM690unboximpl2, rect != null ? RectHelper_androidKt.toComposeRect(rect) : null, new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$focusSearchResult$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                ...
                return Boolean.valueOf(focusTargetNode.mo715requestFocus3ESFkO8(iM690unboximpl2));
            }
        });
        if (boolMo706focusSearchULY8qGw == null) {
            return false;
        }
        if (boolMo706focusSearchULY8qGw.booleanValue()) {
            return true;
        }
        if (ref$BooleanRef.element) {
            return false;
        }
        if ((rect != null && !hasFocus() && Intrinsics.areEqual(getFocusOwner().mo706focusSearchULY8qGw(iM690unboximpl2, null, new Function1() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocus$altFocus$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public long mo1263screenToLocalMKHz9U(long j) {
        recalculateWindowPosition();
        ...
        return Matrix.m944mapMKHz9U(this.windowToViewMatrix, Offset.m752constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat2)) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32)));
    }
