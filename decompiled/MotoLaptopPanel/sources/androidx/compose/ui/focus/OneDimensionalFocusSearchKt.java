...
public abstract class OneDimensionalFocusSearchKt {
    ...
    private static final boolean backwardFocusSearch(FocusTargetNode focusTargetNode, Function1 function1) {
        ...
        if (i2 == 1) {
            return backwardFocusSearch(activeChild, function1) || m734generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m696getPreviousdhqQ8s(), function1) || (activeChild.fetchFocusProperties$ui_release().getCanFocus() && ((Boolean) function1.invoke(activeChild)).booleanValue());
        }
        if (i2 == 2 || i2 == 3) {
            return m734generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m696getPreviousdhqQ8s(), function1);
        }
        if (i2 != 4) {
            throw new NoWhenBranchMatchedException();
        }
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1 function1) {
        ...
        if (i == 1) {
            FocusTargetNode activeChild = FocusTraversalKt.getActiveChild(focusTargetNode);
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m734generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m695getNextdhqQ8s(), function1);
            }
            throw new IllegalStateException("ActiveParent must have a focusedChild");
        }
        if (i == 2 || i == 3) {
    ...
    private static final boolean m734generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1 function1) {
        if (m736searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m683searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                ...
                boolean zM736searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m736searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1);
                Boolean boolValueOf = Boolean.valueOf(zM736searchChildren4C6V_qg);
                if (zM736searchChildren4C6V_qg || !beyondBoundsScope.getHasMoreContent()) {
                    return boolValueOf;
                }
                return null;
            }
    ...
    public static final boolean m735oneDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, Function1 function1) {
    ...
    public static final boolean m736searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1 function1) {
        ...
        if (FocusDirection.m687equalsimpl0(i, FocusDirection.Companion.m695getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetNode)) {
            return false;
        }
