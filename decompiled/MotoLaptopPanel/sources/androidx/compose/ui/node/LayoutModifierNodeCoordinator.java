...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo1284measureBRTryo0(long j) {
            ...
            layoutModifierNodeCoordinator.m1316setLookaheadConstraints_Sx5XlM$ui_release(Constraints.m1849boximpl(j));
            ...
            set_measureResult(layoutModifierNode.mo34measure3p2s80s(this, lookaheadDelegate, j));
            return this;
        }
    }
    ...
    static {
        ...
        Paint.mo816setColor8_81llA(Color.Companion.m892getBlue0d7_KjU());
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode layoutModifierNode) {
        ...
        if ((layoutModifierNode.getNode().getKindSet$ui_release() & NodeKind.m1404constructorimpl(512)) != 0) {
            MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(layoutModifierNode);
    ...
    public Placeable mo1284measureBRTryo0(long j) {
        if (getForceMeasureWithLookaheadConstraints$ui_release()) {
            ...
            j = constraints.m1865unboximpl();
        }
        m1294setMeasurementConstraintsBRTryo0(j);
        ApproachMeasureScopeImpl approachMeasureScopeImpl = this.approachMeasureScope;
        if (approachMeasureScopeImpl == null) {
            setMeasureResult$ui_release(getLayoutModifierNode().mo34measure3p2s80s(this, getWrappedNonNull(), j));
            onMeasured();
            return this;
        }
        approachMeasureScopeImpl.getApproachNode();
        approachMeasureScopeImpl.m1272getLookaheadSizeYbymL2g();
        throw null;
    }
    ...
    public final void setLayoutModifierNode$ui_release(LayoutModifierNode layoutModifierNode) {
        if (!Intrinsics.areEqual(layoutModifierNode, this.layoutModifierNode)) {
            ...
            if ((node.getKindSet$ui_release() & NodeKind.m1404constructorimpl(512)) != 0) {
                MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(layoutModifierNode);
                ApproachMeasureScopeImpl approachMeasureScopeImpl = this.approachMeasureScope;
                if (approachMeasureScopeImpl != null) {
                    MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(layoutModifierNode);
    ...
    public final void m1316setLookaheadConstraints_Sx5XlM$ui_release(Constraints constraints) {
