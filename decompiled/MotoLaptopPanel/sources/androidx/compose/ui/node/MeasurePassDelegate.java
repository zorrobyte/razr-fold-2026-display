...
public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    public MeasurePassDelegate(LayoutNodeLayoutDelegate layoutNodeLayoutDelegate) {
        ...
        this.lastPosition = companion.m1913getZeronOccac();
        ...
        this.performMeasureBlock = new Function0() { // from class: androidx.compose.ui.node.MeasurePassDelegate$performMeasureBlock$1
            ...
            public final void m1364invoke() {
                this.this$0.getOuterCoordinator().mo1284measureBRTryo0(this.this$0.performMeasureConstraints);
            }
        };
        ...
        this.placeOuterCoordinatorPosition = companion.m1913getZeronOccac();
        this.placeOuterCoordinatorBlock = new Function0() { // from class: androidx.compose.ui.node.MeasurePassDelegate$placeOuterCoordinatorBlock$1
            ...
            public final void m1365invoke() {
                ...
                if (graphicsLayer != null) {
                    placementScope2.m1298placeWithLayeraW9wM(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, graphicsLayer, measurePassDelegate.placeOuterCoordinatorZIndex);
                } else if (function1 == null) {
                    placementScope2.m1296place70tqf50(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
                } else {
                    placementScope2.m1297placeWithLayeraW9wM(measurePassDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, function1);
                }
            }
        };
    }
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode.getMeasurePending$ui_release() && layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m1320remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null)) {
    ...
    private final void m1358placeOuterCoordinatorMLgxB_4(long j, float f, Function1 function1, GraphicsLayer graphicsLayer) {
        ...
        ownerRequireOwner.getRectManager().m1506onLayoutPositionChanged70tqf50(getLayoutNode(), j, z);
        if (this.layoutPending || !isPlaced()) {
            ...
            getOuterCoordinator().m1391placeSelfApparentToRealOffsetMLgxB_4(j, f, function1, graphicsLayer);
    ...
    private final void m1359placeSelfMLgxB_4(long j, float f, Function1 function1, GraphicsLayer graphicsLayer) throws Throwable {
        Placeable.PlacementScope placementScope;
        LayoutNode layoutNode = getLayoutNode();
        boolean z = true;
        try {
            this.isPlacedByParent = true;
            if (!IntOffset.m1904equalsimpl0(j, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (lookaheadPassDelegate != null && lookaheadPassDelegate.getNeedsToBePlacedInApproach()) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate2, IntOffset.m1905getXimpl(j), IntOffset.m1906getYimpl(j), 0.0f, 4, null);
            }
            ...
            m1358placeOuterCoordinatorMLgxB_4(j, f, function1, graphicsLayer);
    ...
    public final Constraints m1360getLastConstraintsDWUhwKw() {
        if (this.measuredOnce) {
            return Constraints.m1849boximpl(m1290getMeasurementConstraintsmsEJaDk());
        }
        return null;
    }
    ...
    public Placeable mo1284measureBRTryo0(long j) throws Throwable {
        LayoutNode.UsageByParent intrinsicsUsageByParent$ui_release = getLayoutNode().getIntrinsicsUsageByParent$ui_release();
        ...
        if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(getLayoutNode())) {
            ...
            lookaheadPassDelegate.mo1284measureBRTryo0(j);
        }
        trackMeasurementByParent(getLayoutNode());
        m1362remeasureBRTryo0(j);
        return this;
    }
    ...
    public final void m1361performMeasureBRTryo0$ui_release(long j) {
        LayoutNode.LayoutState layoutState = getLayoutState();
    ...
    public void mo1291placeAtf8xVGno(long j, float f, GraphicsLayer graphicsLayer) throws Throwable {
        m1359placeSelfMLgxB_4(j, f, null, graphicsLayer);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public void mo1292placeAtf8xVGno(long j, float f, Function1 function1) throws Throwable {
        m1359placeSelfMLgxB_4(j, f, function1, null);
    }

    /* JADX INFO: renamed from: remeasure-BRTryo0, reason: not valid java name */
    public final boolean m1362remeasureBRTryo0(long j) throws Throwable {
        LayoutNode layoutNode = getLayoutNode();
        try {
            if (getLayoutNode().isDeactivated()) {
            ...
            if (!getLayoutNode().getMeasurePending$ui_release() && Constraints.m1854equalsimpl0(m1290getMeasurementConstraintsmsEJaDk(), j)) {
            ...
            long jMo1278getSizeYbymL2g = getOuterCoordinator().mo1278getSizeYbymL2g();
            m1294setMeasurementConstraintsBRTryo0(j);
            m1361performMeasureBRTryo0$ui_release(j);
            if (IntSize.m1921equalsimpl0(getOuterCoordinator().mo1278getSizeYbymL2g(), jMo1278getSizeYbymL2g) && getOuterCoordinator().getWidth() == getWidth() && getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m1293setMeasuredSizeozmzZPI(IntSize.m1919constructorimpl((((long) getOuterCoordinator().getHeight()) & 4294967295L) | (((long) getOuterCoordinator().getWidth()) << 32)));
            return z;
        } catch (Throwable th) {
            layoutNode.rethrowWithComposeStackTrace(th);
            throw new KotlinNothingValueException();
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                measurePassDelegate.m1358placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
