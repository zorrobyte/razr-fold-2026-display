...
public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    private long lastPosition = IntOffset.Companion.m1913getZeronOccac();
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release() && layoutNode.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                ...
                lookaheadPassDelegate$ui_release.getClass();
                Constraints constraintsM1338getLastLookaheadConstraintsDWUhwKw = layoutNode.getLayoutDelegate$ui_release().m1338getLastLookaheadConstraintsDWUhwKw();
                constraintsM1338getLastLookaheadConstraintsDWUhwKw.getClass();
                if (lookaheadPassDelegate$ui_release.m1351remeasureBRTryo0(constraintsM1338getLastLookaheadConstraintsDWUhwKw.m1865unboximpl())) {
    ...
    private final void m1348placeSelfMLgxB_4(final long j, float f, Function1 function1, GraphicsLayer graphicsLayer) throws Throwable {
        ...
        try {
            ...
            if (!IntOffset.m1904equalsimpl0(j, this.lastPosition)) {
            ...
            if (getLayoutPending() || !isPlaced()) {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(ownerRequireOwner.getSnapshotObserver(), getLayoutNode(), false, new Function0() { // from class: androidx.compose.ui.node.LookaheadPassDelegate$placeSelf$1$2
                    ...
                    public final void m1354invoke() {
                        ...
                        Placeable.PlacementScope.m1295place70tqf50$default(placementScope, lookaheadDelegate2, j2, 0.0f, 2, null);
                    }
                }, 2, null);
            } else {
                LookaheadDelegate lookaheadDelegate = getOuterCoordinator().getLookaheadDelegate();
                lookaheadDelegate.getClass();
                lookaheadDelegate.m1345placeSelfApparentToRealOffsetgyyYBs$ui_release(j);
    ...
    public final Constraints m1349getLastConstraintsDWUhwKw() {
    ...
    */
    public androidx.compose.ui.layout.Placeable mo1284measureBRTryo0(long r4) throws java.lang.Throwable {
        /*
            r3 = this;
        ...
        L47:
            r3.m1351remeasureBRTryo0(r4)
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LookaheadPassDelegate.mo1284measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
    }
    ...
    public final void m1350performMeasureBRTryo0$ui_release(final long j) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(getLayoutNode()).getSnapshotObserver(), getLayoutNode(), false, new Function0() { // from class: androidx.compose.ui.node.LookaheadPassDelegate$performMeasure$1
            ...
            public final void m1353invoke() {
                ...
                lookaheadDelegate.getClass();
                lookaheadDelegate.mo1284measureBRTryo0(j);
            }
        }, 2, null);
    ...
    public void mo1291placeAtf8xVGno(long j, float f, GraphicsLayer graphicsLayer) throws Throwable {
        m1348placeSelfMLgxB_4(j, f, null, graphicsLayer);
    }
    ...
    public void mo1292placeAtf8xVGno(long j, float f, Function1 function1) throws Throwable {
        m1348placeSelfMLgxB_4(j, f, function1, null);
    }

    /* JADX INFO: renamed from: remeasure-BRTryo0, reason: not valid java name */
    public final boolean m1351remeasureBRTryo0(long j) throws Throwable {
        ...
        try {
            ...
            this.lookaheadConstraints = Constraints.m1849boximpl(j);
            ...
            if (this.measuredOnce) {
                jM1919constructorimpl = m1289getMeasuredSizeYbymL2g();
            } else {
                long j2 = Integer.MIN_VALUE;
                jM1919constructorimpl = IntSize.m1919constructorimpl((j2 & 4294967295L) | (j2 << 32));
            }
            ...
            this.layoutNodeLayoutDelegate.m1339performLookaheadMeasureBRTryo0$ui_release(j);
            m1293setMeasuredSizeozmzZPI(IntSize.m1919constructorimpl((((long) lookaheadDelegate.getHeight()) & 4294967295L) | (((long) lookaheadDelegate.getWidth()) << 32)));
            return (((int) (jM1919constructorimpl >> 32)) == lookaheadDelegate.getWidth() && ((int) (jM1919constructorimpl & 4294967295L)) == lookaheadDelegate.getHeight()) ? false : true;
        } catch (Throwable th) {
            layoutNode.rethrowWithComposeStackTrace(th);
            throw new KotlinNothingValueException();
        }
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                lookaheadPassDelegate.m1348placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
