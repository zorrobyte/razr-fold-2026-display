...
public final class LayoutNode implements ComposeNodeLifecycleCallback, OwnerScope, LayoutInfo, SemanticsInfo, ComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo19measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) m1332measure3p2s80s(measureScope, list, j);
        }

        /* JADX INFO: renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m1332measure3p2s80s(MeasureScope measureScope, List list, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo1331getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.Companion.m1900getZeroMYxV2XQ();
        }
    ...
    public LayoutNode(boolean z, int i) {
        ...
        this.offsetFromRoot = companion.m1912getMaxnOccac();
        this.lastSize = IntSize.Companion.m1927getZeroYbymL2g();
        this.outerToInnerOffset = companion.m1912getMaxnOccac();
    ...
    private final void applyModifier(Modifier modifier) {
        ...
        if (this.lookaheadRoot == null && this.nodes.m1369hasH91voCI$ui_release(NodeKind.m1404constructorimpl(512))) {
    ...
    private final SemanticsConfiguration calculateSemanticsConfiguration() {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0() { // from class: androidx.compose.ui.node.LayoutNode.calculateSemanticsConfiguration.1
            ...
            public final void m1334invoke() {
                ...
                int iM1404constructorimpl = NodeKind.m1404constructorimpl(8);
                Ref$ObjectRef ref$ObjectRef2 = ref$ObjectRef;
                if ((nodes$ui_release.getAggregateChildKindSet() & iM1404constructorimpl) != 0) {
                    for (Modifier.Node tail$ui_release = nodes$ui_release.getTail$ui_release(); tail$ui_release != null; tail$ui_release = tail$ui_release.getParent$ui_release()) {
                        if ((tail$ui_release.getKindSet$ui_release() & iM1404constructorimpl) != 0) {
                            ?? Pop = tail$ui_release;
                            ?? mutableVector = 0;
                            while (Pop != 0) {
    ...
    public static /* synthetic */ void m1317hitTest6fMxITs$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = PointerType.Companion.m1262getUnknownT8wyACA();
        }
        int i3 = i;
        if ((i2 & 8) != 0) {
            z = true;
        }
        layoutNode.m1324hitTest6fMxITs$ui_release(j, hitTestResult, i3, z);
    }

    /* JADX INFO: renamed from: hitTestSemantics-6fMxITs$ui_release$default, reason: not valid java name */
    public static /* synthetic */ void m1318hitTestSemantics6fMxITs$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = PointerType.Companion.m1261getTouchT8wyACA();
        }
        int i3 = i;
        if ((i2 & 8) != 0) {
            z = true;
        }
        layoutNode.m1325hitTestSemantics6fMxITs$ui_release(j, hitTestResult, i3, z);
    }
    ...
    public static /* synthetic */ boolean m1319lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m1338getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m1326lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    public static /* synthetic */ boolean m1320remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m1337getLastConstraintsDWUhwKw();
        }
        return layoutNode.m1327remeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    */
    ...
    public final void detach$ui_release() {
        ...
        if (!ComposeUiFlags.isSemanticAutofillEnabled && this.nodes.m1369hasH91voCI$ui_release(NodeKind.m1404constructorimpl(8))) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        int iM1404constructorimpl = NodeKind.m1404constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & iM1404constructorimpl) != 0) {
            for (Modifier.Node head$ui_release = nodeChain.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & iM1404constructorimpl) != 0) {
                    ?? Pop = head$ui_release;
                    ?? mutableVector = 0;
                    while (Pop != 0) {
                        if (Pop instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m1308requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m1404constructorimpl(256)));
                        } else if ((Pop.getKindSet$ui_release() & iM1404constructorimpl) != 0 && (Pop instanceof DelegatingNode)) {
                            Modifier.Node delegate$ui_release = ((DelegatingNode) Pop).getDelegate$ui_release();
                            int i = 0;
                            Pop = Pop;
                ...
                if ((head$ui_release.getAggregateChildKindSet$ui_release() & iM1404constructorimpl) == 0) {
                    return;
                }
            }
        }
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long jM1386getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m1386getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m1858getHasFixedWidthimpl(jM1386getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m1857getHasFixedHeightimpl(jM1386getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public final long m1321getLastSizeYbymL2g$ui_release() {
    ...
    public final long m1322getOffsetFromRootnOccac$ui_release() {
    ...
    public final long m1323getOuterToInnerOffsetnOccac$ui_release() {
    ...
    public SemanticsConfiguration getSemanticsConfiguration() {
        if (!isAttached() || isDeactivated() || !this.nodes.m1369hasH91voCI$ui_release(NodeKind.m1404constructorimpl(8))) {
            return null;
        }
    ...
    public final void m1324hitTest6fMxITs$ui_release(long j, HitTestResult hitTestResult, int i, boolean z) {
        getOuterCoordinator$ui_release().m1389hitTestqzLsGqo(NodeCoordinator.Companion.getPointerInputSource(), NodeCoordinator.m1373fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), j, false, 2, null), hitTestResult, i, z);
    }

    /* JADX INFO: renamed from: hitTestSemantics-6fMxITs$ui_release, reason: not valid java name */
    public final void m1325hitTestSemantics6fMxITs$ui_release(long j, HitTestResult hitTestResult, int i, boolean z) {
        getOuterCoordinator$ui_release().m1389hitTestqzLsGqo(NodeCoordinator.Companion.getSemanticsSource(), NodeCoordinator.m1373fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), j, false, 2, null), hitTestResult, PointerType.Companion.m1261getTouchT8wyACA(), z);
    }
    ...
    public final boolean m1326lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        lookaheadPassDelegate$ui_release.getClass();
        return lookaheadPassDelegate$ui_release.m1351remeasureBRTryo0(constraints.m1865unboximpl());
    }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node nodeHeadNode = innerCoordinator$ui_release.headNode(zM1405getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet$ui_release() & iM1404constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild$ui_release()) {
    ...
    public final boolean m1327remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate$ui_release().m1362remeasureBRTryo0(constraints.m1865unboximpl());
    }
    ...
    public void setCompositionLocalMap(CompositionLocalMap compositionLocalMap) {
        ...
        NodeChain nodeChain = this.nodes;
        int iM1404constructorimpl = NodeKind.m1404constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & iM1404constructorimpl) != 0) {
            for (Modifier.Node head$ui_release = nodeChain.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & iM1404constructorimpl) != 0) {
                    ?? Pop = head$ui_release;
    ...
    public final void m1328setLastSizeozmzZPI$ui_release(long j) {
        this.lastSize = j;
    }
    ...
    public final void m1329setOffsetFromRootgyyYBs$ui_release(long j) {
        this.offsetFromRoot = j;
    }

    /* JADX INFO: renamed from: setOuterToInnerOffset--gyyYBs$ui_release, reason: not valid java name */
    public final void m1330setOuterToInnerOffsetgyyYBs$ui_release(long j) {
