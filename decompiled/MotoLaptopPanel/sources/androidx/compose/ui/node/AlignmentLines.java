...
public abstract class AlignmentLines {
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i, NodeCoordinator nodeCoordinator) {
        float f = i;
        long jM752constructorimpl = Offset.m752constructorimpl((((long) Float.floatToRawIntBits(f)) << 32) | (((long) Float.floatToRawIntBits(f)) & 4294967295L));
        while (true) {
            jM752constructorimpl = mo1301calculatePositionInParentR5De75A(nodeCoordinator, jM752constructorimpl);
            ...
            if (Intrinsics.areEqual(nodeCoordinator, this.alignmentLinesOwner.getInnerCoordinator())) {
                ...
                jM752constructorimpl = Offset.m752constructorimpl((((long) Float.floatToRawIntBits(positionFor)) << 32) | (((long) Float.floatToRawIntBits(positionFor)) & 4294967295L));
            }
        }
        int iRound = Math.round(alignmentLine instanceof HorizontalAlignmentLine ? Float.intBitsToFloat((int) (jM752constructorimpl & 4294967295L)) : Float.intBitsToFloat((int) (jM752constructorimpl >> 32)));
    ...
    protected abstract long mo1301calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
