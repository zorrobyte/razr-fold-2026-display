...
public final class Rect {
    ...
    public final boolean m771containsk4lQ0M(long j) {
    ...
    public final long m772getCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        return Offset.m752constructorimpl((((long) Float.floatToRawIntBits(this.top + ((getBottom() - getTop()) / 2.0f))) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }
    ...
    public final long m773getSizeNHjbRc() {
        float right = getRight() - getLeft();
        return Size.m783constructorimpl((((long) Float.floatToRawIntBits(getBottom() - getTop())) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }
    ...
    public final Rect m774translatek4lQ0M(long j) {
        int i = (int) (j >> 32);
