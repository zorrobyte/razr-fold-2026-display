...
public abstract class DragAndDropNodeKt {
    ...
    public static final boolean m675containsUv8p0NA(DragAndDropNode dragAndDropNode, long j) {
        ...
        float fM672getSizeYbymL2g$ui_release = ((int) (dragAndDropNode.m672getSizeYbymL2g$ui_release() >> 32)) + fIntBitsToFloat;
        float fM672getSizeYbymL2g$ui_release2 = ((int) (dragAndDropNode.m672getSizeYbymL2g$ui_release() & 4294967295L)) + fIntBitsToFloat2;
        float fIntBitsToFloat3 = Float.intBitsToFloat((int) (j >> 32));
        if (fIntBitsToFloat <= fIntBitsToFloat3 && fIntBitsToFloat3 <= fM672getSizeYbymL2g$ui_release) {
            float fIntBitsToFloat4 = Float.intBitsToFloat((int) (j & 4294967295L));
            if (fIntBitsToFloat2 <= fIntBitsToFloat4 && fIntBitsToFloat4 <= fM672getSizeYbymL2g$ui_release2) {
                return true;
            }
        }
        return false;
