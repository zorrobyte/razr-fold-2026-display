...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer consumer) {
        ...
        long jM1917getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m1917getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTarget = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(rectBoundsInRoot)), new Point(IntOffset.m1905getXimpl(jM1917getTopLeftnOccac), IntOffset.m1906getYimpl(jM1917getTopLeftnOccac)), composeScrollCaptureCallback);
