...
final class AndroidContentDataType implements ContentDataType {
    ...
    public static final /* synthetic */ AndroidContentDataType m666boximpl(int i) {
    ...
    public static boolean m668equalsimpl(int i, Object obj) {
        return (obj instanceof AndroidContentDataType) && i == ((AndroidContentDataType) obj).m671unboximpl();
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m669hashCodeimpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m668equalsimpl(this.androidAutofillType, obj);
    }

    public int hashCode() {
        return m669hashCodeimpl(this.androidAutofillType);
    }

    public String toString() {
        return m670toStringimpl(this.androidAutofillType);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m671unboximpl() {
