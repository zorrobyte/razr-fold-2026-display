...
public abstract class SemanticsPropertiesKt {
    ...
    public static final void m1502setRolekuIjeqM(SemanticsPropertyReceiver semanticsPropertyReceiver, int i) {
        SemanticsProperties.INSTANCE.getRole().setValue(semanticsPropertyReceiver, $$delegatedProperties[12], Role.m1482boximpl(i));
    }
