...
public abstract class SaversKt {
        ...
        public final Object invoke(SaverScope saverScope, AnnotatedString.Range range) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[annotationType.ordinal()]) {
                ...
                case 7:
                    ...
                    item8.getClass();
                    objSave = SaversKt.save(((StringAnnotation) item8).m1582unboximpl());
                    break;
                default:
        ...
        public final AnnotatedString.Range invoke(Object obj) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[annotationType.ordinal()]) {
                ...
                case 7:
                    ...
                    str2.getClass();
                    return new AnnotatedString.Range(StringAnnotation.m1577boximpl(StringAnnotation.m1578constructorimpl(str2)), iIntValue, iIntValue2, str);
                default:
                    throw new NoWhenBranchMatchedException();
            }
        }
    ...
    private static final Saver ParagraphStyleSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope saverScope, ParagraphStyle paragraphStyle) {
            return CollectionsKt.arrayListOf(SaversKt.save(TextAlign.m1798boximpl(paragraphStyle.m1551getTextAligne0LSkKk())), SaversKt.save(TextDirection.m1812boximpl(paragraphStyle.m1552getTextDirections_7Xco())), SaversKt.save(TextUnit.m1931boximpl(paragraphStyle.m1550getLineHeightXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope), SaversKt.save(paragraphStyle.getTextIndent(), SaversKt.getSaver(TextIndent.Companion), saverScope), SaversKt.save(paragraphStyle.getPlatformStyle(), Savers_androidKt.getSaver(PlatformParagraphStyle.Companion), saverScope), SaversKt.save(paragraphStyle.getLineHeightStyle(), SaversKt.getSaver(LineHeightStyle.Companion), saverScope), SaversKt.save(LineBreak.m1736boximpl(paragraphStyle.m1549getLineBreakrAG3T2k()), Savers_androidKt.getSaver(LineBreak.Companion), saverScope), SaversKt.save(Hyphens.m1726boximpl(paragraphStyle.m1548getHyphensvmbZdU8())), SaversKt.save(paragraphStyle.getTextMotion(), Savers_androidKt.getSaver(TextMotion.Companion), saverScope));
        }
        ...
        public final ParagraphStyle invoke(Object obj) {
            ...
            textAlign.getClass();
            int iM1804unboximpl = textAlign.m1804unboximpl();
            Object obj3 = list.get(1);
            TextDirection textDirection = obj3 != null ? (TextDirection) obj3 : null;
            textDirection.getClass();
            int iM1818unboximpl = textDirection.m1818unboximpl();
            ...
            textUnit.getClass();
            long jM1940unboximpl = textUnit.m1940unboximpl();
            ...
            lineBreak.getClass();
            int iM1745unboximpl = lineBreak.m1745unboximpl();
            Object obj9 = list.get(7);
            Hyphens hyphens = obj9 != null ? (Hyphens) obj9 : null;
            hyphens.getClass();
            int iM1732unboximpl = hyphens.m1732unboximpl();
            ...
            return new ParagraphStyle(iM1804unboximpl, iM1818unboximpl, jM1940unboximpl, textIndent, platformParagraphStyle, lineHeightStyle, iM1745unboximpl, iM1732unboximpl, textMotion, null);
        }
    });
    private static final Saver SpanStyleSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final Object invoke(SaverScope saverScope, SpanStyle spanStyle) {
            Color colorM876boximpl = Color.m876boximpl(spanStyle.m1571getColor0d7_KjU());
            Color.Companion companion = Color.Companion;
            Object objSave = SaversKt.save(colorM876boximpl, SaversKt.getSaver(companion), saverScope);
            TextUnit textUnitM1931boximpl = TextUnit.m1931boximpl(spanStyle.m1572getFontSizeXSAIIZE());
            TextUnit.Companion companion2 = TextUnit.Companion;
            return CollectionsKt.arrayListOf(objSave, SaversKt.save(textUnitM1931boximpl, SaversKt.getSaver(companion2), saverScope), SaversKt.save(spanStyle.getFontWeight(), SaversKt.getSaver(FontWeight.Companion), saverScope), SaversKt.save(spanStyle.m1573getFontStyle4Lr2A7w()), SaversKt.save(spanStyle.m1574getFontSynthesisZQGJjVo()), SaversKt.save(-1), SaversKt.save(spanStyle.getFontFeatureSettings()), SaversKt.save(TextUnit.m1931boximpl(spanStyle.m1575getLetterSpacingXSAIIZE()), SaversKt.getSaver(companion2), saverScope), SaversKt.save(spanStyle.m1570getBaselineShift5SSeXJ0(), SaversKt.getSaver(BaselineShift.Companion), saverScope), SaversKt.save(spanStyle.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.Companion), saverScope), SaversKt.save(spanStyle.getLocaleList(), SaversKt.getSaver(LocaleList.Companion), saverScope), SaversKt.save(Color.m876boximpl(spanStyle.m1569getBackground0d7_KjU()), SaversKt.getSaver(companion), saverScope), SaversKt.save(spanStyle.getTextDecoration(), SaversKt.getSaver(TextDecoration.Companion), saverScope), SaversKt.save(spanStyle.getShadow(), SaversKt.getSaver(Shadow.Companion), saverScope));
        }
    }, new Function1() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$2
        /* JADX WARN: Removed duplicated region for block: B:53:0x00f6 A[PHI: r16
          0x00f6: PHI (r16v7 androidx.compose.ui.text.style.BaselineShift) = (r16v4 androidx.compose.ui.text.style.BaselineShift), (r16v8 androidx.compose.ui.text.style.BaselineShift) binds: [B:55:0x00fa, B:52:0x00f4] A[DONT_GENERATE, DONT_INLINE]] */
        /* JADX WARN: Removed duplicated region for block: B:59:0x0114  */
        /* JADX WARN: Removed duplicated region for block: B:61:0x011a A[PHI: r17
          0x011a: PHI (r17v4 androidx.compose.ui.text.style.TextGeometricTransform) = 
          (r17v2 androidx.compose.ui.text.style.TextGeometricTransform)
          (r17v5 androidx.compose.ui.text.style.TextGeometricTransform)
         binds: [B:63:0x011e, B:60:0x0118] A[DONT_GENERATE, DONT_INLINE]] */
        /* JADX WARN: Removed duplicated region for block: B:62:0x011c  */
        /* JADX WARN: Removed duplicated region for block: B:64:0x0120  */
        /* JADX WARN: Removed duplicated region for block: B:67:0x0136  */
        /* JADX WARN: Removed duplicated region for block: B:70:0x013c A[ADDED_TO_REGION] */
        /* JADX WARN: Removed duplicated region for block: B:74:0x015f  */
        /* JADX WARN: Removed duplicated region for block: B:76:0x0165 A[PHI: r18
          0x0165: PHI (r18v6 androidx.compose.ui.text.font.FontStyle) = (r18v3 androidx.compose.ui.text.font.FontStyle), (r18v7 androidx.compose.ui.text.font.FontStyle) binds: [B:78:0x0169, B:75:0x0163] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private static final Saver TextIndentSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope saverScope, TextIndent textIndent) {
            TextUnit textUnitM1931boximpl = TextUnit.m1931boximpl(textIndent.m1827getFirstLineXSAIIZE());
            TextUnit.Companion companion = TextUnit.Companion;
            return CollectionsKt.arrayListOf(SaversKt.save(textUnitM1931boximpl, SaversKt.getSaver(companion), saverScope), SaversKt.save(TextUnit.m1931boximpl(textIndent.m1828getRestLineXSAIIZE()), SaversKt.getSaver(companion), saverScope));
        }
        ...
        public final TextIndent invoke(Object obj) {
            ...
            textUnit2.getClass();
            long jM1940unboximpl = textUnit2.m1940unboximpl();
            Object obj3 = list.get(1);
            ...
            textUnit.getClass();
            return new TextIndent(jM1940unboximpl, textUnit.m1940unboximpl(), null);
        }
    });
    ...
    private static final Saver BaselineShiftSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            return m1555invoke8a2Sb4w((SaverScope) obj, ((BaselineShift) obj2).m1723unboximpl());
        }

        /* JADX INFO: renamed from: invoke-8a2Sb4w, reason: not valid java name */
        public final Object m1555invoke8a2Sb4w(SaverScope saverScope, float f) {
        ...
        public final BaselineShift invoke(Object obj) {
            obj.getClass();
            return BaselineShift.m1717boximpl(BaselineShift.m1718constructorimpl(((Float) obj).floatValue()));
        }
    });
    private static final Saver TextRangeSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            return m1561invokeFDrldGo((SaverScope) obj, ((TextRange) obj2).m1599unboximpl());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX INFO: renamed from: invoke-FDrldGo, reason: not valid java name */
        public final Object m1561invokeFDrldGo(SaverScope saverScope, long j) {
            return CollectionsKt.arrayListOf(SaversKt.save(Integer.valueOf(TextRange.m1596getStartimpl(j))), SaversKt.save(Integer.valueOf(TextRange.m1593getEndimpl(j))));
        }
        ...
        public final TextRange invoke(Object obj) {
            ...
            num2.getClass();
            return TextRange.m1588boximpl(TextRangeKt.TextRange(iIntValue, num2.intValue()));
        }
    });
    private static final Saver ShadowSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope saverScope, Shadow shadow) {
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m876boximpl(shadow.m981getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope), SaversKt.save(Offset.m751boximpl(shadow.m982getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), saverScope), SaversKt.save(Float.valueOf(shadow.getBlurRadius())));
        }
        ...
        public final Shadow invoke(Object obj) {
            ...
            color.getClass();
            long jM890unboximpl = color.m890unboximpl();
            Object obj3 = list.get(1);
            ...
            offset.getClass();
            long jM767unboximpl = offset.m767unboximpl();
            Object obj4 = list.get(2);
            Float f = obj4 != null ? (Float) obj4 : null;
            f.getClass();
            return new Shadow(jM890unboximpl, jM767unboximpl, f.floatValue(), null);
        }
    });
    private static final NonNullValueClassSaver ColorSaver = NonNullValueClassSaver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            return m1557invoke4WTKRHQ((SaverScope) obj, ((Color) obj2).m890unboximpl());
        }

        /* JADX INFO: renamed from: invoke-4WTKRHQ, reason: not valid java name */
        public final Object m1557invoke4WTKRHQ(SaverScope saverScope, long j) {
            return j == 16 ? Boolean.FALSE : Integer.valueOf(ColorKt.m900toArgb8_81llA(j));
        }
        ...
        public final Color invoke(Object obj) {
            if (Intrinsics.areEqual(obj, Boolean.FALSE)) {
                return Color.m876boximpl(Color.Companion.m895getUnspecified0d7_KjU());
            }
            obj.getClass();
            return Color.m876boximpl(ColorKt.Color(((Integer) obj).intValue()));
        }
    });
    private static final NonNullValueClassSaver TextUnitSaver = NonNullValueClassSaver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            return m1563invokempE4wyQ((SaverScope) obj, ((TextUnit) obj2).m1940unboximpl());
        }

        /* JADX INFO: renamed from: invoke-mpE4wyQ, reason: not valid java name */
        public final Object m1563invokempE4wyQ(SaverScope saverScope, long j) {
            return TextUnit.m1934equalsimpl0(j, TextUnit.Companion.m1941getUnspecifiedXSAIIZE()) ? Boolean.FALSE : CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m1937getValueimpl(j))), SaversKt.save(TextUnitType.m1944boximpl(TextUnit.m1936getTypeUIouoOA(j))));
        }
        ...
        public final TextUnit invoke(Object obj) {
            if (Intrinsics.areEqual(obj, Boolean.FALSE)) {
                return TextUnit.m1931boximpl(TextUnit.Companion.m1941getUnspecifiedXSAIIZE());
            }
            obj.getClass();
            List list = (List) obj;
            Object obj2 = list.get(0);
            ...
            return TextUnit.m1931boximpl(TextUnitKt.m1942TextUnitanM5pPY(fFloatValue, textUnitType.m1950unboximpl()));
        }
    });
    private static final NonNullValueClassSaver OffsetSaver = NonNullValueClassSaver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            return m1559invokeUv8p0NA((SaverScope) obj, ((Offset) obj2).m767unboximpl());
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX INFO: renamed from: invoke-Uv8p0NA, reason: not valid java name */
        public final Object m1559invokeUv8p0NA(SaverScope saverScope, long j) {
            return Offset.m757equalsimpl0(j, Offset.Companion.m769getUnspecifiedF1C5BW0()) ? Boolean.FALSE : CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(Float.intBitsToFloat((int) (j >> 32)))), SaversKt.save(Float.valueOf(Float.intBitsToFloat((int) (j & 4294967295L)))));
        }
        ...
        public final Offset invoke(Object obj) {
            if (Intrinsics.areEqual(obj, Boolean.FALSE)) {
                return Offset.m751boximpl(Offset.Companion.m769getUnspecifiedF1C5BW0());
            }
            obj.getClass();
            List list = (List) obj;
            Object obj2 = list.get(0);
            ...
            f2.getClass();
            return Offset.m751boximpl(Offset.m752constructorimpl((((long) Float.floatToRawIntBits(f2.floatValue())) & 4294967295L) | (((long) Float.floatToRawIntBits(fFloatValue)) << 32)));
        }
    });
    ...
    private static final Saver LineHeightStyleSaver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.SaversKt$LineHeightStyleSaver$1
        ...
        public final Object invoke(SaverScope saverScope, LineHeightStyle lineHeightStyle) {
            return CollectionsKt.arrayListOf(SaversKt.save(LineHeightStyle.Alignment.m1769boximpl(lineHeightStyle.m1766getAlignmentPIaL0Z0())), SaversKt.save(LineHeightStyle.Trim.m1787boximpl(lineHeightStyle.m1768getTrimEVpEnUU())), SaversKt.save(LineHeightStyle.Mode.m1778boximpl(lineHeightStyle.m1767getModelzQqcRY())));
        }
        ...
        public final LineHeightStyle invoke(Object obj) {
            ...
            alignment.getClass();
            float fM1775unboximpl = alignment.m1775unboximpl();
            Object obj3 = list.get(1);
            LineHeightStyle.Trim trim = obj3 != null ? (LineHeightStyle.Trim) obj3 : null;
            trim.getClass();
            int iM1795unboximpl = trim.m1795unboximpl();
            Object obj4 = list.get(2);
            LineHeightStyle.Mode mode = obj4 != null ? (LineHeightStyle.Mode) obj4 : null;
            mode.getClass();
            return new LineHeightStyle(fM1775unboximpl, iM1795unboximpl, mode.m1784unboximpl(), null);
        }
    });
