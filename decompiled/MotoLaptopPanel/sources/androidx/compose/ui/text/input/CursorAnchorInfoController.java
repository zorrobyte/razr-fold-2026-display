...
public final class CursorAnchorInfoController {
    ...
    private Function1 textFieldToRootTransform = new Function1() { // from class: androidx.compose.ui.text.input.CursorAnchorInfoController$textFieldToRootTransform$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            m1651invoke58bKbWc(((Matrix) obj).m954unboximpl());
            return Unit.INSTANCE;
        }

        /* JADX INFO: renamed from: invoke-58bKbWc, reason: not valid java name */
        public final void m1651invoke58bKbWc(float[] fArr) {
        }
    };
    private final CursorAnchorInfo.Builder builder = new CursorAnchorInfo.Builder();
    private final float[] matrix = Matrix.m941constructorimpl$default(null, 1, null);
    ...
    private final void updateCursorAnchorInfo() {
        if (this.inputMethodManager.isActive()) {
            this.textFieldToRootTransform.invoke(Matrix.m939boximpl(this.matrix));
            this.rootPositionCalculator.mo1204localToScreen58bKbWc(this.matrix);
            AndroidMatrixConversions_androidKt.m808setFromEL8BTi8(this.androidMatrix, this.matrix);
