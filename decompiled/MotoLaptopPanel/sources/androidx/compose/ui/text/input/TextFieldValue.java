...
public final class TextFieldValue {
    ...
    private static final Saver Saver = SaverKt.Saver(new Function2() { // from class: androidx.compose.ui.text.input.TextFieldValue$Companion$Saver$1
        ...
        public final Object invoke(SaverScope saverScope, TextFieldValue textFieldValue) {
            return CollectionsKt.arrayListOf(SaversKt.save(textFieldValue.getAnnotatedString(), SaversKt.getAnnotatedStringSaver(), saverScope), SaversKt.save(TextRange.m1588boximpl(textFieldValue.m1692getSelectiond9O1mEE()), SaversKt.getSaver(TextRange.Companion), saverScope));
        }
        ...
        public final TextFieldValue invoke(Object obj) {
            ...
            textRange.getClass();
            return new TextFieldValue(annotatedString, textRange.m1599unboximpl(), (TextRange) null, 4, (DefaultConstructorMarker) null);
        }
    });
    ...
    private TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange) {
        ...
        this.selection = TextRangeKt.m1601coerceIn8ffj60Q(j, 0, getText().length());
        this.composition = textRange != null ? TextRange.m1588boximpl(TextRangeKt.m1601coerceIn8ffj60Q(textRange.m1599unboximpl(), 0, getText().length())) : null;
    }
    ...
    public /* synthetic */ TextFieldValue(AnnotatedString annotatedString, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, (i & 2) != 0 ? TextRange.Companion.m1600getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.Companion.m1600getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return TextRange.m1591equalsimpl0(this.selection, textFieldValue.selection) && Intrinsics.areEqual(this.composition, textFieldValue.composition) && Intrinsics.areEqual(this.annotatedString, textFieldValue.annotatedString);
    }
    ...
    public int hashCode() {
        int iHashCode = ((this.annotatedString.hashCode() * 31) + TextRange.m1597hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return iHashCode + (textRange != null ? TextRange.m1597hashCodeimpl(textRange.m1599unboximpl()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + ((Object) this.annotatedString) + "', selection=" + ((Object) TextRange.m1598toStringimpl(this.selection)) + ", composition=" + this.composition + ')';
    }
}
