...
public final class GraphicsLayer {
    ...
    private final Function1 clipDrawBlock = new Function1() { // from class: androidx.compose.ui.graphics.layer.GraphicsLayer$clipDrawBlock$1
        ...
        public final void invoke(DrawScope drawScope) {
            ...
            try {
                drawContext.getTransform().mo1067clipPathmtrdDE(path, iM875getIntersectrtfAjoo);
    ...
    public GraphicsLayer(GraphicsLayerImpl graphicsLayerImpl, LayerManager layerManager) {
        ...
        this.roundRectOutlineTopLeft = companion.m770getZeroF1C5BW0();
        this.roundRectOutlineSize = Size.Companion.m793getUnspecifiedNHjbRc();
        this.childDependenciesTracker = new ChildLayerDependenciesTracker();
        graphicsLayerImpl.setClip(false);
        this.topLeft = IntOffset.Companion.m1913getZeronOccac();
        this.size = IntSize.Companion.m1927getZeroYbymL2g();
        this.pivotOffset = companion.m769getUnspecifiedF1C5BW0();
    }
        ...
        if (this.outlineDirty) {
            ...
            if (this.clip || getShadowElevation() > 0.0f) {
                ...
                if (path != null) {
                    ...
                    this.impl.mo1116setOutlineO0kMr_c(outline, IntSize.m1919constructorimpl((4294967295L & ((long) Math.round(rectFObtainPathBounds.height()))) | (((long) Math.round(rectFObtainPathBounds.width())) << 32)));
                    ...
                    this.impl.setClip(this.clip);
                    Size.Companion.m794getZeroNHjbRc();
                    Outline outlineObtainAndroidOutline = obtainAndroidOutline();
                    long jM1930toSizeozmzZPI = IntSizeKt.m1930toSizeozmzZPI(this.size);
                    long j = this.roundRectOutlineTopLeft;
                    long j2 = this.roundRectOutlineSize;
                    long j3 = j2 == 9205357640488583168L ? jM1930toSizeozmzZPI : j2;
                    int i = (int) (j >> 32);
                    ...
                    this.impl.mo1116setOutlineO0kMr_c(outlineObtainAndroidOutline, IntSizeKt.m1929roundToIntSizeuvyYCjk(j3));
                }
            } else {
                this.impl.setClip(false);
                this.impl.mo1116setOutlineO0kMr_c(null, IntSize.Companion.m1927getZeroYbymL2g());
            }
        }
    ...
    */
    ...
    private final void resetOutlineParams() {
        ...
        this.roundRectOutlineSize = Size.Companion.m793getUnspecifiedNHjbRc();
        this.roundRectOutlineTopLeft = Offset.Companion.m770getZeroF1C5BW0();
    ...
    private final void m1094setPositionVbeCjmY(long j, long j2) {
        this.impl.mo1118setPositionH0pRuoY(IntOffset.m1905getXimpl(j), IntOffset.m1906getYimpl(j), j2);
    }

    /* JADX INFO: renamed from: setSize-ozmzZPI, reason: not valid java name */
    private final void m1095setSizeozmzZPI(long j) {
        if (IntSize.m1921equalsimpl0(this.size, j)) {
            return;
        }
        this.size = j;
        m1094setPositionVbeCjmY(this.topLeft, j);
    ...
    private final void transformCanvas(Canvas canvas) {
        Canvas canvas2;
        float fM1905getXimpl = IntOffset.m1905getXimpl(this.topLeft);
        float fM1906getYimpl = IntOffset.m1906getYimpl(this.topLeft);
        float fM1905getXimpl2 = IntOffset.m1905getXimpl(this.topLeft) + ((int) (this.size >> 32));
        float fM1906getYimpl2 = IntOffset.m1906getYimpl(this.topLeft) + ((int) (this.size & 4294967295L));
        float alpha = getAlpha();
        ColorFilter colorFilter = getColorFilter();
        int iM1096getBlendMode0nO6VwU = m1096getBlendMode0nO6VwU();
        if (alpha < 1.0f || !BlendMode.m832equalsimpl0(iM1096getBlendMode0nO6VwU, BlendMode.Companion.m862getSrcOver0nO6VwU()) || colorFilter != null || CompositingStrategy.m1090equalsimpl0(m1097getCompositingStrategyke2Ky5w(), CompositingStrategy.Companion.m1093getOffscreenke2Ky5w())) {
            ...
            Paint.mo815setBlendModes9anfk8(iM1096getBlendMode0nO6VwU);
            Paint.setColorFilter(colorFilter);
            canvas2 = canvas;
            canvas2.saveLayer(fM1905getXimpl, fM1906getYimpl, fM1905getXimpl2, fM1906getYimpl2, Paint.asFrameworkPaint());
        } else {
            canvas.save();
            canvas2 = canvas;
        }
        canvas2.translate(fM1905getXimpl, fM1906getYimpl);
    ...
    */
    ...
    public final void draw$ui_graphics_release(androidx.compose.ui.graphics.Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        if (z4) {
            ...
            if (outline instanceof Outline.Rectangle) {
                androidx.compose.ui.graphics.Canvas.m870clipRectmtrdDE$default(canvas, outline.getBounds(), 0, 2, null);
                ...
                androidx.compose.ui.graphics.Canvas.m868clipPathmtrdDE$default(canvas, Path, 0, 2, null);
            } else if (outline instanceof Outline.Generic) {
                androidx.compose.ui.graphics.Canvas.m868clipPathmtrdDE$default(canvas, ((Outline.Generic) outline).getPath(), 0, 2, null);
            }
        }
        ...
        if (AndroidCanvas_androidKt.getNativeCanvas(canvas).isHardwareAccelerated() || this.impl.getSupportsSoftwareRendering()) {
            ...
            drawContext.mo1066setSizeuvyYCjk(jM1930toSizeozmzZPI);
    ...
    public final int m1096getBlendMode0nO6VwU() {
        return this.impl.mo1110getBlendMode0nO6VwU();
    }
    ...
    public final int m1097getCompositingStrategyke2Ky5w() {
        return this.impl.mo1111getCompositingStrategyke2Ky5w();
    }
    ...
    public final androidx.compose.ui.graphics.Outline getOutline() {
        ...
        if (j2 != 9205357640488583168L) {
            jM1930toSizeozmzZPI = j2;
        }
        float fIntBitsToFloat = Float.intBitsToFloat((int) (j >> 32));
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (j & 4294967295L));
        float fIntBitsToFloat3 = Float.intBitsToFloat((int) (jM1930toSizeozmzZPI >> 32)) + fIntBitsToFloat;
        float fIntBitsToFloat4 = fIntBitsToFloat2 + Float.intBitsToFloat((int) (jM1930toSizeozmzZPI & 4294967295L));
        float f = this.roundRectCornerRadius;
        if (f > 0.0f) {
            rectangle = new Outline.Rounded(RoundRectKt.m781RoundRectgG7oq9Y(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat3, fIntBitsToFloat4, CornerRadius.m745constructorimpl((((long) Float.floatToRawIntBits(f)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(f))))));
        } else {
    ...
    public final long m1098getPivotOffsetF1C5BW0() {
    ...
    public final long m1099getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final void m1100recordmLhObY(Density density, LayoutDirection layoutDirection, long j, Function1 function1) {
        m1095setSizeozmzZPI(j);
    ...
    public final void m1101setAmbientShadowColor8_81llA(long j) {
        if (Color.m882equalsimpl0(j, this.impl.mo1109getAmbientShadowColor0d7_KjU())) {
            return;
        }
        this.impl.mo1113setAmbientShadowColor8_81llA(j);
    }

    /* JADX INFO: renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m1102setBlendModes9anfk8(int i) {
        if (BlendMode.m832equalsimpl0(this.impl.mo1110getBlendMode0nO6VwU(), i)) {
            return;
        }
        this.impl.mo1114setBlendModes9anfk8(i);
    }
    ...
    public final void m1103setCompositingStrategyWpw9cng(int i) {
        if (CompositingStrategy.m1090equalsimpl0(this.impl.mo1111getCompositingStrategyke2Ky5w(), i)) {
            return;
        }
        this.impl.mo1115setCompositingStrategyWpw9cng(i);
    }
    ...
    public final void m1104setPivotOffsetk4lQ0M(long j) {
        if (Offset.m757equalsimpl0(this.pivotOffset, j)) {
            return;
        }
        this.pivotOffset = j;
        this.impl.mo1117setPivotOffsetk4lQ0M(j);
    }

    /* JADX INFO: renamed from: setRectOutline-tz77jQw, reason: not valid java name */
    public final void m1105setRectOutlinetz77jQw(long j, long j2) {
        m1106setRoundRectOutlineTNW_H78(j, j2, 0.0f);
    }
    ...
    public final void m1106setRoundRectOutlineTNW_H78(long j, long j2, float f) {
        if (Offset.m757equalsimpl0(this.roundRectOutlineTopLeft, j) && Size.m785equalsimpl0(this.roundRectOutlineSize, j2) && this.roundRectCornerRadius == f && this.outlinePath == null) {
            return;
        }
        resetOutlineParams();
    ...
    public final void m1107setSpotShadowColor8_81llA(long j) {
        if (Color.m882equalsimpl0(j, this.impl.mo1112getSpotShadowColor0d7_KjU())) {
            return;
        }
        this.impl.mo1119setSpotShadowColor8_81llA(j);
    }

    /* JADX INFO: renamed from: setTopLeft--gyyYBs, reason: not valid java name */
    public final void m1108setTopLeftgyyYBs(long j) {
        if (IntOffset.m1904equalsimpl0(this.topLeft, j)) {
            return;
        }
        this.topLeft = j;
        m1094setPositionVbeCjmY(j, this.size);
    }
