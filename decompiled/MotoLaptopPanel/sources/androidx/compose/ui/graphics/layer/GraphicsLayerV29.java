...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.Companion.m794getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        CompositingStrategy.Companion companion = CompositingStrategy.Companion;
        m1120applyCompositingStrategyZ1X6vPc(renderNode, companion.m1091getAutoke2Ky5w());
        this.alpha = 1.0f;
        this.blendMode = BlendMode.Companion.m862getSrcOver0nO6VwU();
        this.pivotOffset = Offset.Companion.m769getUnspecifiedF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        Color.Companion companion2 = Color.Companion;
        this.ambientShadowColor = companion2.m891getBlack0d7_KjU();
        this.spotShadowColor = companion2.m891getBlack0d7_KjU();
        this.cameraDistance = 8.0f;
        this.compositingStrategy = companion.m1091getAutoke2Ky5w();
    ...
    private final void m1120applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        CompositingStrategy.Companion companion = CompositingStrategy.Companion;
        if (CompositingStrategy.m1090equalsimpl0(i, companion.m1093getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m1090equalsimpl0(i, companion.m1092getModulateAlphake2Ky5w())) {
    ...
    private final boolean requiresCompositingLayer() {
        if (CompositingStrategy.m1090equalsimpl0(mo1111getCompositingStrategyke2Ky5w(), CompositingStrategy.Companion.m1093getOffscreenke2Ky5w()) || requiresLayerPaint()) {
            return true;
        }
        getRenderEffect();
        return false;
    ...
    private final boolean requiresLayerPaint() {
        return (BlendMode.m832equalsimpl0(mo1110getBlendMode0nO6VwU(), BlendMode.Companion.m862getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m1120applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.Companion.m1093getOffscreenke2Ky5w());
        } else {
            m1120applyCompositingStrategyZ1X6vPc(this.renderNode, mo1111getCompositingStrategyke2Ky5w());
        }
    }
    ...
    public long mo1109getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    @Override // androidx.compose.ui.graphics.layer.GraphicsLayerImpl
    /* JADX INFO: renamed from: getBlendMode-0nO6VwU */
    public int mo1110getBlendMode0nO6VwU() {
    ...
    public int mo1111getCompositingStrategyke2Ky5w() {
    ...
    public long mo1112getSpotShadowColor0d7_KjU() {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer graphicsLayer, Function1 function1) {
        ...
        try {
            ...
            drawContext.mo1066setSizeuvyYCjk(this.size);
    ...
    public void mo1113setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
        this.renderNode.setAmbientShadowColor(ColorKt.m900toArgb8_81llA(j));
    }

    @Override // androidx.compose.ui.graphics.layer.GraphicsLayerImpl
    /* JADX INFO: renamed from: setBlendMode-s9anfk8 */
    public void mo1114setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m797toAndroidBlendModes9anfk8(i));
    ...
    public void mo1115setCompositingStrategyWpw9cng(int i) {
    ...
    public void mo1116setOutlineO0kMr_c(Outline outline, long j) {
    ...
    public void mo1117setPivotOffsetk4lQ0M(long j) {
        this.pivotOffset = j;
    ...
    public void mo1118setPositionH0pRuoY(int i, int i2, long j) {
        this.renderNode.setPosition(i, i2, ((int) (j >> 32)) + i, ((int) (4294967295L & j)) + i2);
        this.size = IntSizeKt.m1930toSizeozmzZPI(j);
    }
    ...
    public void mo1119setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
        this.renderNode.setSpotShadowColor(ColorKt.m900toArgb8_81llA(j));
    }
