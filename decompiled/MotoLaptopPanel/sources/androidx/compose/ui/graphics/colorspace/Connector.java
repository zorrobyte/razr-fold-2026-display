...
public class Connector {
    ...
    public final class Companion {
        ...
        public final float[] m1035computeTransformYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
            if (!RenderIntent.m1038equalsimpl0(i, RenderIntent.Companion.m1039getAbsoluteuksYyKA())) {
                return null;
            }
            long jM1027getModelxdoWZVw = colorSpace.m1027getModelxdoWZVw();
            ColorModel.Companion companion = ColorModel.Companion;
            boolean zM1020equalsimpl0 = ColorModel.m1020equalsimpl0(jM1027getModelxdoWZVw, companion.m1025getRgbxdoWZVw());
            boolean zM1020equalsimpl02 = ColorModel.m1020equalsimpl0(colorSpace2.m1027getModelxdoWZVw(), companion.m1025getRgbxdoWZVw());
            if (zM1020equalsimpl0 && zM1020equalsimpl02) {
                return null;
            }
            if (!zM1020equalsimpl0 && !zM1020equalsimpl02) {
                return null;
            }
            if (!zM1020equalsimpl0) {
                colorSpace = colorSpace2;
            }
            Rgb rgb = (Rgb) colorSpace;
            float[] xyz$ui_graphics_release = zM1020equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = zM1020equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace colorSpace) {
            final int iM1041getRelativeuksYyKA = RenderIntent.Companion.m1041getRelativeuksYyKA();
            return new Connector(colorSpace, iM1041getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                {
                    super(colorSpace, colorSpace, iM1041getRelativeuksYyKA, null);
                }

                @Override // androidx.compose.ui.graphics.colorspace.Connector
                /* JADX INFO: renamed from: transformToColor-l2rxGTc$ui_graphics_release */
                public long mo1033transformToColorl2rxGTc$ui_graphics_release(long j) {
                    return j;
                }
            };
        }
    ...
    public final class RgbConnector extends Connector {
        ...
        private RgbConnector(Rgb rgb, Rgb rgb2, int i) {
            ...
            this.mTransform = m1036computeTransformYBCOT_4(rgb, rgb2, i);
        }
        ...
        /* JADX INFO: renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        private final float[] m1036computeTransformYBCOT_4(Rgb rgb, Rgb rgb2, int i) {
        ...
        /* JADX INFO: renamed from: transformToColor-l2rxGTc$ui_graphics_release */
        public long mo1033transformToColorl2rxGTc$ui_graphics_release(long j) {
            float fM887getRedimpl = Color.m887getRedimpl(j);
            float fM886getGreenimpl = Color.m886getGreenimpl(j);
            float fM884getBlueimpl = Color.m884getBlueimpl(j);
            float fM883getAlphaimpl = Color.m883getAlphaimpl(j);
            float fInvoke = (float) this.mSource.getEotfFunc$ui_graphics_release().invoke(fM887getRedimpl);
            float fInvoke2 = (float) this.mSource.getEotfFunc$ui_graphics_release().invoke(fM886getGreenimpl);
            float fInvoke3 = (float) this.mSource.getEotfFunc$ui_graphics_release().invoke(fM884getBlueimpl);
            float[] fArr = this.mTransform;
            return ColorKt.Color((float) this.mDestination.getOetfFunc$ui_graphics_release().invoke((fArr[0] * fInvoke) + (fArr[3] * fInvoke2) + (fArr[6] * fInvoke3)), (float) this.mDestination.getOetfFunc$ui_graphics_release().invoke((fArr[1] * fInvoke) + (fArr[4] * fInvoke2) + (fArr[7] * fInvoke3)), (float) this.mDestination.getOetfFunc$ui_graphics_release().invoke((fArr[2] * fInvoke) + (fArr[5] * fInvoke2) + (fArr[8] * fInvoke3)), fM883getAlphaimpl, this.mDestination);
        }
    }
    ...
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        long jM1027getModelxdoWZVw = colorSpace.m1027getModelxdoWZVw();
        ColorModel.Companion companion = ColorModel.Companion;
        this(colorSpace, colorSpace2, ColorModel.m1020equalsimpl0(jM1027getModelxdoWZVw, companion.m1025getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace, ColorModel.m1020equalsimpl0(colorSpace2.m1027getModelxdoWZVw(), companion.m1025getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), null, 2, null) : colorSpace2, i, Companion.m1035computeTransformYBCOT_4(colorSpace, colorSpace2, i), null);
    }
    ...
    public long mo1033transformToColorl2rxGTc$ui_graphics_release(long j) {
        ...
        float fM884getBlueimpl = Color.m884getBlueimpl(j);
        float fM883getAlphaimpl = Color.m883getAlphaimpl(j);
        long xy$ui_graphics_release = this.transformSource.toXy$ui_graphics_release(fM887getRedimpl, fM886getGreenimpl, fM884getBlueimpl);
        ...
        float z$ui_graphics_release = this.transformSource.toZ$ui_graphics_release(fM887getRedimpl, fM886getGreenimpl, fM884getBlueimpl);
        ...
        return this.transformDestination.mo1028xyzaToColorJlNiLsg$ui_graphics_release(f, fIntBitsToFloat2, z$ui_graphics_release, fM883getAlphaimpl, this.destination);
    }
}
