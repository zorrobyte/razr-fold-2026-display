...
public abstract class ColorSpaceKt {
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (ColorModel.m1020equalsimpl0(colorSpace.m1027getModelxdoWZVw(), ColorModel.Companion.m1025getRgbxdoWZVw())) {
    ...
    public static final Connector m1029connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        if ((id$ui_graphics_release | id$ui_graphics_release2) < 0) {
            return m1031createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        MutableIntObjectMap connectors = ConnectorKt.getConnectors();
        int i2 = id$ui_graphics_release | (id$ui_graphics_release2 << 6) | (i << 12);
        Object objM1031createConnectorYBCOT_4 = connectors.get(i2);
        if (objM1031createConnectorYBCOT_4 == null) {
            objM1031createConnectorYBCOT_4 = m1031createConnectorYBCOT_4(colorSpace, colorSpace2, i);
            connectors.set(i2, objM1031createConnectorYBCOT_4);
        }
        return (Connector) objM1031createConnectorYBCOT_4;
    }

    /* JADX INFO: renamed from: connect-YBCOT_4$default, reason: not valid java name */
    public static /* synthetic */ Connector m1030connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m1040getPerceptualuksYyKA();
        }
        return m1029connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* JADX INFO: renamed from: createConnector-YBCOT_4, reason: not valid java name */
    private static final Connector m1031createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        return (ColorModel.m1020equalsimpl0(jM1027getModelxdoWZVw, companion.m1025getRgbxdoWZVw()) && ColorModel.m1020equalsimpl0(colorSpace2.m1027getModelxdoWZVw(), companion.m1025getRgbxdoWZVw())) ? new Connector.RgbConnector((Rgb) colorSpace, (Rgb) colorSpace2, i, defaultConstructorMarker) : new Connector(colorSpace, colorSpace2, i, defaultConstructorMarker);
    }
