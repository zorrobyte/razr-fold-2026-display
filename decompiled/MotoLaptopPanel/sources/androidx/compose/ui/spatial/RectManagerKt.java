...
public abstract class RectManagerKt {
    ...
    public static final int m1511analyzeComponents58bKbWc(float[] fArr) {
        int i = 0;
        if (fArr.length < 16) {
            return 0;
        }
    ...
    public static final boolean m1512isSetgyyYBs(long j) {
        return !IntOffset.m1904equalsimpl0(j, IntOffset.Companion.m1912getMaxnOccac());
    }
}
