...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    final class FrameAwaiter {
        ...
        public final void resume(long j) {
            ...
            try {
                ...
                objM2192constructorimpl = Result.m2192constructorimpl(this.onFrame.invoke(Long.valueOf(j)));
            } catch (Throwable th) {
        ...
        synchronized (this.lock) {
            try {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    Result.Companion companion = Result.Companion;
                    continuation.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(th)));
                }
                this.awaiters.clear();
    ...
    public Object withFrameNanos(Function1 function1, Continuation continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m2192constructorimpl(ResultKt.createFailure(th)));
            } else {
