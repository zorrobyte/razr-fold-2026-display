...
public final class MultiValueMap {
    ...
    public static final void m625addimpl(MutableScatterMap mutableScatterMap, Object obj, Object obj2) {
    ...
    public static final /* synthetic */ MultiValueMap m626boximpl(MutableScatterMap mutableScatterMap) {
        return new MultiValueMap(mutableScatterMap);
    }

    /* JADX INFO: renamed from: clear-impl, reason: not valid java name */
    public static final void m627clearimpl(MutableScatterMap mutableScatterMap) {
        mutableScatterMap.clear();
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static MutableScatterMap m628constructorimpl(MutableScatterMap mutableScatterMap) {
        return mutableScatterMap;
    }

    /* JADX INFO: renamed from: constructor-impl$default, reason: not valid java name */
    public static /* synthetic */ MutableScatterMap m629constructorimpl$default(MutableScatterMap mutableScatterMap, int i, DefaultConstructorMarker defaultConstructorMarker) {
        int i2 = 1;
        if ((i & 1) != 0) {
            mutableScatterMap = new MutableScatterMap(0, i2, null);
        }
        return m628constructorimpl(mutableScatterMap);
    }

    /* JADX INFO: renamed from: contains-impl, reason: not valid java name */
    public static final boolean m630containsimpl(MutableScatterMap mutableScatterMap, Object obj) {
        return mutableScatterMap.contains(obj);
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m631equalsimpl(MutableScatterMap mutableScatterMap, Object obj) {
        return (obj instanceof MultiValueMap) && Intrinsics.areEqual(mutableScatterMap, ((MultiValueMap) obj).m640unboximpl());
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m632hashCodeimpl(MutableScatterMap mutableScatterMap) {
        return mutableScatterMap.hashCode();
    }

    /* JADX INFO: renamed from: isEmpty-impl, reason: not valid java name */
    public static final boolean m633isEmptyimpl(MutableScatterMap mutableScatterMap) {
        return mutableScatterMap.isEmpty();
    }

    /* JADX INFO: renamed from: isNotEmpty-impl, reason: not valid java name */
    public static final boolean m634isNotEmptyimpl(MutableScatterMap mutableScatterMap) {
        return mutableScatterMap.isNotEmpty();
    }

    /* JADX INFO: renamed from: removeFirst-impl, reason: not valid java name */
    public static final Object m635removeFirstimpl(MutableScatterMap mutableScatterMap, Object obj) {
    ...
    public static final Object m636removeLastimpl(MutableScatterMap mutableScatterMap, Object obj) {
        Object obj2 = mutableScatterMap.get(obj);
        if (obj2 == null) {
            return null;
        }
    ...
    public static final void m637removeValueIfimpl(MutableScatterMap mutableScatterMap, Object obj, Function1 function1) {
        Object obj2 = mutableScatterMap.get(obj);
        if (obj2 != null) {
            if (!(obj2 instanceof MutableObjectList)) {
    ...
    public static String m638toStringimpl(MutableScatterMap mutableScatterMap) {
    ...
    */
    public static final androidx.collection.ObjectList m639valuesimpl(androidx.collection.MutableScatterMap r14) {
        /*
        ...
        L65:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.collection.MultiValueMap.m639valuesimpl(androidx.collection.MutableScatterMap):androidx.collection.ObjectList");
    }

    public boolean equals(Object obj) {
        return m631equalsimpl(this.map, obj);
    }

    public int hashCode() {
        return m632hashCodeimpl(this.map);
    }

    public String toString() {
        return m638toStringimpl(this.map);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ MutableScatterMap m640unboximpl() {
        return this.map;
    }
}
