...
public final class TrieNode {
    ...
    private final TrieNode mutableCollisionPutAll(TrieNode trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        CommonFunctionsKt.m650assert(this.nodeMap == 0);
        CommonFunctionsKt.m650assert(this.dataMap == 0);
        CommonFunctionsKt.m650assert(trieNode.nodeMap == 0);
        CommonFunctionsKt.m650assert(trieNode.dataMap == 0);
        Object[] objArr = this.buffer;
