...
public final class Recomposer extends CompositionContext {
    ...
    /* JADX INFO: compiled from: Recomposer.kt */
    final class C00502 extends SuspendLambda implements Function2 {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00502(Function3 function3, MonotonicFrameClock monotonicFrameClock, Continuation continuation) {
            super(2, continuation);
            this.$block = function3;
            this.$parentFrameClock = monotonicFrameClock;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            C00502 c00502 = Recomposer.this.new C00502(this.$block, this.$parentFrameClock, continuation);
            c00502.L$0 = obj;
            return c00502;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r10) throws java.lang.Throwable {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.Recomposer.C00502.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    /* JADX INFO: compiled from: Recomposer.kt */
    final class C00512 extends SuspendLambda implements Function3 {
        /* synthetic */ Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        */
        public static final void invokeSuspend$clearRecompositionState(androidx.compose.runtime.Recomposer r22, java.util.List r23, java.util.List r24, java.util.List r25, androidx.collection.MutableScatterSet r26, androidx.collection.MutableScatterSet r27, androidx.collection.MutableScatterSet r28, androidx.collection.MutableScatterSet r29) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.Recomposer.C00512.invokeSuspend$clearRecompositionState(androidx.compose.runtime.Recomposer, java.util.List, java.util.List, java.util.List, androidx.collection.MutableScatterSet, androidx.collection.MutableScatterSet, androidx.collection.MutableScatterSet, androidx.collection.MutableScatterSet):void");
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, MonotonicFrameClock monotonicFrameClock, Continuation continuation) {
            C00512 c00512 = Recomposer.this.new C00512(continuation);
            c00512.L$0 = monotonicFrameClock;
    ...
    public Recomposer(CoroutineContext coroutineContext) {
        BroadcastFrameClock broadcastFrameClock = new BroadcastFrameClock(new Function0() { // from class: androidx.compose.runtime.Recomposer$broadcastFrameClock$1
            ...
            public final void m599invoke() {
                ...
                if (cancellableContinuationDeriveStateLocked != null) {
                    ...
                    cancellableContinuationDeriveStateLocked.resumeWith(Result.m2192constructorimpl(Unit.INSTANCE));
                }
            }
        });
        ...
        this.movableContentRemoved = MultiValueMap.m629constructorimpl$default(null, 1, null);
        ...
        this.movableContentNestedExtractionsPending = MultiValueMap.m629constructorimpl$default(null, 1, null);
        ...
        completableJobJob.invokeOnCompletion(new Function1() { // from class: androidx.compose.runtime.Recomposer$effectJob$1$1
            ...
            public final void invoke(final Throwable th) {
                ...
                if (cancellableContinuation != null) {
                    Result.Companion companion = Result.Companion;
                    cancellableContinuation.resumeWith(Result.m2192constructorimpl(Unit.INSTANCE));
                }
            }
        });
    ...
    private final void clearKnownCompositionsLocked() {
        ...
        if (mutableObjectList != null) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(objArr[i2]);
    ...
    public final void discardUnusedMovableContentState() {
        ...
        synchronized (this.stateLock) {
            try {
                if (MultiValueMap.m634isNotEmptyimpl(this.movableContentRemoved)) {
                    ObjectList objectListM639valuesimpl = MultiValueMap.m639valuesimpl(this.movableContentRemoved);
                    MultiValueMap.m627clearimpl(this.movableContentRemoved);
                    this.movableContentNestedStatesAvailable.clear();
                    MultiValueMap.m627clearimpl(this.movableContentNestedExtractionsPending);
                    MutableObjectList mutableObjectList = new MutableObjectList(objectListM639valuesimpl.getSize());
                    Object[] objArr = objectListM639valuesimpl.content;
                    int i2 = objectListM639valuesimpl._size;
    ...
    */
    ...
    private final Object recompositionRunner(Function3 function3, Continuation continuation) {
        Object objWithContext = BuildersKt.withContext(this.broadcastFrameClock, new C00502(function3, MonotonicFrameClockKt.getMonotonicFrameClock(continuation.getContext()), null), continuation);
    ...
    public final Object runRecomposeAndApplyChanges(Continuation continuation) {
        Object objRecompositionRunner = recompositionRunner(new C00512(null), continuation);
