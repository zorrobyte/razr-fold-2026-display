...
public abstract class Operation {
    ...
    public final class AppendValue extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Anchor anchor = (Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0));
            Object objMo619getObject31yXWZQ = operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
            if (objMo619getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering((RememberObserverHolder) objMo619getObject31yXWZQ);
            }
            slotWriter.appendSlot(anchor, objMo619getObject31yXWZQ);
        }
    }
    ...
    public final class ApplyChangeList extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            IntRef intRef = (IntRef) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0));
            if (element > 0) {
    ...
    public final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            int element = ((IntRef) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
            int size = list.size();
    ...
    public final class CopySlotTableToAnchorLocation extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(2));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
    ...
    public final class DetermineMovableContentNodeIndex extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            IntRef intRef = (IntRef) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
            applier.getClass();
    ...
    public final class Downs extends Operation {
        ...
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            applier.getClass();
            for (Object obj : (Object[]) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0))) {
                applier.down(obj);
            }
        }
    }
    ...
    public final class EndCompositionScope extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ((Function1) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0))).invoke((Composition) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1)));
        }
    }
    ...
    public final class EndResumingScope extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.endResumingScope((RecomposeScopeImpl) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0)));
        }
    }
    ...
    public final class EnsureGroupStarted extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0)));
        }
    }
    ...
    public final class InsertNodeFixup extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            Object objInvoke = ((Function0) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0))).invoke();
            Anchor anchor = (Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
        ...
        protected Anchor getGroupAnchor(OperationArgContainer operationArgContainer, SlotWriter slotWriter) {
            return (Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
        }
    }
    ...
    public final class InsertSlots extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0));
    ...
    public final class InsertSlotsWithFixups extends Operation {
        ...
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ...
            SlotTable slotTable = (SlotTable) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(2));
    ...
    public final class PostInsertNodeFixup extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected Anchor getGroupAnchor(OperationArgContainer operationArgContainer, SlotWriter slotWriter) {
            return (Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0));
        }
    }
    ...
    public final class Remember extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.remembering((RememberObserverHolder) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0)));
        }
    }
    ...
    public final class SideEffect extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.sideEffect((Function0) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0)));
        }
    }
    ...
    public final class StartResumingScope extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            rememberManager.startResumingScope((RecomposeScopeImpl) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0)));
        }
    }
    ...
    public final class UpdateAnchoredValue extends Operation {
        ...
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            int iAnchorIndex;
            int slotsSize;
            Object objMo619getObject31yXWZQ = operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1));
            int i = operationArgContainer.getInt(0);
            if (objMo619getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering((RememberObserverHolder) objMo619getObject31yXWZQ);
            ...
            Object obj = slotWriter.set(iAnchorIndex2, i, objMo619getObject31yXWZQ);
            if (!(obj instanceof RememberObserverHolder)) {
    ...
    public final class UpdateAuxData extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            slotWriter.updateAux(operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0)));
        }
    }
    ...
    public final class UpdateNode extends Operation {
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            applier.apply((Function2) operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(1)), operationArgContainer.mo619getObject31yXWZQ(ObjectParameter.m618constructorimpl(0)));
        }
    }
    ...
    public final class UpdateValue extends Operation {
        ...
        protected void execute(OperationArgContainer operationArgContainer, Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) {
            ...
            Object obj = slotWriter.set(slotWriter.getCurrentGroup(), i, objMo619getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
