...
public class ActionBarContainer extends FrameLayout {
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x0047 A[PHI: r0
      0x0047: PHI (r0v4 boolean) = (r0v1 boolean), (r0v1 boolean), (r0v0 boolean) binds: [B:31:0x0076, B:33:0x007a, B:15:0x0039] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(getMeasuredWidth(), Math.min(getPaddingTop() + getPaddingBottom() + (!isCollapsed(this.mActionBarView) ? getMeasuredHeightWithMargins(this.mActionBarView) : !isCollapsed(this.mContextView) ? getMeasuredHeightWithMargins(this.mContextView) : 0) + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i2) : Integer.MAX_VALUE));
    }
