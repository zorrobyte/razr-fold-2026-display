    ...
    class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (z && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver$$ExternalSyntheticThrowCCEIfNotNull0.m(newInstance(string, SupportMenuInflater.ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE, SupportMenuInflater.this.mActionProviderConstructorArguments));
            } else if (z) {
