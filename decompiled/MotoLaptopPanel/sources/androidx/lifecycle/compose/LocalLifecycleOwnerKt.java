...
public abstract class LocalLifecycleOwnerKt {
    ...
    static {
        ...
        try {
            ...
            objM2192constructorimpl = Result.m2192constructorimpl(providableCompositionLocal);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            objM2192constructorimpl = Result.m2192constructorimpl(ResultKt.createFailure(th));
        }
        ProvidableCompositionLocal providableCompositionLocalStaticCompositionLocalOf = (ProvidableCompositionLocal) (Result.m2194isFailureimpl(objM2192constructorimpl) ? null : objM2192constructorimpl);
