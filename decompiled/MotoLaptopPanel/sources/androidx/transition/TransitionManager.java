...
public abstract class TransitionManager {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo2049clone = transition.mo2049clone();
        sceneChangeSetup(viewGroup, transitionMo2049clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo2049clone);
    }
    ...
    public static TransitionSeekController controlDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo2049clone);
