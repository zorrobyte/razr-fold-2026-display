...
public class MaterialDatePicker extends DialogFragment {
    ...
    private DateSelector getDateSelector() {
        ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(getArguments().getParcelable("DATE_SELECTOR_KEY"));
        return null;
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(bundle.getParcelable("DAY_VIEW_DECORATOR_KEY"));
