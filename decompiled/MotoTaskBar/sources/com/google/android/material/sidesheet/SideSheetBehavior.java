...
public class SideSheetBehavior extends CoordinatorLayout.Behavior implements MaterialBackHandler {
    ...
    class StateSettlingTracker {
        private final Runnable continueSettlingRunnable = new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SideSheetBehavior.StateSettlingTracker.m2152$r8$lambda$moQjjbcBo6ApC5WH96319nIACo(this.f$0);
            }
        };
        ...
        public static /* synthetic */ void m2152$r8$lambda$moQjjbcBo6ApC5WH96319nIACo(StateSettlingTracker stateSettlingTracker) {
    ...
    public static /* synthetic */ void m2151$r8$lambda$vg37JzyumMkESCn5KJfiWrmBw(SideSheetBehavior sideSheetBehavior, ViewGroup.MarginLayoutParams marginLayoutParams, int i, View view, ValueAnimator valueAnimator) {
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                SideSheetBehavior.m2151$r8$lambda$vg37JzyumMkESCn5KJfiWrmBw(this.f$0, marginLayoutParams, coplanarSiblingAdjacentMargin, coplanarSiblingView, valueAnimator);
            }
        };
    }
