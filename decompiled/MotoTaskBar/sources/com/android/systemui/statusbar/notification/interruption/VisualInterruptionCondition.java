...
public abstract class VisualInterruptionCondition implements VisualInterruptionSuppressor {
    ...
    public VisualInterruptionCondition(Set set, String str) {
        this(set, str, null, null, 8, null);
        set.getClass();
        str.getClass();
    }

    public VisualInterruptionCondition(Set set, String str, UiEventLogger.UiEventEnum uiEventEnum, VisualInterruptionSuppressor.EventLogData eventLogData) {
        set.getClass();
        str.getClass();
        this.types = set;
        this.reason = str;
    ...
    public /* synthetic */ VisualInterruptionCondition(Set set, String str, UiEventLogger.UiEventEnum uiEventEnum, VisualInterruptionSuppressor.EventLogData eventLogData, int i, DefaultConstructorMarker defaultConstructorMarker) {
