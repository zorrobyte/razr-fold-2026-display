...
public final class NotificationLoggerViewModel {
    ...
    private final Flow activeNotifications;
    private final Flow isOnLockScreen;

    public NotificationLoggerViewModel(ActiveNotificationsInteractor activeNotificationsInteractor) {
        activeNotificationsInteractor.getClass();
        final Flow allRepresentativeNotifications = activeNotificationsInteractor.getAllRepresentativeNotifications();
        this.activeNotifications = new Flow() { // from class: com.android.systemui.statusbar.notification.stack.ui.viewmodel.NotificationLoggerViewModel$special$$inlined$map$1
            ...
            /* JADX INFO: renamed from: com.android.systemui.statusbar.notification.stack.ui.viewmodel.NotificationLoggerViewModel$special$$inlined$map$1$2, reason: invalid class name */
            /* JADX INFO: compiled from: Emitters.kt */
            public final class AnonymousClass2 implements FlowCollector {
                final /* synthetic */ FlowCollector $this_unsafeFlow;

                /* JADX INFO: renamed from: com.android.systemui.statusbar.notification.stack.ui.viewmodel.NotificationLoggerViewModel$special$$inlined$map$1$2$1, reason: invalid class name */
            ...
            public Object collect(FlowCollector flowCollector, Continuation continuation) {
                Object objCollect = allRepresentativeNotifications.collect(new AnonymousClass2(flowCollector), continuation);
                return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
            }
        };
        this.activeNotificationRanks = activeNotificationsInteractor.getActiveNotificationRanks();
        this.isOnLockScreen = FlowKt.flowOf(Boolean.FALSE);
    }
}
