...
public abstract class Interpolators {
    ...
    /* JADX INFO: renamed from: $r8$lambda$FFeuzS0-oWnp8o7YNkrK4yGVtSU, reason: not valid java name */
    public static /* synthetic */ float m1129$r8$lambda$FFeuzS0oWnp8o7YNkrK4yGVtSU(float f) {
        return f < 1.0f ? 0.0f : 1.0f;
    }

    public static /* synthetic */ float $r8$lambda$P0xfzzAa8YGoSiUvSevu2IhWKZA(float f) {
        return 1.0f;
    }
    ...
    static {
        ...
        INSTANT = new Interpolator() { // from class: com.android.app.animation.Interpolators$$ExternalSyntheticLambda0
            @Override // android.animation.TimeInterpolator
            public final float getInterpolation(float f) {
                return Interpolators.$r8$lambda$P0xfzzAa8YGoSiUvSevu2IhWKZA(f);
            }
        };
        FINAL_FRAME = new Interpolator() { // from class: com.android.app.animation.Interpolators$$ExternalSyntheticLambda1
            @Override // android.animation.TimeInterpolator
            public final float getInterpolation(float f) {
                return Interpolators.m1129$r8$lambda$FFeuzS0oWnp8o7YNkrK4yGVtSU(f);
            }
        };
        ...
        TOUCH_RESPONSE_ACCEL_DEACCEL = new Interpolator() { // from class: com.android.app.animation.Interpolators$$ExternalSyntheticLambda2
            @Override // android.animation.TimeInterpolator
            public final float getInterpolation(float f) {
                return Interpolators.ACCELERATE_DECELERATE.getInterpolation(Interpolators.TOUCH_RESPONSE.getInterpolation(f));
            }
        };
        ZOOM_IN = new Interpolator() { // from class: com.android.app.animation.Interpolators.1
            @Override // android.animation.TimeInterpolator
            public float getInterpolation(float f) {
                return Interpolators.DECELERATE_3.getInterpolation(1.0f - Interpolators.ZOOM_OUT.getInterpolation(1.0f - f));
            }
        };
        ZOOM_OUT = new Interpolator() { // from class: com.android.app.animation.Interpolators.2
        ...
        SCROLL = new Interpolator() { // from class: com.android.app.animation.Interpolators.3
            @Override // android.animation.TimeInterpolator
            public float getInterpolation(float f) {
                float f2 = f - 1.0f;
        ...
        SCROLL_CUBIC = new Interpolator() { // from class: com.android.app.animation.Interpolators.4
            @Override // android.animation.TimeInterpolator
            public float getInterpolation(float f) {
                float f2 = f - 1.0f;
