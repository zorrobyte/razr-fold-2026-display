...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
                ...
                if (lottieDrawable.mainThreadHandler == null) {
                    ...
                    lottieDrawable.invalidateSelfRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda17
                        ...
                        public final void run() {
                            LottieDrawable.m1124$r8$lambda$qVOJAuCYN_sh5dMlsJC4mC_iE(this.f$0);
                        }
                    };
                }
    ...
    public static /* synthetic */ void m1124$r8$lambda$qVOJAuCYN_sh5dMlsJC4mC_iE(LottieDrawable lottieDrawable) {
