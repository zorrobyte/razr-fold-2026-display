...
public final class PluginManagerComponentModule_ProvidePluginDiscoveryFactory implements Factory {
    private final Provider o1Provider;
    private final Provider oProvider;

    public PluginManagerComponentModule_ProvidePluginDiscoveryFactory(Provider provider, Provider provider2) {
        this.oProvider = provider;
        this.o1Provider = provider2;
    }

    public static PluginManagerComponentModule_ProvidePluginDiscoveryFactory create(Provider provider, Provider provider2) {
        return new PluginManagerComponentModule_ProvidePluginDiscoveryFactory(provider, provider2);
    }
    ...
    public static PluginDiscovery providePluginDiscovery(ThirdPartyAppPluginDiscovery thirdPartyAppPluginDiscovery, LocalAppPluginDiscovery localAppPluginDiscovery) {
        PluginDiscovery pluginDiscoveryProvidePluginDiscovery = PluginManagerComponentModule.providePluginDiscovery(thirdPartyAppPluginDiscovery, localAppPluginDiscovery);
