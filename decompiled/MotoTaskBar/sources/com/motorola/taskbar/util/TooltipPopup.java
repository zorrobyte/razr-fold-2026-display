...
class TooltipPopup {
    ...
    private TooltipPopupRootView mContentView;
    ...
    public TooltipPopup(Context context) {
        ...
        this.mConfigurationListener = new ConfigurationController.ConfigurationListener() { // from class: com.motorola.taskbar.util.TooltipPopup.1
        ...
        this.mHandler = new Handler() { // from class: com.motorola.taskbar.util.TooltipPopup.2
            @Override // android.os.Handler
            public void handleMessage(Message message) {
                int i = message.what;
                if (i == 1) {
                    if (TooltipPopup.this.mContentView.isOnTouchOrOnHover()) {
                        return;
                    }
                    TooltipPopup.this.hide(true);
                } else {
        ...
        layoutParams.motoPrivateFlags = 512;
    ...
    public void show(long j, int i, View view, int i2, boolean z, View view2, ViewGroup.LayoutParams layoutParams) {
        beginShow(z);
        this.mCustomContainer.addView(view2, layoutParams);
        this.mCustomContainer.setVisibility(0);
        computeAndShow(j, i, view, 0, i2);
    }

    public void show(long j, int i, View view, int i2, boolean z, CharSequence charSequence) {
        beginShow(z);
        this.mMessageView.setVisibility(0);
        this.mMessageView.setText(charSequence);
        computeAndShow(j, i, view, 0, i2);
