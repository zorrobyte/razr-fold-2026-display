...
public class ConflatedBufferedChannel extends BufferedChannel {
    ...
    static /* synthetic */ Object send$suspendImpl(ConflatedBufferedChannel conflatedBufferedChannel, Object obj, Continuation continuation) throws Throwable {
        ...
        Object objM2753trySendImplMj0NB7M = conflatedBufferedChannel.m2753trySendImplMj0NB7M(obj, true);
        if (!(objM2753trySendImplMj0NB7M instanceof ChannelResult.Closed)) {
            return Unit.INSTANCE;
        }
        ChannelResult.m2742exceptionOrNullimpl(objM2753trySendImplMj0NB7M);
    ...
    private final Object m2752trySendDropLatestMj0NB7M(Object obj, boolean z) {
        Function1 function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2736trySendJP2dKIU = super.mo2736trySendJP2dKIU(obj);
        if (ChannelResult.m2746isSuccessimpl(objMo2736trySendJP2dKIU) || ChannelResult.m2745isClosedimpl(objMo2736trySendJP2dKIU)) {
            return objMo2736trySendJP2dKIU;
        }
    ...
    private final Object m2753trySendImplMj0NB7M(Object obj, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2752trySendDropLatestMj0NB7M(obj, z) : m2737trySendDropOldestJP2dKIU(obj);
    }
    ...
    public Object mo2736trySendJP2dKIU(Object obj) {
        return m2753trySendImplMj0NB7M(obj, false);
    }
}
