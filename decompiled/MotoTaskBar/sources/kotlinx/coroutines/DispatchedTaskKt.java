...
public abstract class DispatchedTaskKt {
    ...
    public static final void resume(DispatchedTask dispatchedTask, Continuation continuation, boolean z) {
        ...
        Object objM2707constructorimpl = Result.m2707constructorimpl(successfulResult$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host);
        if (!z) {
        ...
        try {
            dispatchedContinuation.continuation.resumeWith(objM2707constructorimpl);
