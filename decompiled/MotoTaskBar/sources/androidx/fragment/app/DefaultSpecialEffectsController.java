                                ...
                                while (it.hasNext()) {
                                    if (!((DefaultSpecialEffectsController.TransitionInfo) it.next()).getOperation().isSeeking()) {
                                        ...
                                        L72:
                                            ...
                                            return
                                        */
                                        throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.DefaultSpecialEffectsController$TransitionEffect$onStart$4.AnonymousClass2.m1062invoke():void");
                                    }
                                }
                    ...
                    loop3: while (true) {
                        ...
                        while (i3 < size3) {
                            ...
                            if (transitionInfo2.hasSharedElementTransition() && operation != null && operation2 != null) {
                                ...
                                ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(pair.component1());
                                ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(pair.component2());
                                int i6 = 0;
