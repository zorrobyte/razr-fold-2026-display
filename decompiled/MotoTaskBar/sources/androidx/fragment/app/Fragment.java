...
public abstract class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    /* JADX INFO: renamed from: $r8$lambda$fb2iz_9i-0AeQEy2DZBRxlwOv0g, reason: not valid java name */
    public static /* synthetic */ void m1063$r8$lambda$fb2iz_9i0AeQEy2DZBRxlwOv0g(Fragment fragment) {
    ...
    void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new Runnable() { // from class: androidx.fragment.app.Fragment$$ExternalSyntheticLambda0
            ...
            public final void run() {
                Fragment.m1063$r8$lambda$fb2iz_9i0AeQEy2DZBRxlwOv0g(this.f$0);
            }
        });
