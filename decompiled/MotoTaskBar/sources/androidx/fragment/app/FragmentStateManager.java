...
class FragmentStateManager {
    ...
    FragmentStateManager(FragmentLifecycleCallbacksDispatcher fragmentLifecycleCallbacksDispatcher, FragmentStore fragmentStore, ClassLoader classLoader, FragmentFactory fragmentFactory, Bundle bundle) {
        this.mDispatcher = fragmentLifecycleCallbacksDispatcher;
        this.mFragmentStore = fragmentStore;
        Fragment fragmentInstantiate = ((FragmentState) bundle.getParcelable(WeatherData.STATE_KEY)).instantiate(fragmentFactory, classLoader);
    ...
    void restoreState(ClassLoader classLoader) {
        ...
        try {
            ...
            FragmentState fragmentState = (FragmentState) this.mFragment.mSavedFragmentState.getParcelable(WeatherData.STATE_KEY);
    ...
    Bundle saveState() {
        ...
        bundle2.putParcelable(WeatherData.STATE_KEY, new FragmentState(this.mFragment));
        if (this.mFragment.mState > -1) {
