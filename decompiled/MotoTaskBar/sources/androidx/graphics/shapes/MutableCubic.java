...
public final class MutableCubic extends Cubic {
    ...
    private final void transformOnePoint(PointTransformer pointTransformer, int i) {
        int i2 = i + 1;
        long jMo1083transformXgqJiTY = pointTransformer.mo1083transformXgqJiTY(getPoints$graphics_shapes()[i], getPoints$graphics_shapes()[i2]);
        getPoints$graphics_shapes()[i] = Float.intBitsToFloat((int) (jMo1083transformXgqJiTY >> 32));
        getPoints$graphics_shapes()[i2] = Float.intBitsToFloat((int) (4294967295L & jMo1083transformXgqJiTY));
    }
