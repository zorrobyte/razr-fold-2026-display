...
public class Cubic {
    ...
    public final class Companion {
        ...
        public final Cubic circularArc(float f, float f2, float f3, float f4, float f5, float f6) {
            ...
            long jM1089rotate90DnnuFBc = Utils.m1089rotate90DnnuFBc(jDirectionVector);
            long jM1089rotate90DnnuFBc2 = Utils.m1089rotate90DnnuFBc(jDirectionVector2);
            boolean z = PointKt.m1071dotProduct5P9i7ZU(jM1089rotate90DnnuFBc, f9, f10) >= 0.0f;
            float fM1072dotProductybeJwSQ = PointKt.m1072dotProductybeJwSQ(jDirectionVector, jDirectionVector2);
            if (fM1072dotProductybeJwSQ > 0.999f) {
                return straightLine(f3, f4, f5, f6);
            }
            float fDistance = ((((Utils.distance(f7, f8) * 4.0f) / 3.0f) * (((float) Math.sqrt(2 * r9)) - ((float) Math.sqrt(r5 - (fM1072dotProductybeJwSQ * fM1072dotProductybeJwSQ))))) / (1 - fM1072dotProductybeJwSQ)) * (z ? 1.0f : -1.0f);
            return CubicKt.Cubic(f3, f4, (PointKt.m1076getXDnnuFBc(jM1089rotate90DnnuFBc) * fDistance) + f3, (PointKt.m1077getYDnnuFBc(jM1089rotate90DnnuFBc) * fDistance) + f4, f5 - (PointKt.m1076getXDnnuFBc(jM1089rotate90DnnuFBc2) * fDistance), f6 - (PointKt.m1077getYDnnuFBc(jM1089rotate90DnnuFBc2) * fDistance), f5, f6);
        }
    ...
    private Cubic(long j, long j2, long j3, long j4) {
        this(new float[]{PointKt.m1076getXDnnuFBc(j), PointKt.m1077getYDnnuFBc(j), PointKt.m1076getXDnnuFBc(j2), PointKt.m1077getYDnnuFBc(j2), PointKt.m1076getXDnnuFBc(j3), PointKt.m1077getYDnnuFBc(j3), PointKt.m1076getXDnnuFBc(j4), PointKt.m1077getYDnnuFBc(j4)});
    }
    ...
    */
    ...
    public final long m1067pointOnCurveOOQOV4g$graphics_shapes(float f) {
        float f2 = 1 - f;
        float f3 = f2 * f2 * f2;
        float f4 = 3 * f;
        float f5 = f4 * f2 * f2;
        float f6 = f4 * f * f2;
        float f7 = f * f * f;
        return FloatFloatPair.m13constructorimpl((getAnchor0X() * f3) + (getControl0X() * f5) + (getControl1X() * f6) + (getAnchor1X() * f7), (getAnchor0Y() * f3) + (getControl0Y() * f5) + (getControl1Y() * f6) + (getAnchor1Y() * f7));
    }
    ...
    public final Pair split(float f) {
        float f2 = 1 - f;
        long jM1067pointOnCurveOOQOV4g$graphics_shapes = m1067pointOnCurveOOQOV4g$graphics_shapes(f);
        float f3 = f2 * f2;
        float f4 = 2 * f2 * f;
        float f5 = f * f;
        return TuplesKt.to(CubicKt.Cubic(getAnchor0X(), getAnchor0Y(), (getAnchor0X() * f2) + (getControl0X() * f), (getAnchor0Y() * f2) + (getControl0Y() * f), (getAnchor0X() * f3) + (getControl0X() * f4) + (getControl1X() * f5), (getAnchor0Y() * f3) + (getControl0Y() * f4) + (getControl1Y() * f5), PointKt.m1076getXDnnuFBc(jM1067pointOnCurveOOQOV4g$graphics_shapes), PointKt.m1077getYDnnuFBc(jM1067pointOnCurveOOQOV4g$graphics_shapes)), CubicKt.Cubic(PointKt.m1076getXDnnuFBc(jM1067pointOnCurveOOQOV4g$graphics_shapes), PointKt.m1077getYDnnuFBc(jM1067pointOnCurveOOQOV4g$graphics_shapes), (getControl0X() * f3) + (getControl1X() * f4) + (getAnchor1X() * f5), (getControl0Y() * f3) + (getControl1Y() * f4) + (getAnchor1Y() * f5), (getControl1X() * f2) + (getAnchor1X() * f), (getControl1Y() * f2) + (getAnchor1Y() * f), getAnchor1X(), getAnchor1Y()));
    }
