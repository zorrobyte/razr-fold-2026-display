...
public abstract class RoundedPolygonKt {
    ...
    public static final RoundedPolygon RoundedPolygon(List list, float f, float f2) {
        ...
        return new RoundedPolygon(list, FloatFloatPair.m13constructorimpl(f, f2), null);
    }
    ...
    public static final RoundedPolygon RoundedPolygon(float[] fArr, CornerRounding cornerRounding, List list, float f, float f2) {
        ...
        while (i2 < length) {
            ...
            int i5 = (i4 % length) * 2;
            int i6 = i2 * 2;
            arrayList2.add(new RoundedCorner(FloatFloatPair.m13constructorimpl(fArr[i3], fArr[i3 + 1]), FloatFloatPair.m13constructorimpl(fArr[i6], fArr[i6 + 1]), FloatFloatPair.m13constructorimpl(fArr[i5], fArr[i5 + 1]), cornerRounding3, null));
            i2 = i4;
        }
        ...
        while (i < length) {
            ...
            int i13 = i12 % length;
            int i14 = i * 2;
            long jM13constructorimpl = FloatFloatPair.m13constructorimpl(fArr[i14], fArr[i14 + 1]);
            int i15 = (((i + length) - 1) % length) * 2;
            long jM13constructorimpl2 = FloatFloatPair.m13constructorimpl(fArr[i15], fArr[i15 + 1]);
            int i16 = i13 * 2;
            arrayList4.add(new Feature.Corner((List) arrayList.get(i), Utils.m1086convexb22R3LQ(jM13constructorimpl2, jM13constructorimpl, FloatFloatPair.m13constructorimpl(fArr[i16], fArr[i16 + 1]))));
        ...
        long jCalculateCenter = (f == Float.MIN_VALUE || f2 == Float.MIN_VALUE) ? calculateCenter(fArr) : FloatFloatPair.m13constructorimpl(f, f2);
    ...
    public static final long calculateCenter(float[] fArr) {
        ...
        return FloatFloatPair.m13constructorimpl(f / (fArr.length / 2), f2 / (fArr.length / 2));
    }
    ...
    private static final float[] verticesFromNumVerts(int i, float f, float f2, float f3) {
        ...
        while (i2 < i) {
            float f4 = f;
            long jM1080plusybeJwSQ = PointKt.m1080plusybeJwSQ(Utils.m1088radialToCartesianL6JJ3z0$default(f4, (Utils.getFloatPi() / i) * 2 * i2, 0L, 4, null), FloatFloatPair.m13constructorimpl(f2, f3));
            int i4 = i3 + 1;
            fArr[i3] = PointKt.m1076getXDnnuFBc(jM1080plusybeJwSQ);
            i3 += 2;
            fArr[i4] = PointKt.m1077getYDnnuFBc(jM1080plusybeJwSQ);
            i2++;
            f = f4;
        }
        return fArr;
