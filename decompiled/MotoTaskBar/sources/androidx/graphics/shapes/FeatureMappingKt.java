...
public abstract class FeatureMappingKt {
    ...
    public static final float featureDistSquared(Feature feature, Feature feature2) {
        ...
        return PointKt.m1075getDistanceSquaredDnnuFBc(PointKt.m1079minusybeJwSQ(featureRepresentativePoint(feature), featureRepresentativePoint(feature2)));
    }
    ...
    public static final long featureRepresentativePoint(Feature feature) {
        feature.getClass();
        return FloatFloatPair.m13constructorimpl((((Cubic) CollectionsKt.first(feature.getCubics())).getAnchor0X() + ((Cubic) CollectionsKt.last(feature.getCubics())).getAnchor1X()) / 2.0f, (((Cubic) CollectionsKt.first(feature.getCubics())).getAnchor0Y() + ((Cubic) CollectionsKt.last(feature.getCubics())).getAnchor1Y()) / 2.0f);
    }
}
