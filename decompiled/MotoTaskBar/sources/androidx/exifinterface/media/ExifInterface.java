...
public class ExifInterface {
    ...
    private static final int PNG_CHUNK_TYPE_EXIF = intFromBytes(101, 88, 73, 102);
    private static final int PNG_CHUNK_TYPE_IHDR = intFromBytes(73, 72, 68, 82);
    private static final int PNG_CHUNK_TYPE_IEND = intFromBytes(73, 69, 78, 68);
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:70:0x01a0, code lost:
        ...
        return;
     */
    /* JADX WARN: Removed duplicated region for block: B:64:0x0185 A[LOOP:0: B:10:0x0037->B:64:0x0185, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:81:0x018c A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private void getJpegAttributes(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r23, int r24, int r25) throws java.lang.Throwable {
        /*
    ...
    private void getPngAttributes(ByteOrderedDataInputStream byteOrderedDataInputStream) throws Throwable {
        ...
        while (true) {
            try {
                ...
                byteOrderedDataInputStream.skipFully(i + 4);
    ...
    private static int intFromBytes(int i, int i2, int i3, int i4) {
