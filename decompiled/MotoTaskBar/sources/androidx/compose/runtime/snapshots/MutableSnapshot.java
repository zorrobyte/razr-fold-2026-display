    ...
    */
    ...
    public MutableSnapshot takeNestedMutableSnapshot(Function1 function1, Function1 function12) {
        ...
        synchronized (SnapshotKt.getLock()) {
            ...
            nestedMutableSnapshot = new NestedMutableSnapshot(j, SnapshotKt.addRange(invalid$runtime_release, getSnapshotId() + 1, j), SnapshotKt.mergedReadObserver$default(function1, getReadObserver(), false, 4, null), SnapshotKt.mergedWriteObserver(function12, getWriteObserver$runtime_release()), this);
        }
        if (getApplied$runtime_release() || getDisposed$runtime_release()) {
    ...
    public Snapshot takeNestedSnapshot(Function1 function1) {
        ...
        synchronized (SnapshotKt.getLock()) {
            ...
            SnapshotKt.nextSnapshotId++;
            SnapshotKt.openSnapshots = SnapshotKt.openSnapshots.set(j);
            nestedReadonlySnapshot = new NestedReadonlySnapshot(j, SnapshotKt.addRange(getInvalid$runtime_release(), snapshotId + 1, j), SnapshotKt.mergedReadObserver$default(function1, getReadObserver(), false, 4, null), this);
        }
        if (getApplied$runtime_release() || getDisposed$runtime_release()) {
