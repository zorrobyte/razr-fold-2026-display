...
public final class SnapshotStateObserver {
    ...
    final class ObservedScopeMap {
        ...
        private final MutableScatterMap valueToScopes = ScopeMap.m85constructorimpl$default(null, 1, null);
        ...
        private final MutableScatterMap dependencyToDerivedStates = ScopeMap.m85constructorimpl$default(null, 1, null);
        ...
        private final void recordRead(Object obj, int i, Object obj2, MutableObjectIntMap mutableObjectIntMap) {
            ...
            if (!(obj instanceof DerivedState) || iPut == i) {
                ...
                ScopeMap.m89removeScopeimpl(mutableScatterMap, obj);
                            ...
                            while (i8 < i7) {
                                if ((j & 255) < 128) {
                                    ...
                                    if (stateObject instanceof StateObjectImpl) {
                                        ((StateObjectImpl) stateObject).m102recordReadInh_f27i8$runtime_release(ReaderKind.m96constructorimpl(i4));
                                    }
                                    ScopeMap.m82addimpl(mutableScatterMap, stateObject, obj);
                                } else {
                                    i4 = i5;
                                }
                                j >>= 8;
            ...
            if (iPut == i3) {
                if (obj instanceof StateObjectImpl) {
                    ((StateObjectImpl) obj).m102recordReadInh_f27i8$runtime_release(ReaderKind.m96constructorimpl(i2));
                }
                ScopeMap.m82addimpl(this.valueToScopes, obj, obj2);
            }
        }

        private final void removeObservation(Object obj, Object obj2) {
            ScopeMap.m88removeimpl(this.valueToScopes, obj2, obj);
            if (!(obj2 instanceof DerivedState) || ScopeMap.m86containsimpl(this.valueToScopes, obj2)) {
                return;
            }
            ScopeMap.m89removeScopeimpl(this.dependencyToDerivedStates, obj2);
            this.recordedDerivedStateValues.remove(obj2);
        }

        public final void clear() {
            ScopeMap.m83clearimpl(this.valueToScopes);
            this.scopeToValues.clear();
            ScopeMap.m83clearimpl(this.dependencyToDerivedStates);
