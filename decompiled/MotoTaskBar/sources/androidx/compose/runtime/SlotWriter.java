...
public final class SlotWriter {
    ...
    private final void recalculateMarks() {
        ...
        if (mutableIntList != null) {
            while (PrioritySet.m40isNotEmptyimpl(mutableIntList)) {
                m47updateContainsMarkNowXpTMRCE(PrioritySet.m42takeMaximpl(mutableIntList), mutableIntList);
            }
        }
    }
    ...
    public final void updateContainsMark(int i) {
        if (i >= 0) {
            MutableIntList mutableIntListM39constructorimpl$default = this.pendingRecalculateMarks;
            if (mutableIntListM39constructorimpl$default == null) {
                mutableIntListM39constructorimpl$default = PrioritySet.m39constructorimpl$default(null, 1, null);
                this.pendingRecalculateMarks = mutableIntListM39constructorimpl$default;
            }
            PrioritySet.m37addimpl(mutableIntListM39constructorimpl$default, i);
        }
    }

    /* JADX INFO: renamed from: updateContainsMarkNow-XpTMRCE, reason: not valid java name */
    private final void m47updateContainsMarkNowXpTMRCE(int i, MutableIntList mutableIntList) {
        ...
        if (((iArr[(iGroupIndexToAddress * 5) + 1] & 67108864) != 0) != zChildContainsAnyMarks) {
            ...
            if (iParent >= 0) {
                PrioritySet.m37addimpl(mutableIntList, iParent);
            }
        }
    }
    ...
    */
    ...
    public final boolean removeGroup() {
        ...
        MutableIntList mutableIntList = this.pendingRecalculateMarks;
        if (mutableIntList != null) {
            while (PrioritySet.m40isNotEmptyimpl(mutableIntList) && PrioritySet.m41peekimpl(mutableIntList) >= i) {
                PrioritySet.m42takeMaximpl(mutableIntList);
            }
        }
