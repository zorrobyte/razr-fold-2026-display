...
public final class ComposerImpl implements Composer {
    ...
    private final ArrayList pendingStack = Stack.m50constructorimpl$default(null, 1, null);
    ...
    public ComposerImpl(Applier applier, CompositionContext compositionContext, SlotTable slotTable, Set set, ChangeList changeList, ChangeList changeList2, ControlledComposition controlledComposition) {
        ...
        this.invalidateStack = Stack.m50constructorimpl$default(null, 1, null);
    ...
    private final void abortRoot() {
        cleanUpCompose();
        Stack.m48clearimpl(this.pendingStack);
    ...
    */
    private final void addRecomposeScope() {
        /*
            ...
            androidx.compose.runtime.Stack.m57pushimpl(r1, r0)
            r4.updateValue(r0)
        ...
        L6a:
            ...
            androidx.compose.runtime.Stack.m57pushimpl(r0, r1)
    ...
    private final void cleanUpCompose() {
        ...
        Stack.m48clearimpl(this.invalidateStack);
    ...
    private final void m23doComposeaFTiNEg(MutableScatterMap mutableScatterMap, Function2 function2) {
        if (this.isComposing) {
        ...
        try {
            ...
            this.providerUpdates = null;
            m27updateComposerInvalidationsRY85e9Y(mutableScatterMap);
            this.nodeIndex = 0;
    ...
    private final void enterGroup(boolean z, Pending pending) {
        Stack.m57pushimpl(this.pendingStack, this.pending);
    ...
    private final void exitGroup(int i, boolean z) {
        Pending pending = (Pending) Stack.m56popimpl(this.pendingStack);
        if (pending != null && !z) {
    ...
    private final void finalizeCompose() {
        ...
        if (!Stack.m52isEmptyimpl(this.pendingStack)) {
    ...
    public final void invokeMovableContentLambda(MovableContent movableContent, PersistentCompositionLocalMap persistentCompositionLocalMap, Object obj, boolean z) {
        ...
        try {
            ...
            m24startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m33getGroupULZAiWs(), persistentCompositionLocalMap);
            this.providerCache = null;
            if (!getInserting() || z) {
    ...
    */
    private final java.lang.Object recomposeMovableContent(androidx.compose.runtime.ControlledComposition r7, androidx.compose.runtime.ControlledComposition r8, java.lang.Integer r9, java.util.List r10, kotlin.jvm.functions.Function0 r11) {
        ...
        L39:
            ...
            if (r7 != 0) goto L43
        L3f:
            java.lang.Object r7 = r11.mo2224invoke()     // Catch: java.lang.Throwable -> L26
        L43:
            r6.isComposing = r0
            r6.nodeIndex = r1
            return r7
    ...
    private final void recomposeToGroupEnd() {
        ...
        while (invalidationFirstInRange != null) {
            ...
            if (invalidationFirstInRange.isInvalid()) {
                ...
                Stack.m57pushimpl(this.invalidateStack, invalidationFirstInRange.getScope());
                invalidationFirstInRange.getScope().rereadTrackedInstances();
                Stack.m56popimpl(this.invalidateStack);
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final void m24startBaiHCIY(int r13, java.lang.Object r14, int r15, java.lang.Object r16) {
        /*
            Method dump skipped, instruction units count: 473
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.ComposerImpl.m24startBaiHCIY(int, java.lang.Object, int, java.lang.Object):void");
    }

    private final void startGroup(int i) {
        m24startBaiHCIY(i, null, GroupKind.Companion.m33getGroupULZAiWs(), null);
    }

    private final void startGroup(int i, Object obj) {
        m24startBaiHCIY(i, obj, GroupKind.Companion.m33getGroupULZAiWs(), null);
    }
    ...
    private final void updateNodeCountOverrides(int i, int i2) {
        ...
        if (iUpdatedNodeCount != i2) {
            ...
            int iM51getSizeimpl = Stack.m51getSizeimpl(this.pendingStack) - 1;
            while (i != -1) {
                int iUpdatedNodeCount2 = updatedNodeCount(i) + i3;
                updateNodeCount(i, iUpdatedNodeCount2);
                int i4 = iM51getSizeimpl;
                while (true) {
                    if (-1 < i4) {
                        Pending pending = (Pending) Stack.m55peekimpl(this.pendingStack, i4);
                        if (pending != null && pending.updateNodeCount(i, iUpdatedNodeCount2)) {
                            iM51getSizeimpl = i4 - 1;
                            break;
                        }
                        i4--;
                    } else {
    ...
    public final void m25composeContentZbOJvo$runtime_release(MutableScatterMap mutableScatterMap, Function2 function2, ShouldPauseCallback shouldPauseCallback) {
        if (!this.changes.isEmpty()) {
            ComposerKt.composeImmediateRuntimeError("Expected applyChanges() to have been called");
        }
        m23doComposeaFTiNEg(mutableScatterMap, function2);
    }
    ...
    public ScopeUpdateScope endRestartGroup() {
        ...
        RecomposeScopeImpl recomposeScopeImpl2 = Stack.m53isNotEmptyimpl(this.invalidateStack) ? (RecomposeScopeImpl) Stack.m56popimpl(this.invalidateStack) : null;
    ...
    public final RecomposeScopeImpl getCurrentRecomposeScope$runtime_release() {
        ...
        if (this.childrenComposing == 0 && Stack.m53isNotEmptyimpl(arrayList)) {
            return (RecomposeScopeImpl) Stack.m54peekimpl(arrayList);
        }
        return null;
    }
    ...
    public final boolean m26recomposeaFTiNEg$runtime_release(MutableScatterMap mutableScatterMap, ShouldPauseCallback shouldPauseCallback) {
        if (!this.changes.isEmpty()) {
            ComposerKt.composeImmediateRuntimeError("Expected applyChanges() to have been called");
        }
        if (ScopeMap.m87getSizeimpl(mutableScatterMap) <= 0 && this.invalidations.isEmpty() && !this.forciblyRecompose) {
            return false;
        }
        m23doComposeaFTiNEg(mutableScatterMap, null);
    ...
    */
    ...
    public void startProvider(ProvidedValue providedValue) {
        ...
        m24startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m33getGroupULZAiWs(), persistentCompositionLocalMapCurrentCompositionLocalScope);
    }
    ...
    public void startProviders(ProvidedValue[] providedValueArr) {
        ...
        m24startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m33getGroupULZAiWs(), persistentCompositionLocalMapUpdateProviderMapGroup);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void m27updateComposerInvalidationsRY85e9Y(androidx.collection.MutableScatterMap r17) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
        ...
        L65:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.ComposerImpl.m27updateComposerInvalidationsRY85e9Y(androidx.collection.MutableScatterMap):void");
    }
