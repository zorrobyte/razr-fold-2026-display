...
public final class CompositionImpl implements ControlledComposition, Composition, RecomposeScopeOwner {
    ...
    public CompositionImpl(CompositionContext compositionContext, Applier applier, CoroutineContext coroutineContext) {
        ...
        this.observations = ScopeMap.m85constructorimpl$default(null, 1, null);
        this.invalidatedScopes = new MutableScatterSet(0, 1, null);
        this.conditionallyInvalidatedScopes = new MutableScatterSet(0, 1, null);
        this.derivedStates = ScopeMap.m85constructorimpl$default(null, 1, null);
        ChangeList changeList = new ChangeList();
        this.changes = changeList;
        ChangeList changeList2 = new ChangeList();
        this.lateChanges = changeList2;
        this.observationsProcessed = ScopeMap.m85constructorimpl$default(null, 1, null);
        this.invalidations = ScopeMap.m85constructorimpl$default(null, 1, null);
        ...
        this.composable = ComposableSingletons$CompositionKt.INSTANCE.m21getLambda1$runtime_release();
    }
    ...
    private final void addPendingInvalidationsLocked(Object obj, boolean z) {
        ...
        if (!(obj2 instanceof MutableScatterSet)) {
            ...
            if (ScopeMap.m88removeimpl(this.observationsProcessed, obj, recomposeScopeImpl) || recomposeScopeImpl.invalidateForResult(obj) == InvalidationResult.IGNORED) {
                return;
            }
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        ...
                        if (!ScopeMap.m88removeimpl(this.observationsProcessed, obj, recomposeScopeImpl2) && recomposeScopeImpl2.invalidateForResult(obj) != InvalidationResult.IGNORED) {
                    ...
                    while (i8 < i7) {
                        if ((j9 & 255) < j8) {
                            ...
                            if (obj2 instanceof MutableScatterSet) {
                                        ...
                                        if ((((~j10) << c2) & j10 & j5) != j5) {
                                            ...
                                            while (i14 < i13) {
                                                if ((j10 & 255) < j6) {
                                                    ...
                                                    i3 = i14;
                                                    i4 = i8;
                                                    if (!ScopeMap.m86containsimpl(this.observations, (DerivedState) objArr[i15])) {
                                ...
                                j6 = j8;
                                obj2.getClass();
                                zIsEmpty = !ScopeMap.m86containsimpl(this.observations, (DerivedState) obj2);
                            }
                            if (zIsEmpty) {
    ...
    */
    ...
    private final void invalidateScopeOfLocked(Object obj) {
        ...
        if (!(obj2 instanceof MutableScatterSet)) {
            ...
            if (recomposeScopeImpl.invalidateForResult(obj) == InvalidationResult.IMMINENT) {
                ScopeMap.m82addimpl(this.observationsProcessed, obj, recomposeScopeImpl);
                return;
            }
            return;
        }
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        ...
                        if (recomposeScopeImpl2.invalidateForResult(obj) == InvalidationResult.IMMINENT) {
                            ScopeMap.m82addimpl(this.observationsProcessed, obj, recomposeScopeImpl2);
                        }
                    }
                    j >>= 8;
                }
    ...
    private final MutableScatterMap m30takeInvalidationsafanTW4() {
    ...
    public void composeContent(Function2 function2) {
        try {
            synchronized (this.lock) {
                ...
                MutableScatterMap mutableScatterMapM30takeInvalidationsafanTW4 = m30takeInvalidationsafanTW4();
                try {
                    observer();
                    this.composer.m25composeContentZbOJvo$runtime_release(mutableScatterMapM30takeInvalidationsafanTW4, function2, null);
                } finally {
                }
            }
        } finally {
    ...
    public void dispose() {
        synchronized (this.lock) {
            try {
                ...
                if (!this.disposed) {
                    this.disposed = true;
                    this.composable = ComposableSingletons$CompositionKt.INSTANCE.m22getLambda2$runtime_release();
    ...
    */
    public boolean observesAnyOf(java.util.Set r15) {
        ...
        L30:
            ...
            boolean r11 = androidx.compose.runtime.collection.ScopeMap.m86containsimpl(r11, r10)
            if (r11 != 0) goto L50
            androidx.collection.MutableScatterMap r11 = r14.derivedStates
            boolean r10 = androidx.compose.runtime.collection.ScopeMap.m86containsimpl(r11, r10)
            if (r10 == 0) goto L51
        L50:
            return r2
        L51:
        ...
        L62:
            ...
            boolean r3 = androidx.compose.runtime.collection.ScopeMap.m86containsimpl(r3, r0)
            if (r3 != 0) goto L7c
            androidx.collection.MutableScatterMap r3 = r14.derivedStates
            boolean r0 = androidx.compose.runtime.collection.ScopeMap.m86containsimpl(r3, r0)
            if (r0 == 0) goto L62
        L7c:
            return r2
        L7d:
    ...
    public boolean recompose() {
        boolean zM26recomposeaFTiNEg$runtime_release;
        synchronized (this.lock) {
            drainPendingModificationsForCompositionLocked();
            try {
                MutableScatterMap mutableScatterMapM30takeInvalidationsafanTW4 = m30takeInvalidationsafanTW4();
                try {
                    observer();
                    zM26recomposeaFTiNEg$runtime_release = this.composer.m26recomposeaFTiNEg$runtime_release(mutableScatterMapM30takeInvalidationsafanTW4, null);
                    if (!zM26recomposeaFTiNEg$runtime_release) {
                        drainPendingModificationsLocked();
                    }
                } catch (Throwable th) {
                    this.invalidations = mutableScatterMapM30takeInvalidationsafanTW4;
                    throw th;
                }
            } finally {
            }
        }
        return zM26recomposeaFTiNEg$runtime_release;
    }
    ...
    public void recordReadOf(Object obj) {
        ...
        if (obj instanceof StateObjectImpl) {
            ((StateObjectImpl) obj).m102recordReadInh_f27i8$runtime_release(ReaderKind.m96constructorimpl(1));
        }
        ScopeMap.m82addimpl(this.observations, obj, currentRecomposeScope$runtime_release);
        if (obj instanceof DerivedState) {
            DerivedState derivedState = (DerivedState) obj;
            DerivedState.Record currentRecord = derivedState.getCurrentRecord();
            ScopeMap.m89removeScopeimpl(this.derivedStates, obj);
                        ...
                        while (i8 < i7) {
                            if ((j & 255) < 128) {
                                ...
                                if (stateObject instanceof StateObjectImpl) {
                                    i3 = i6;
                                    ((StateObjectImpl) stateObject).m102recordReadInh_f27i8$runtime_release(ReaderKind.m96constructorimpl(i2));
                                } else {
                                    i3 = i6;
                                }
                                ScopeMap.m82addimpl(this.derivedStates, stateObject, obj);
                            } else {
                                i2 = i4;
                                i3 = i6;
                            }
    ...
    */
    ...
    public final void removeDerivedStateObservation$runtime_release(DerivedState derivedState) {
        if (ScopeMap.m86containsimpl(this.observations, derivedState)) {
            return;
        }
        ScopeMap.m89removeScopeimpl(this.derivedStates, derivedState);
    }

    public final void removeObservation$runtime_release(Object obj, RecomposeScopeImpl recomposeScopeImpl) {
        ScopeMap.m88removeimpl(this.observations, obj, recomposeScopeImpl);
    }
