...
final class Pending {
    ...
    public Pending(List list, int i) {
        ...
        this.keyMap$delegate = LazyKt.lazy(new Function0() { // from class: androidx.compose.runtime.Pending$keyMap$2
            ...
            public /* bridge */ /* synthetic */ Object mo2224invoke() {
                return MultiValueMap.m67boximpl(m36invokefVlnmYg());
            }

            /* JADX INFO: renamed from: invoke-fVlnmYg, reason: not valid java name */
            public final MutableScatterMap m36invokefVlnmYg() {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    MultiValueMap.m66addimpl(mutableScatterMapMultiMap, ComposerKt.getJoinedKey(keyInfo2), keyInfo2);
                }
    ...
    public final MutableScatterMap m35getKeyMapfVlnmYg() {
        return ((MultiValueMap) this.keyMap$delegate.getValue()).m81unboximpl();
    }

    public final KeyInfo getNext(int i, Object obj) {
        return (KeyInfo) MultiValueMap.m76removeFirstimpl(m35getKeyMapfVlnmYg(), obj != null ? new JoinedKey(Integer.valueOf(i), obj) : Integer.valueOf(i));
    }
