...
public final class ComposerChangeListWriter {
    ...
    private ArrayList pendingDownNodes = Stack.m50constructorimpl$default(null, 1, null);
    ...
    private final void pushPendingUpsAndDowns() {
        ...
        if (Stack.m53isNotEmptyimpl(this.pendingDownNodes)) {
            this.changeList.pushDowns(Stack.m58toArrayimpl(this.pendingDownNodes));
            Stack.m48clearimpl(this.pendingDownNodes);
        }
    }
    ...
    public final void moveDown(Object obj) {
        realizeNodeMovementOperations();
        Stack.m57pushimpl(this.pendingDownNodes, obj);
    }
    ...
    public final void moveUp() {
        realizeNodeMovementOperations();
        if (Stack.m53isNotEmptyimpl(this.pendingDownNodes)) {
            Stack.m56popimpl(this.pendingDownNodes);
        } else {
            this.pendingUps++;
        }
    }
