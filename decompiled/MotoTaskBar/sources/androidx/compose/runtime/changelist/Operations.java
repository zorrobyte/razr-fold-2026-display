...
public final class Operations extends OperationsDebugStringFormattable {
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public Object mo60getObject31yXWZQ(int i) {
    ...
    public abstract class WriteScope {
        ...
        public static Operations m61constructorimpl(Operations operations) {
            return operations;
        }

        /* JADX INFO: renamed from: setObject-DKhxnng, reason: not valid java name */
        public static final void m62setObjectDKhxnng(Operations operations, int i, Object obj) {
        ...
        public static final void m63setObjects4uCC6AY(Operations operations, int i, Object obj, int i2, Object obj2) {
        ...
        public static final void m64setObjectsOGa0p1M(Operations operations, int i, Object obj, int i2, Object obj2, int i3, Object obj3, int i4, Object obj4) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = obj;
        ...
        public static final void m65setObjectst7hvbck(Operations operations, int i, Object obj, int i2, Object obj2, int i3, Object obj3) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = obj;
            objArr[i2 + objects] = obj2;
    ...
    public final void executeAndFlushAllPendingOperations(Applier applier, SlotWriter slotWriter, RememberManager rememberManager, OperationErrorContext operationErrorContext) throws Throwable {
        if (isNotEmpty()) {
