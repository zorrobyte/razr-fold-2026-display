...
final class KeyInputNode extends Modifier.Node implements KeyInputModifierNode {
    ...
    public boolean mo465onKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
        Function1 function1 = this.onEvent;
        if (function1 != null) {
            return ((Boolean) function1.invoke(KeyEvent.m451boximpl(keyEvent))).booleanValue();
        }
        return false;
    }
    ...
    public boolean mo466onPreKeyEventZmokQxo(android.view.KeyEvent keyEvent) {
