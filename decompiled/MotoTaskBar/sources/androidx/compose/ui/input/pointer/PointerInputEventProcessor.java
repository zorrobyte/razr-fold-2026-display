...
public final class PointerInputEventProcessor {
    ...
    public final int m507processBIzXfog(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z) {
        boolean z2;
        ...
        try {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (z2 || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange2)) {
                    LayoutNode.m571hitTest6fMxITs$ui_release$default(this.root, pointerInputChange2.m497getPositionF1C5BW0(), this.hitResult, pointerInputChange2.m499getTypeT8wyACA(), false, 8, null);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m469addHitPathQJqDSyo(pointerInputChange2.m496getIdJ3iCeTQ(), this.hitResult, PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange2));
