...
public final class PointerInputChange {
    ...
    private PointerInputChange(long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, boolean z3, int i, long j6) {
        ...
        this.type = i;
        this.scrollDelta = j6;
        this.originalEventPosition = Offset.Companion.m195getZeroF1C5BW0();
        this.downChange = z3;
    ...
    public static /* synthetic */ PointerInputChange m493copyOHpmEuE$default(PointerInputChange pointerInputChange, long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, int i, List list, long j6, int i2, Object obj) {
        long j7;
        ...
        return pointerInputChange.m494copyOHpmEuE(j8, j9, j10, z3, j11, j12, z4, i3, list, j7);
    }

    /* JADX INFO: renamed from: copy-OHpmEuE, reason: not valid java name */
    public final PointerInputChange m494copyOHpmEuE(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, int i, List list, long j6) {
        PointerInputChange pointerInputChange = this;
        PointerInputChange pointerInputChangeM495copywbzehF4 = pointerInputChange.m495copywbzehF4(j, j2, j3, z, pointerInputChange.pressure, j4, j5, z2, i, list, j6);
        PointerInputChange pointerInputChange2 = pointerInputChange.consumedDelegate;
        if (pointerInputChange2 != null) {
            pointerInputChange = pointerInputChange2;
        }
        pointerInputChangeM495copywbzehF4.consumedDelegate = pointerInputChange;
        return pointerInputChangeM495copywbzehF4;
    }

    /* JADX INFO: renamed from: copy-wbzehF4, reason: not valid java name */
    public final PointerInputChange m495copywbzehF4(long j, long j2, long j3, boolean z, float f, long j4, long j5, boolean z2, int i, List list, long j6) {
        PointerInputChange pointerInputChange = this;
    ...
    public final long m496getIdJ3iCeTQ() {
        return this.id;
    }

    /* JADX INFO: renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m497getPositionF1C5BW0() {
    ...
    public final long m498getPreviousPositionF1C5BW0() {
    ...
    public final int m499getTypeT8wyACA() {
        return this.type;
    }
    ...
    public String toString() {
        return "PointerInputChange(id=" + ((Object) PointerId.m492toStringimpl(this.id)) + ", uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m191toStringimpl(this.position)) + ", pressed=" + this.pressed + ", pressure=" + this.pressure + ", previousUptimeMillis=" + this.previousUptimeMillis + ", previousPosition=" + ((Object) Offset.m191toStringimpl(this.previousPosition)) + ", previousPressed=" + this.previousPressed + ", isConsumed=" + isConsumed() + ", type=" + ((Object) PointerType.m517toStringimpl(this.type)) + ", historical=" + getHistorical() + ",scrollDelta=" + ((Object) Offset.m191toStringimpl(this.scrollDelta)) + ')';
    }
}
