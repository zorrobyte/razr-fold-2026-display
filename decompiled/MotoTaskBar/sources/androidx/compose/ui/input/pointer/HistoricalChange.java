...
public final class HistoricalChange {
    ...
    public final long m467getOriginalEventPositionF1C5BW0$ui_release() {
        return this.originalEventPosition;
    }

    /* JADX INFO: renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m468getPositionF1C5BW0() {
    ...
    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m191toStringimpl(this.position)) + ')';
    }
}
