...
public final class MotionEventAdapter {
    ...
    private final PointerInputEventData createPointerInputEventData(PositionCalculator positionCalculator, MotionEvent motionEvent, int i, boolean z) {
        long jM474toRawOffsetdBAh8RU;
        long jMo523screenToLocalMKHz9U;
        long j;
        int i2 = i;
        long jM473getComposePointerId_I2yYro = m473getComposePointerId_I2yYro(motionEvent.getPointerId(i));
        float pressure = motionEvent.getPressure(i);
        long j2 = 4294967295L;
        long jM184copydBAh8RU$default = Offset.m184copydBAh8RU$default(Offset.m182constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getY(i))) & 4294967295L) | (((long) Float.floatToRawIntBits(motionEvent.getX(i))) << 32)), 0.0f, 0.0f, 3, null);
        if (i2 == 0) {
            jM474toRawOffsetdBAh8RU = Offset.m182constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getRawY())) & 4294967295L) | (((long) Float.floatToRawIntBits(motionEvent.getRawX())) << 32));
            jMo523screenToLocalMKHz9U = positionCalculator.mo523screenToLocalMKHz9U(jM474toRawOffsetdBAh8RU);
        } else {
            jM474toRawOffsetdBAh8RU = MotionEventHelper.INSTANCE.m474toRawOffsetdBAh8RU(motionEvent, i2);
            jMo523screenToLocalMKHz9U = positionCalculator.mo523screenToLocalMKHz9U(jM474toRawOffsetdBAh8RU);
        }
        int toolType = motionEvent.getToolType(i);
        int iM522getUnknownT8wyACA = toolType != 0 ? toolType != 1 ? toolType != 2 ? toolType != 3 ? toolType != 4 ? PointerType.Companion.m522getUnknownT8wyACA() : PointerType.Companion.m518getEraserT8wyACA() : PointerType.Companion.m519getMouseT8wyACA() : PointerType.Companion.m520getStylusT8wyACA() : PointerType.Companion.m521getTouchT8wyACA() : PointerType.Companion.m522getUnknownT8wyACA();
        ...
        while (i3 < historySize) {
            ...
            if ((Float.floatToRawIntBits(historicalX) & Integer.MAX_VALUE) >= 2139095040 || (Float.floatToRawIntBits(historicalY) & Integer.MAX_VALUE) >= 2139095040) {
                j = jM474toRawOffsetdBAh8RU;
            } else {
                long jFloatToRawIntBits = Float.floatToRawIntBits(historicalX);
                j = jM474toRawOffsetdBAh8RU;
                long jM182constructorimpl = Offset.m182constructorimpl((((long) Float.floatToRawIntBits(historicalY)) & j3) | (jFloatToRawIntBits << 32));
                arrayList.add(new HistoricalChange(motionEvent.getHistoricalEventTime(i3), jM182constructorimpl, jM182constructorimpl, null));
            }
            i3++;
            i2 = i;
            jM474toRawOffsetdBAh8RU = j;
            j2 = j3;
        }
        return new PointerInputEventData(jM473getComposePointerId_I2yYro, motionEvent.getEventTime(), jM474toRawOffsetdBAh8RU, jMo523screenToLocalMKHz9U, z, pressure, iM522getUnknownT8wyACA, this.activeHoverIds.get(motionEvent.getPointerId(i), false), arrayList, motionEvent.getActionMasked() == 8 ? Offset.m182constructorimpl((((long) Float.floatToRawIntBits((-motionEvent.getAxisValue(9)) + 0.0f)) & j2) | (((long) Float.floatToRawIntBits(motionEvent.getAxisValue(10))) << 32)) : Offset.Companion.m195getZeroF1C5BW0(), jM184copydBAh8RU$default, null);
    }

    /* JADX INFO: renamed from: getComposePointerId-_I2yYro, reason: not valid java name */
    private final long m473getComposePointerId_I2yYro(int i) {
        long jValueAt;
        ...
        return PointerId.m489constructorimpl(jValueAt);
    }
