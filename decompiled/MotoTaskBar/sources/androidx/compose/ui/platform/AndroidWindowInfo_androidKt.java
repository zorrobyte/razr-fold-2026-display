...
public abstract class AndroidWindowInfo_androidKt {
    public static final long calculateWindowSize(AndroidComposeView androidComposeView) {
        ...
        if (activityFindActivity != null) {
            ...
            return IntSize.m1008constructorimpl((((long) rectCurrentWindowBounds.height()) & 4294967295L) | (((long) rectCurrentWindowBounds.width()) << 32));
        }
        Configuration configuration = context.getResources().getConfiguration();
        float f = context.getResources().getDisplayMetrics().density;
        return IntSize.m1008constructorimpl((((long) Math.round(configuration.screenHeightDp * f)) & 4294967295L) | (((long) Math.round(configuration.screenWidthDp * f)) << 32));
    }
