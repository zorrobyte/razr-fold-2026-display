    ...
    private final View findNextFocusInAbsoluteDirection(ViewGroup viewGroup, View view, Rect rect, ArrayList arrayList, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (!Intrinsics.areEqual(view3, view) && !Intrinsics.areEqual(view3, viewGroup)) {
                ...
                if (TwoDimensionalFocusSearchKt.m172isBetterCandidateI7lrPNg(composeRect, composeRect2, composeRect3, focusDirection != null ? focusDirection.m123unboximpl() : FocusDirection.Companion.m128getNextdhqQ8s())) {
