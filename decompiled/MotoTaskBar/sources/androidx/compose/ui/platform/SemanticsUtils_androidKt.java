...
public abstract class SemanticsUtils_androidKt {
    ...
    public static final String m729toLegacyClassNameV4PA4sw(int i) {
        ...
        if (Role.m736equalsimpl0(i, companion.m740getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m736equalsimpl0(i, companion.m742getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m736equalsimpl0(i, companion.m745getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m736equalsimpl0(i, companion.m744getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m736equalsimpl0(i, companion.m743getDropdownListo7Vup1c())) {
            return "android.widget.Spinner";
        }
        if (Role.m736equalsimpl0(i, companion.m748getValuePickero7Vup1c())) {
