...
public final class OutlineResolver {
    ...
    public OutlineResolver() {
        ...
        this.rectTopLeft = Offset.Companion.m195getZeroF1C5BW0();
        this.rectSize = Size.Companion.m211getZeroNHjbRc();
    }

    /* JADX INFO: renamed from: isSameBounds-4L21HEs, reason: not valid java name */
    private final boolean m723isSameBounds4L21HEs(RoundRect roundRect, long j, long j2, float f) {
        ...
        return roundRect.getTop() == Float.intBitsToFloat(i2) && roundRect.getRight() == Float.intBitsToFloat(i) + Float.intBitsToFloat((int) (j2 >> 32)) && roundRect.getBottom() == Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 & 4294967295L)) && Float.intBitsToFloat((int) (roundRect.m203getTopLeftCornerRadiuskKHJgLs() >> 32)) == f;
    }
    ...
    private final void updateCacheWithRect(Rect rect) {
        ...
        this.rectTopLeft = Offset.m182constructorimpl((((long) Float.floatToRawIntBits(rect.getTop())) & 4294967295L) | (Float.floatToRawIntBits(left) << 32));
        float right = rect.getRight() - rect.getLeft();
        this.rectSize = Size.m206constructorimpl((((long) Float.floatToRawIntBits(rect.getBottom() - rect.getTop())) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        float fIntBitsToFloat = Float.intBitsToFloat((int) (roundRect.m203getTopLeftCornerRadiuskKHJgLs() >> 32));
        float left = roundRect.getLeft();
        this.rectTopLeft = Offset.m182constructorimpl((((long) Float.floatToRawIntBits(roundRect.getTop())) & 4294967295L) | (Float.floatToRawIntBits(left) << 32));
        float width = roundRect.getWidth();
        this.rectSize = Size.m206constructorimpl((((long) Float.floatToRawIntBits(roundRect.getHeight())) & 4294967295L) | (Float.floatToRawIntBits(width) << 32));
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (clipPath != null) {
            Canvas.m264clipPathmtrdDE$default(canvas, clipPath, 0, 2, null);
            return;
        }
        float f = this.roundedCornerRadius;
        if (f <= 0.0f) {
            Canvas.m265clipRectN_I0leg$default(canvas, Float.intBitsToFloat((int) (this.rectTopLeft >> 32)), Float.intBitsToFloat((int) (this.rectTopLeft & 4294967295L)), Float.intBitsToFloat((int) (this.rectTopLeft >> 32)) + Float.intBitsToFloat((int) (this.rectSize >> 32)), Float.intBitsToFloat((int) (this.rectTopLeft & 4294967295L)) + Float.intBitsToFloat((int) (this.rectSize & 4294967295L)), 0, 16, null);
            return;
        }
        Path Path = this.tmpPath;
        RoundRect roundRect = this.tmpRoundRect;
        if (Path == null || !m723isSameBounds4L21HEs(roundRect, this.rectTopLeft, this.rectSize, f)) {
            ...
            RoundRect roundRectM205RoundRectgG7oq9Y = RoundRectKt.m205RoundRectgG7oq9Y(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat3, fIntBitsToFloat4, CornerRadius.m175constructorimpl((((long) Float.floatToRawIntBits(f2)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L)));
            if (Path == null) {
                Path = AndroidPath_androidKt.Path();
            } else {
                Path.reset();
            }
            Path.addRoundRect$default(Path, roundRectM205RoundRectgG7oq9Y, null, 2, null);
            this.tmpRoundRect = roundRectM205RoundRectgG7oq9Y;
            this.tmpPath = Path;
        }
        Canvas.m264clipPathmtrdDE$default(canvas, Path, 0, 2, null);
    }
    ...
    public final boolean m724isInOutlinek4lQ0M(long j) {
    ...
    public final boolean m725updateS_szKao(androidx.compose.ui.graphics.Outline outline, float f, boolean z, float f2, long j) {
