...
public final class LazyWindowInfo implements WindowInfo {
    ...
    public void m722setKeyboardModifiers5xRPYO0(int i) {
        WindowInfoImpl.Companion.getGlobalKeyboardModifiers$ui_release().setValue(PointerKeyboardModifiers.m508boximpl(i));
    }
