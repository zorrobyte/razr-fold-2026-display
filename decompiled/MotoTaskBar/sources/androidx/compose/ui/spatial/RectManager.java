...
public final class RectManager {
    ...
    private final void boundingRectInRoot(NodeCoordinator nodeCoordinator, MutableRect mutableRect) {
        while (nodeCoordinator != null) {
            ...
            long jMo594getPositionnOccac = nodeCoordinator.mo594getPositionnOccac();
            mutableRect.m180translatek4lQ0M(Offset.m182constructorimpl((((long) Float.floatToRawIntBits(IntOffset.m997getXimpl(jMo594getPositionnOccac))) << 32) | (((long) Float.floatToRawIntBits(IntOffset.m998getYimpl(jMo594getPositionnOccac))) & 4294967295L)));
            nodeCoordinator = nodeCoordinator.getWrappedBy$ui_release();
            if (layer != null) {
                float[] fArrMo660getUnderlyingMatrixsQKQjiQ = layer.mo660getUnderlyingMatrixsQKQjiQ();
                if (!MatrixKt.m317isIdentity58bKbWc(fArrMo660getUnderlyingMatrixsQKQjiQ)) {
                    Matrix.m309mapimpl(fArrMo660getUnderlyingMatrixsQKQjiQ, mutableRect);
                }
            }
        }
    }
    ...
    private final void m754insertOrUpdateTransformedNode70tqf50(LayoutNode layoutNode, long j, boolean z) {
        ...
        mutableRect.set(IntOffset.m997getXimpl(j), IntOffset.m998getYimpl(j), IntOffset.m997getXimpl(j) + measuredWidth, IntOffset.m998getYimpl(j) + measuredHeight);
    ...
    private final void insertOrUpdateTransformedNodeSubhierarchy(LayoutNode layoutNode) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            m754insertOrUpdateTransformedNode70tqf50(layoutNode2, layoutNode2.getOuterCoordinator$ui_release().mo594getPositionnOccac(), false);
    ...
    private final long m755outerToInnerOffsetBjo55l4(LayoutNode layoutNode) {
        NodeCoordinator outerCoordinator$ui_release = layoutNode.getOuterCoordinator$ui_release();
        long jM195getZeroF1C5BW0 = Offset.Companion.m195getZeroF1C5BW0();
        ...
        while (innerCoordinator$ui_release != null && innerCoordinator$ui_release != outerCoordinator$ui_release) {
            ...
            jM195getZeroF1C5BW0 = IntOffsetKt.m1004plusNvtHpc(jM195getZeroF1C5BW0, innerCoordinator$ui_release.mo594getPositionnOccac());
            innerCoordinator$ui_release = innerCoordinator$ui_release.getWrappedBy$ui_release();
            if (layer != null) {
                float[] fArrMo660getUnderlyingMatrixsQKQjiQ = layer.mo660getUnderlyingMatrixsQKQjiQ();
                int iM762analyzeComponents58bKbWc = RectManagerKt.m762analyzeComponents58bKbWc(fArrMo660getUnderlyingMatrixsQKQjiQ);
                if (iM762analyzeComponents58bKbWc == 3) {
                    continue;
                } else {
                    if ((iM762analyzeComponents58bKbWc & 2) == 0) {
                        return IntOffset.Companion.m1001getMaxnOccac();
                    }
                    jM195getZeroF1C5BW0 = Matrix.m308mapMKHz9U(fArrMo660getUnderlyingMatrixsQKQjiQ, jM195getZeroF1C5BW0);
                }
            }
        }
        return IntOffsetKt.m1005roundk4lQ0M(jM195getZeroF1C5BW0);
    }

    /* JADX INFO: renamed from: positionInRoot-Bjo55l4, reason: not valid java name */
    private final long m756positionInRootBjo55l4(NodeCoordinator nodeCoordinator) {
        long jM195getZeroF1C5BW0 = Offset.Companion.m195getZeroF1C5BW0();
        while (nodeCoordinator != null) {
            OwnedLayer layer = nodeCoordinator.getLayer();
            jM195getZeroF1C5BW0 = IntOffsetKt.m1004plusNvtHpc(jM195getZeroF1C5BW0, nodeCoordinator.mo594getPositionnOccac());
            nodeCoordinator = nodeCoordinator.getWrappedBy$ui_release();
            if (layer != null) {
                float[] fArrMo660getUnderlyingMatrixsQKQjiQ = layer.mo660getUnderlyingMatrixsQKQjiQ();
                int iM762analyzeComponents58bKbWc = RectManagerKt.m762analyzeComponents58bKbWc(fArrMo660getUnderlyingMatrixsQKQjiQ);
    ...
    public final void dispatchCallbacks() {
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                ((Function0) objArr[i2]).mo2224invoke();
            }
    ...
    public final void onLayoutLayerPositionalPropertiesChanged(LayoutNode layoutNode) {
        if (ComposeUiFlags.isRectTrackingEnabled) {
            long jM755outerToInnerOffsetBjo55l4 = m755outerToInnerOffsetBjo55l4(layoutNode);
            if (!RectManagerKt.m763isSetgyyYBs(jM755outerToInnerOffsetBjo55l4)) {
                insertOrUpdateTransformedNodeSubhierarchy(layoutNode);
                return;
            }
            layoutNode.m584setOuterToInnerOffsetgyyYBs$ui_release(jM755outerToInnerOffsetBjo55l4);
            ...
            for (int i = 0; i < size; i++) {
                LayoutNode layoutNode2 = (LayoutNode) objArr[i];
                m757onLayoutPositionChanged70tqf50(layoutNode2, layoutNode2.getOuterCoordinator$ui_release().mo594getPositionnOccac(), false);
            }
    ...
    public final void m757onLayoutPositionChanged70tqf50(LayoutNode layoutNode, long j, boolean z) {
        long j2;
        long jM756positionInRootBjo55l4;
        long jM755outerToInnerOffsetBjo55l4;
        if (ComposeUiFlags.isRectTrackingEnabled) {
            MeasurePassDelegate measurePassDelegate$ui_release = layoutNode.getMeasurePassDelegate$ui_release();
            int measuredWidth = measurePassDelegate$ui_release.getMeasuredWidth();
            int measuredHeight = measurePassDelegate$ui_release.getMeasuredHeight();
            LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
            long jM576getOffsetFromRootnOccac$ui_release = layoutNode.m576getOffsetFromRootnOccac$ui_release();
            long jM575getLastSizeYbymL2g$ui_release = layoutNode.m575getLastSizeYbymL2g$ui_release();
            int i = (int) (jM575getLastSizeYbymL2g$ui_release >> 32);
            int i2 = (int) (jM575getLastSizeYbymL2g$ui_release & 4294967295L);
            boolean z2 = false;
            if (parent$ui_release != null) {
                boolean outerToInnerOffsetDirty$ui_release = parent$ui_release.getOuterToInnerOffsetDirty$ui_release();
                long jM576getOffsetFromRootnOccac$ui_release2 = parent$ui_release.m576getOffsetFromRootnOccac$ui_release();
                long jM577getOuterToInnerOffsetnOccac$ui_release = parent$ui_release.m577getOuterToInnerOffsetnOccac$ui_release();
                if (RectManagerKt.m763isSetgyyYBs(jM576getOffsetFromRootnOccac$ui_release2)) {
                    if (outerToInnerOffsetDirty$ui_release) {
                        j2 = 4294967295L;
                        jM755outerToInnerOffsetBjo55l4 = m755outerToInnerOffsetBjo55l4(parent$ui_release);
                        parent$ui_release.m584setOuterToInnerOffsetgyyYBs$ui_release(jM755outerToInnerOffsetBjo55l4);
                        parent$ui_release.setOuterToInnerOffsetDirty$ui_release(false);
                    } else {
                        j2 = 4294967295L;
                        jM755outerToInnerOffsetBjo55l4 = jM577getOuterToInnerOffsetnOccac$ui_release;
                    }
                    z2 = !RectManagerKt.m763isSetgyyYBs(jM755outerToInnerOffsetBjo55l4);
                    jM756positionInRootBjo55l4 = IntOffset.m1000plusqkQi6aY(IntOffset.m1000plusqkQi6aY(jM576getOffsetFromRootnOccac$ui_release2, jM755outerToInnerOffsetBjo55l4), j);
                } else {
                    j2 = 4294967295L;
                    jM756positionInRootBjo55l4 = m756positionInRootBjo55l4(layoutNode.getOuterCoordinator$ui_release());
                }
            } else {
                j2 = 4294967295L;
                jM756positionInRootBjo55l4 = j;
            }
            if (z2 || !RectManagerKt.m763isSetgyyYBs(jM756positionInRootBjo55l4)) {
                m754insertOrUpdateTransformedNode70tqf50(layoutNode, j, z);
                return;
            }
            layoutNode.m583setOffsetFromRootgyyYBs$ui_release(jM756positionInRootBjo55l4);
            layoutNode.m582setLastSizeozmzZPI$ui_release(IntSize.m1008constructorimpl((((long) measuredWidth) << 32) | (((long) measuredHeight) & j2)));
            int iM997getXimpl = IntOffset.m997getXimpl(jM756positionInRootBjo55l4);
            int iM998getYimpl = IntOffset.m998getYimpl(jM756positionInRootBjo55l4);
            int i3 = iM997getXimpl + measuredWidth;
            int i4 = iM998getYimpl + measuredHeight;
            if (!z && IntOffset.m996equalsimpl0(jM756positionInRootBjo55l4, jM576getOffsetFromRootnOccac$ui_release) && i == measuredWidth && i2 == measuredHeight) {
                return;
            }
            insertOrUpdate(layoutNode, z, iM997getXimpl, iM998getYimpl, i3, i4);
        }
    }
    ...
    public final void m758updateOffsetsucfNpQE(long j, long j2, float[] fArr) {
        int iM762analyzeComponents58bKbWc = RectManagerKt.m762analyzeComponents58bKbWc(fArr);
        ThrottledCallbacks throttledCallbacks = this.throttledCallbacks;
        if ((iM762analyzeComponents58bKbWc & 2) != 0) {
            fArr = null;
        }
        this.isScreenOrWindowDirty = throttledCallbacks.m764updateOffsetsbT0EZQs(j, j2, fArr) || this.isScreenOrWindowDirty;
    }
}
