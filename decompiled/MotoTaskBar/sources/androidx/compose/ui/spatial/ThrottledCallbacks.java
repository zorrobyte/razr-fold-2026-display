...
public final class ThrottledCallbacks {
    ...
    public ThrottledCallbacks() {
        ...
        this.windowOffset = companion.m1002getZeronOccac();
        this.screenOffset = companion.m1002getZeronOccac();
    }
    ...
    public final void fireOnUpdatedRect(int i, long j, long j2, long j3) {
        ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(this.rectChangedMap.get(i));
    }
    ...
    */
    public final void triggerDebounced(long r13) {
        ...
        L2e:
            ...
            int r8 = r8 + r7
            r8 = r14[r8]
            androidx.activity.result.ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(r8)
        L41:
            long r3 = r3 >> r6
            int r7 = r7 + 1
            goto L2e
    ...
    public final boolean m764updateOffsetsbT0EZQs(long j, long j2, float[] fArr) {
        boolean z;
        if (IntOffset.m996equalsimpl0(j2, this.windowOffset)) {
            z = false;
        } else {
            this.windowOffset = j2;
            z = true;
        }
        if (!IntOffset.m996equalsimpl0(j, this.screenOffset)) {
            this.screenOffset = j;
            z = true;
        }
        if (fArr == null) {
