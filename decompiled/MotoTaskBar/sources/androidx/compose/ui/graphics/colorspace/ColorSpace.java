...
public abstract class ColorSpace {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m349equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public final int getComponentCount() {
        return ColorModel.m350getComponentCountimpl(this.model);
    }
    ...
    public final long m356getModelxdoWZVw() {
        return this.model;
    }
    ...
    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m351hashCodeimpl(this.model)) * 31) + this.id;
    }
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m352toStringimpl(this.model)) + ')';
    }
    ...
    public abstract long mo357xyzaToColorJlNiLsg$ui_graphics_release(float f, float f2, float f3, float f4, ColorSpace colorSpace);
}
