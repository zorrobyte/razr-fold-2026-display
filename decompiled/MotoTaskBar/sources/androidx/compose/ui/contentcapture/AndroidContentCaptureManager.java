...
public final class AndroidContentCaptureManager implements ContentCaptureManager, DefaultLifecycleObserver, View.OnAttachStateChangeListener {
    ...
    private final ViewStructureCompat toViewStructure(SemanticsNode semanticsNode, int i) {
        ...
        String strM729toLegacyClassNameV4PA4sw;
        ContentCaptureSessionCompat contentCaptureSessionCompat = this.contentCaptureSession;
        ...
        if (role != null && (strM729toLegacyClassNameV4PA4sw = SemanticsUtils_androidKt.m729toLegacyClassNameV4PA4sw(role.m739unboximpl())) != null) {
            viewStructureCompatNewVirtualViewStructure.setClassName(strM729toLegacyClassNameV4PA4sw);
        }
        SemanticsUtils_androidKt.getTextLayoutResult(unmergedConfig$ui_release);
    ...
    */
    ...
    public void onStart(LifecycleOwner lifecycleOwner) {
        this.contentCaptureSession = (ContentCaptureSessionCompat) this.onContentCaptureSession.mo2224invoke();
