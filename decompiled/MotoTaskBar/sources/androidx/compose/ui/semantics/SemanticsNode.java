...
public final class SemanticsNode {
    ...
    private final void emitFakeNodes(List list) {
        ...
        if (role != null && this.unmergedConfig.isMergingSemanticsOfDescendants() && !list.isEmpty()) {
            list.add(m749fakeSemanticsNodeypyhhiA(role, new Function1() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                {
                    super(1);
                }
                ...
                public final void invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    SemanticsPropertiesKt.m753setRolekuIjeqM(semanticsPropertyReceiver, role.m739unboximpl());
                }
            }));
        }
        ...
        if (semanticsConfiguration.contains(semanticsProperties.getContentDescription()) && !list.isEmpty() && this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            ...
            if (str != null) {
                list.add(0, m749fakeSemanticsNodeypyhhiA(null, new Function1() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
    ...
    private final SemanticsNode m749fakeSemanticsNodeypyhhiA(Role role, Function1 function1) {
    ...
    private final void fillOneLayerOfSemanticsWrappers(LayoutNode layoutNode, List list, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (layoutNode2.isAttached() && (z || !layoutNode2.isDeactivated())) {
                if (layoutNode2.getNodes$ui_release().m623hasH91voCI$ui_release(NodeKind.m658constructorimpl(8))) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        ...
        return DelegatableNodeKt.m562requireCoordinator64DMado(outerMergingSemantics, NodeKind.m658constructorimpl(8));
    }
    ...
    public final Rect getBoundsInParent$ui_release() {
        ...
        if (nodeCoordinatorFindCoordinatorToGetBounds$ui_release != null) {
            ...
            if (nodeCoordinatorFindCoordinatorToGetBounds$ui_release != null && (coordinates = nodeCoordinatorFindCoordinatorToGetBounds$ui_release.getCoordinates()) != null) {
                return LayoutCoordinates.localBoundingBoxOf$default(DelegatableNodeKt.m562requireCoordinator64DMado(parent.outerSemanticsNode, NodeKind.m658constructorimpl(8)), coordinates, false, 2, null);
            }
        }
        return Rect.Companion.getZero();
    }
    ...
    public final SemanticsNode getParent() {
        ...
        if (parent$ui_release == null) {
            ...
            while (true) {
                ...
                if (parent$ui_release.getNodes$ui_release().m623hasH91voCI$ui_release(NodeKind.m658constructorimpl(8))) {
                    break;
                }
                parent$ui_release = parent$ui_release.getParent$ui_release();
            }
    ...
    public final long m750getPositionInRootF1C5BW0() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (nodeCoordinatorFindCoordinatorToGetBounds$ui_release != null) {
            if (!nodeCoordinatorFindCoordinatorToGetBounds$ui_release.isAttached()) {
                nodeCoordinatorFindCoordinatorToGetBounds$ui_release = null;
        ...
        return Offset.Companion.m195getZeroF1C5BW0();
    }
    ...
    public final long m751getSizeYbymL2g() {
        NodeCoordinator nodeCoordinatorFindCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        return nodeCoordinatorFindCoordinatorToGetBounds$ui_release != null ? nodeCoordinatorFindCoordinatorToGetBounds$ui_release.mo531getSizeYbymL2g() : IntSize.Companion.m1014getZeroYbymL2g();
    }
