...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m591getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m614getLastConstraintsDWUhwKw();
    }

    /* JADX INFO: renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m592getLastLookaheadConstraintsDWUhwKw() {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            return lookaheadPassDelegate.m603getLastConstraintsDWUhwKw();
        }
        return null;
    }
    ...
    public final void m593performLookaheadMeasureBRTryo0$ui_release(long j) {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            lookaheadPassDelegate.m604performMeasureBRTryo0$ui_release(j);
        }
    }
