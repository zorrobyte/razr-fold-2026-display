...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope {
    ...
    private final void initializeModifier(boolean z) {
        ...
        NodeKind.m658constructorimpl(32);
        getKindSet$ui_release();
        if ((NodeKind.m658constructorimpl(4) & getKindSet$ui_release()) != 0 && !z) {
            LayoutModifierNodeKt.invalidateLayer(this);
        }
        if ((NodeKind.m658constructorimpl(2) & getKindSet$ui_release()) != 0) {
        ...
        NodeKind.m658constructorimpl(128);
        getKindSet$ui_release();
        NodeKind.m658constructorimpl(256);
        getKindSet$ui_release();
        NodeKind.m658constructorimpl(16);
        getKindSet$ui_release();
        if ((NodeKind.m658constructorimpl(8) & getKindSet$ui_release()) != 0) {
    ...
    public void applyFocusProperties(FocusProperties focusProperties) {
        ...
        ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(element);
    ...
    public MeasureResult mo554measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Modifier.Element element = this.element;
        element.getClass();
        ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(element);
        throw null;
