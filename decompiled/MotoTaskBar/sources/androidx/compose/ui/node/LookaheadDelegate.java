...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    private final void m597placeSelfgyyYBs(long j) {
        if (!IntOffset.m996equalsimpl0(mo594getPositionnOccac(), j)) {
            m601setPositiongyyYBs(j);
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m547setMeasuredSizeozmzZPI(IntSize.m1008constructorimpl((((long) measureResult.getHeight()) & 4294967295L) | (((long) measureResult.getWidth()) << 32)));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m547setMeasuredSizeozmzZPI(IntSize.Companion.m1014getZeroYbymL2g());
        }
    ...
    public final long m598getConstraintsmsEJaDk$ui_release() {
    ...
    public final void mo546placeAtf8xVGno(long j, float f, Function1 function1) {
        m597placeSelfgyyYBs(j);
    ...
    public final void m599placeSelfApparentToRealOffsetgyyYBs$ui_release(long j) {
        m597placeSelfgyyYBs(IntOffset.m1000plusqkQi6aY(j, m542getApparentToRealOffsetnOccac()));
    }

    /* JADX INFO: renamed from: positionIn-iSbpLlY$ui_release, reason: not valid java name */
    public final long m600positionIniSbpLlY$ui_release(LookaheadDelegate lookaheadDelegate, boolean z) {
        long jM1002getZeronOccac = IntOffset.Companion.m1002getZeronOccac();
        while (!Intrinsics.areEqual(this, lookaheadDelegate)) {
            if (!this.isPlacedUnderMotionFrameOfReference() || !z) {
                jM1002getZeronOccac = IntOffset.m1000plusqkQi6aY(jM1002getZeronOccac, this.mo594getPositionnOccac());
            }
            NodeCoordinator wrappedBy$ui_release = this.coordinator.getWrappedBy$ui_release();
        ...
        return jM1002getZeronOccac;
    }

    @Override // androidx.compose.ui.node.LookaheadCapablePlaceable
    public void replace$ui_release() {
        mo546placeAtf8xVGno(mo594getPositionnOccac(), 0.0f, (Function1) null);
    }

    /* JADX INFO: renamed from: setPosition--gyyYBs, reason: not valid java name */
    public void m601setPositiongyyYBs(long j) {
        this.position = j;
    }
}
