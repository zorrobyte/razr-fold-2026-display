...
public abstract class NodeKindKt {
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m658constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m562requireCoordinator64DMado(node, NodeKind.m658constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m658constructorimpl(128) & i) != 0 && (node instanceof LayoutAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m658constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateOnPositioned$ui_release();
            }
            if ((NodeKind.m658constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m658constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).setSemanticsInvalidated$ui_release(true);
            }
            if ((NodeKind.m658constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m658constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m658constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        int iM658constructorimpl = NodeKind.m658constructorimpl(1);
        return element instanceof BringIntoViewModifierNode ? NodeKind.m658constructorimpl(524288) | iM658constructorimpl : iM658constructorimpl;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        if (node instanceof LayoutModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(256);
        }
        if (node instanceof FocusTargetNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(32768);
        }
        if (node instanceof TraversableNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(262144);
        }
        if (node instanceof BringIntoViewModifierNode) {
            iM658constructorimpl |= NodeKind.m658constructorimpl(524288);
        }
        mutableObjectIntMap.set(objClassKeyForObject, iM658constructorimpl);
        return iM658constructorimpl;
    }
    ...
    public static final boolean m659getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m658constructorimpl(128)) != 0;
    }
