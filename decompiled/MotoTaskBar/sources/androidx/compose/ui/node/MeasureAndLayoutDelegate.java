...
public final class MeasureAndLayoutDelegate {
    ...
    private final boolean m609doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        if (layoutNode.getLookaheadRoot$ui_release() == null) {
            return false;
        }
        boolean zM580lookaheadRemeasure_Sx5XlM$ui_release = constraints != null ? layoutNode.m580lookaheadRemeasure_Sx5XlM$ui_release(constraints) : LayoutNode.m573lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM580lookaheadRemeasure_Sx5XlM$ui_release && parent$ui_release != null) {
            if (parent$ui_release.getLookaheadRoot$ui_release() == null) {
                ...
                return zM580lookaheadRemeasure_Sx5XlM$ui_release;
            }
    ...
    private final boolean m610doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM581remeasure_Sx5XlM$ui_release = constraints != null ? layoutNode.m581remeasure_Sx5XlM$ui_release(constraints) : LayoutNode.m574remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM581remeasure_Sx5XlM$ui_release && parent$ui_release != null) {
            if (layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                LayoutNode.requestRemeasure$ui_release$default(parent$ui_release, false, false, false, 3, null);
                return zM581remeasure_Sx5XlM$ui_release;
            }
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean z, boolean z2) {
        ...
        boolean zM609doLookaheadRemeasuresdFAvZA;
        ...
        if (z) {
            zM609doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m609doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            if (z2 && ((zM609doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual(layoutNode.isPlacedInLookahead(), Boolean.TRUE))) {
                layoutNode.lookaheadReplace$ui_release();
            }
        } else {
            boolean zM610doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m610doRemeasuresdFAvZA(layoutNode, constraints) : false;
            ...
            zM609doLookaheadRemeasuresdFAvZA = zM610doRemeasuresdFAvZA;
        }
        drainPostponedMeasureRequests();
        return zM609doLookaheadRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean z) {
        ...
        if (z) {
            m609doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m610doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
    ...
    public final void m611updateRootConstraintsBRTryo0(long j) {
        ...
        this.rootConstraints = Constraints.m973boximpl(j);
        if (this.root.getLookaheadRoot$ui_release() != null) {
