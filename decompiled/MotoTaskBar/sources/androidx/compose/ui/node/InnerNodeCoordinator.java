...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo537measureBRTryo0(long j) {
            ...
            set_measureResult(getLayoutNode().getMeasurePolicy().mo538measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), j));
            return this;
        }
    ...
    static {
        ...
        Paint.mo225setColor8_81llA(Color.Companion.m289getRed0d7_KjU());
    ...
    public void mo569hitTestChildqzLsGqo(NodeCoordinator.HitTestSource hitTestSource, long j, HitTestResult hitTestResult, int i, boolean z) {
        ...
        if (hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            if (m648withinLayerBoundsk4lQ0M(j)) {
                z2 = true;
            } else if (PointerType.m515equalsimpl0(i, PointerType.Companion.m521getTouchT8wyACA()) && (Float.floatToRawIntBits(m638distanceInMinimumTouchTargettz77jQw(j, m641getMinimumTouchTargetSizeNHjbRc())) & Integer.MAX_VALUE) < 2139095040) {
                z = false;
                z2 = true;
            }
        }
        if (z2) {
            ...
            while (size >= 0) {
                ...
                if (layoutNode.isPlaced()) {
                    ...
                    hitTestSource2.mo649childHitTestqzLsGqo(layoutNode, j, hitTestResult, i, z);
    ...
    public Placeable mo537measureBRTryo0(long j) {
        if (getForceMeasureWithLookaheadConstraints$ui_release()) {
            ...
            j = lookaheadDelegate.m598getConstraintsmsEJaDk$ui_release();
        }
        m548setMeasurementConstraintsBRTryo0(j);
        MutableVector mutableVector = getLayoutNode().get_children$ui_release();
        Object[] objArr = mutableVector.content;
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo538measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), j));
        onMeasured();
        return this;
    }
