...
public interface FocusOwner extends FocusManager {
    ...
    static /* synthetic */ boolean m135dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        return focusOwner.mo138dispatchKeyEventYhN2O0w(keyEvent, function0);
    }

    /* JADX INFO: renamed from: clearFocus-I7lrPNg, reason: not valid java name */
    boolean mo136clearFocusI7lrPNg(boolean z, boolean z2, boolean z3, int i);

    /* JADX INFO: renamed from: dispatchInterceptedSoftKeyboardEvent-ZmokQxo, reason: not valid java name */
    boolean mo137dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* JADX INFO: renamed from: dispatchKeyEvent-YhN2O0w, reason: not valid java name */
    boolean mo138dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0 function0);
    ...
    Boolean mo139focusSearchULY8qGw(int i, Rect rect, Function1 function1);
    ...
    boolean mo140requestFocusForOwner7o62pno(FocusDirection focusDirection, Rect rect);
