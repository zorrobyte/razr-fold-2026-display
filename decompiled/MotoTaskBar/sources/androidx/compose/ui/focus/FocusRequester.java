...
public final class FocusRequester {
    ...
    public static /* synthetic */ boolean m145requestFocus3ESFkO8$default(FocusRequester focusRequester, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = FocusDirection.Companion.m125getEnterdhqQ8s();
        }
        return focusRequester.m146requestFocus3ESFkO8(i);
    }
    ...
    */
    public final boolean findFocusTargetNode$ui_release(kotlin.jvm.functions.Function1 r10) {
        /*
    ...
    public final boolean m146requestFocus3ESFkO8(final int i) {
        return findFocusTargetNode$ui_release(new Function1() { // from class: androidx.compose.ui.focus.FocusRequester$requestFocus$1
            ...
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                return Boolean.valueOf(focusTargetNode.m148requestFocus3ESFkO8(i));
            }
        });
    }
}
