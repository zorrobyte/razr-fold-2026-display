...
public abstract class TwoDimensionalFocusSearchKt {
    ...
    private static final boolean m168beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        ...
        return FocusDirection.m120equalsimpl0(i, companion.m127getLeftdhqQ8s()) || FocusDirection.m120equalsimpl0(i, companion.m130getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }

    private static final boolean beamBeats_I7lrPNg$inSourceBeam(Rect rect, int i, Rect rect2) {
        FocusDirection.Companion companion = FocusDirection.Companion;
        if (FocusDirection.m120equalsimpl0(i, companion.m127getLeftdhqQ8s()) ? true : FocusDirection.m120equalsimpl0(i, companion.m130getRightdhqQ8s())) {
            return rect.getBottom() > rect2.getTop() && rect.getTop() < rect2.getBottom();
        }
        if (FocusDirection.m120equalsimpl0(i, companion.m131getUpdhqQ8s()) ? true : FocusDirection.m120equalsimpl0(i, companion.m124getDowndhqQ8s())) {
    ...
    */
    private static final float beamBeats_I7lrPNg$majorAxisDistance$6(androidx.compose.ui.geometry.Rect r2, int r3, androidx.compose.ui.geometry.Rect r4) {
        /*
            ...
            int r1 = r0.m127getLeftdhqQ8s()
            boolean r1 = androidx.compose.ui.focus.FocusDirection.m120equalsimpl0(r3, r1)
            if (r1 == 0) goto L16
            float r3 = r4.getLeft()
        ...
        L2b:
            ...
            goto L14
        L3e:
            int r0 = r0.m124getDowndhqQ8s()
            boolean r3 = androidx.compose.ui.focus.FocusDirection.m120equalsimpl0(r3, r0)
            if (r3 == 0) goto L58
            float r2 = r2.getTop()
    ...
    */
    ...
    private static final FocusTargetNode m169findBestCandidate4WY_MpI(MutableVector mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        FocusDirection.Companion companion = FocusDirection.Companion;
        if (FocusDirection.m120equalsimpl0(i, companion.m127getLeftdhqQ8s())) {
            rectTranslate = rect.translate((rect.getRight() - rect.getLeft()) + 1, 0.0f);
        } else if (FocusDirection.m120equalsimpl0(i, companion.m130getRightdhqQ8s())) {
            rectTranslate = rect.translate(-((rect.getRight() - rect.getLeft()) + 1), 0.0f);
        } else if (FocusDirection.m120equalsimpl0(i, companion.m131getUpdhqQ8s())) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                ...
                if (m172isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    public static final boolean m170findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1 function1) {
        ...
        if (FocusDirection.m120equalsimpl0(i, companion.m125getEnterdhqQ8s())) {
            i = companion.m130getRightdhqQ8s();
        }
        if (FocusDirection.m120equalsimpl0(i, companion.m130getRightdhqQ8s()) ? true : FocusDirection.m120equalsimpl0(i, companion.m124getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            if (!(FocusDirection.m120equalsimpl0(i, companion.m127getLeftdhqQ8s()) ? true : FocusDirection.m120equalsimpl0(i, companion.m131getUpdhqQ8s()))) {
                throw new IllegalStateException("This function should only be used for 2-D focus search");
            }
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        }
        FocusTargetNode focusTargetNodeM169findBestCandidate4WY_MpI = m169findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM169findBestCandidate4WY_MpI != null) {
            return ((Boolean) function1.invoke(focusTargetNodeM169findBestCandidate4WY_MpI)).booleanValue();
        }
        return false;
    }

    /* JADX INFO: renamed from: generateAndSearchChildren-4C6V_qg, reason: not valid java name */
    private static final boolean m171generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final Rect rect, final int i, final Function1 function1) {
        if (m173searchChildren4C6V_qg(focusTargetNode, rect, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m116searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                ...
                boolean zM173searchChildren4C6V_qg = TwoDimensionalFocusSearchKt.m173searchChildren4C6V_qg(focusTargetNode, rect, i, function1);
                Boolean boolValueOf = Boolean.valueOf(zM173searchChildren4C6V_qg);
                if (zM173searchChildren4C6V_qg || !beyondBoundsScope.getHasMoreContent()) {
                    return boolValueOf;
                }
                return null;
            }
    ...
    public static final boolean m172isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (!isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return false;
        }
        if (isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) && !m168beamBeatsI7lrPNg(rect3, rect, rect2, i)) {
            return !m168beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2);
        }
        return true;
    }
    ...
    */
    ...
    public static final boolean m173searchChildren4C6V_qg(FocusTargetNode focusTargetNode, Rect rect, int i, Function1 function1) {
        FocusTargetNode focusTargetNodeM169findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        int iM658constructorimpl = NodeKind.m658constructorimpl(1024);
        ...
        while (mutableVector.getSize() != 0 && (focusTargetNodeM169findBestCandidate4WY_MpI = m169findBestCandidate4WY_MpI(mutableVector, rect, i)) != null) {
            if (focusTargetNodeM169findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return ((Boolean) function1.invoke(focusTargetNodeM169findBestCandidate4WY_MpI)).booleanValue();
            }
            if (m171generateAndSearchChildren4C6V_qg(focusTargetNodeM169findBestCandidate4WY_MpI, rect, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM169findBestCandidate4WY_MpI);
        }
        return false;
    }
    ...
    public static final Boolean m174twoDimensionalFocusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i, Rect rect, Function1 function1) {
        FocusStateImpl focusState = focusTargetNode.getFocusState();
        int[] iArr = WhenMappings.$EnumSwitchMapping$0;
        int i2 = iArr[focusState.ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m170findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 == 4) {
                return focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() ? (Boolean) function1.invoke(focusTargetNode) : rect == null ? Boolean.valueOf(m170findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1)) : Boolean.valueOf(m173searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
            }
        ...
        if (i3 == 1) {
            Boolean boolM174twoDimensionalFocusSearchsMXa3k8 = m174twoDimensionalFocusSearchsMXa3k8(activeChild, i, rect, function1);
            if (!Intrinsics.areEqual(boolM174twoDimensionalFocusSearchsMXa3k8, Boolean.FALSE)) {
                return boolM174twoDimensionalFocusSearchsMXa3k8;
            }
            if (rect == null) {
                rect = FocusTraversalKt.focusRect(activeNode(activeChild));
            }
            return Boolean.valueOf(m171generateAndSearchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        if (i3 == 2 || i3 == 3) {
            if (rect == null) {
