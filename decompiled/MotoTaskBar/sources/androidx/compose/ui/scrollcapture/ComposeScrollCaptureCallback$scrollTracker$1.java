...
final class ComposeScrollCaptureCallback$scrollTracker$1 extends SuspendLambda implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            long jM192unboximpl = ((Offset) obj).m192unboximpl();
            return Boxing.boxFloat(z ? -Float.intBitsToFloat((int) (jM192unboximpl & 4294967295L)) : Float.intBitsToFloat((int) (jM192unboximpl & 4294967295L)));
        }
        ResultKt.throwOnFailure(obj);
        ...
        ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(this.this$0.node.getUnmergedConfig$ui_release().get(SemanticsProperties.INSTANCE.getVerticalScrollAxisRange()));
        throw null;
    }
}
