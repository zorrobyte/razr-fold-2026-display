...
public final class RecordingInputConnection implements InputConnection {
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m814getMinimpl(this.mTextFieldValue.m873getSelectiond9O1mEE()), i);
    }
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m811getCollapsedimpl(this.mTextFieldValue.m873getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public boolean performEditorAction(int i) {
        ...
        if (i != 0) {
            switch (i) {
                case 2:
                    iM840getDefaulteUduSuo = ImeAction.Companion.m842getGoeUduSuo();
                    break;
                case 3:
                    iM840getDefaulteUduSuo = ImeAction.Companion.m846getSearcheUduSuo();
                    break;
                case 4:
                    iM840getDefaulteUduSuo = ImeAction.Companion.m847getSendeUduSuo();
                    break;
                case 5:
                    iM840getDefaulteUduSuo = ImeAction.Companion.m843getNexteUduSuo();
                    break;
                case 6:
                    iM840getDefaulteUduSuo = ImeAction.Companion.m841getDoneeUduSuo();
                    break;
                case 7:
                    iM840getDefaulteUduSuo = ImeAction.Companion.m845getPreviouseUduSuo();
                    break;
                default:
                    Log.w("RecordingIC", "IME sends unsupported Editor Action: " + i);
                    iM840getDefaulteUduSuo = ImeAction.Companion.m840getDefaulteUduSuo();
                    break;
            }
        } else {
            iM840getDefaulteUduSuo = ImeAction.Companion.m840getDefaulteUduSuo();
        }
        this.eventCallback.mo851onImeActionKlQnJC8(iM840getDefaulteUduSuo);
        return true;
    }
    ...
    public boolean requestCursorUpdates(int i) {
        ...
        this.eventCallback.onRequestCursorAnchorInfo(z6, z7, z4, z2, z3, z);
        return true;
    }
