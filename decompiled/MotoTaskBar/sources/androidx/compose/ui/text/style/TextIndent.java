...
public final class TextIndent {
    ...
    public boolean equals(Object obj) {
        ...
        return TextUnit.m1020equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m1020equalsimpl0(this.restLine, textIndent.restLine);
    }

    /* JADX INFO: renamed from: getFirstLine-XSAIIZE, reason: not valid java name */
    public final long m961getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* JADX INFO: renamed from: getRestLine-XSAIIZE, reason: not valid java name */
    public final long m962getRestLineXSAIIZE() {
        return this.restLine;
    }

    public int hashCode() {
        return (TextUnit.m1024hashCodeimpl(this.firstLine) * 31) + TextUnit.m1024hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m1025toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m1025toStringimpl(this.restLine)) + ')';
    }
}
