...
public abstract class AndroidFontUtils_androidKt {
    ...
    public static final int m821getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m824equalsimpl0(i, FontStyle.Companion.m825getItalic_LCdwA()));
    }
}
