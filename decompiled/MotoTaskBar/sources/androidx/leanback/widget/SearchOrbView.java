...
public class SearchOrbView extends FrameLayout implements View.OnClickListener {
    ...
    /* JADX INFO: renamed from: $r8$lambda$_3kGQ2M5dXeY00hz39i66M9_r-g, reason: not valid java name */
    public static /* synthetic */ void m1090$r8$lambda$_3kGQ2M5dXeY00hz39i66M9_rg(SearchOrbView searchOrbView, ValueAnimator valueAnimator) {
        searchOrbView.getClass();
        searchOrbView.setSearchOrbZ(valueAnimator.getAnimatedFraction());
    }

    public static /* synthetic */ void $r8$lambda$ei7gfRzTteqZ5QRdXqNV9v5wVe0(SearchOrbView searchOrbView, ValueAnimator valueAnimator) {
        searchOrbView.getClass();
    ...
    public SearchOrbView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.leanback.widget.SearchOrbView$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                SearchOrbView.$r8$lambda$ei7gfRzTteqZ5QRdXqNV9v5wVe0(this.f$0, valueAnimator);
            }
        };
        this.mFocusUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.leanback.widget.SearchOrbView$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                SearchOrbView.m1090$r8$lambda$_3kGQ2M5dXeY00hz39i66M9_rg(this.f$0, valueAnimator);
            }
        };
        ...
        int color = typedArrayObtainStyledAttributes.getColor(androidx.leanback.R$styleable.lbSearchOrbView_searchOrbColor, resources.getColor(R$color.lb_default_search_color));
