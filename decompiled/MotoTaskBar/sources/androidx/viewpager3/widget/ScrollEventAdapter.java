...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    ScrollEventAdapter(ViewPager3 viewPager3) {
        this.mViewPager = viewPager3;
        RecyclerView recyclerView = viewPager3.mRecyclerView;
    ...
    private void dispatchScrolled(int i, float f, int i2) {
        ViewPager3.OnPageChangeCallback onPageChangeCallback = this.mCallback;
    ...
    */
    public void onScrolled(androidx.recyclerview.widget.RecyclerView r4, int r5, int r6) {
        ...
        L16:
            r5 = r2
        L17:
            androidx.viewpager3.widget.ViewPager3 r6 = r3.mViewPager
            boolean r6 = r6.isRtl()
            if (r5 != r6) goto L29
        L1f:
            androidx.viewpager3.widget.ScrollEventAdapter$ScrollEventValues r5 = r3.mScrollValues
            int r6 = r5.mOffsetPx
            if (r6 == 0) goto L29
            int r5 = r5.mPosition
            int r5 = r5 + r4
        ...
        L6b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.viewpager3.widget.ScrollEventAdapter.onScrolled(androidx.recyclerview.widget.RecyclerView, int, int):void");
    }

    void setOnPageChangeCallback(ViewPager3.OnPageChangeCallback onPageChangeCallback) {
