...
public abstract class ProfileInstaller {
    private static final String PROFILE_BASE_DIR = "/data/misc/profiles/cur/" + UserInfo.getCurrentUserId();
    ...
    private static boolean transcodeAndWrite(AssetManager assetManager, String str, PackageInfo packageInfo, File file, String str2, Executor executor, DiagnosticsCallback diagnosticsCallback) {
        DeviceProfileWriter deviceProfileWriter = new DeviceProfileWriter(assetManager, executor, diagnosticsCallback, str2, "dexopt/baseline.prof", "dexopt/baseline.profm", new File(new File(PROFILE_BASE_DIR, str), "primary.prof"));
