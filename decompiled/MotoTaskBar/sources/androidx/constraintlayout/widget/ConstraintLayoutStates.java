...
public class ConstraintLayoutStates {
    ...
    */
    ...
    public void updateConstraints(int i, float f, float f2) {
        ...
        if (i2 == i) {
            State state = i == -1 ? (State) this.mStateList.valueAt(0) : (State) this.mStateList.get(i2);
            ...
            if ((i3 == -1 || !((Variant) state.mVariants.get(i3)).match(f, f2)) && this.mCurrentConstraintNumber != (iFindMatch = state.findMatch(f, f2))) {
                ConstraintSet constraintSet = iFindMatch == -1 ? this.mDefaultConstraintSet : ((Variant) state.mVariants.get(iFindMatch)).mConstraintSet;
                if (iFindMatch != -1) {
        ...
        ConstraintSet constraintSet2 = iFindMatch2 == -1 ? state2.mConstraintSet : ((Variant) state2.mVariants.get(iFindMatch2)).mConstraintSet;
        if (iFindMatch2 != -1) {
