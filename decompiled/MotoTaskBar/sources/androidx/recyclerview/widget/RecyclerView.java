...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    public abstract class ItemAnimator {
        ...
        public final void dispatchAnimationsFinished() {
            if (this.mFinishedListeners.size() <= 0) {
                ...
                ActivityResultRegistry$$ExternalSyntheticThrowCCEIfNotNull0.m(this.mFinishedListeners.get(0));
                throw null;
            }
        }
    ...
    private void dispatchLayoutStep3() {
        ...
        ArrayList arrayList = recyclerView.mRecycler.mChangedScrap;
        if (arrayList != null) {
            arrayList.clear();
        }
    ...
    private void nestedScrollByInternal(int i, int i2, int i3, int i4, MotionEvent motionEvent, int i5) {
        ...
        boolean zCanScrollHorizontally = layoutManager.canScrollHorizontally();
        boolean zCanScrollVertically = this.mLayout.canScrollVertically();
        int i6 = zCanScrollVertically ? (zCanScrollHorizontally ? 1 : 0) | 2 : zCanScrollHorizontally ? 1 : 0;
        ...
        if (dispatchNestedPreScroll(zCanScrollHorizontally ? iReleaseHorizontalGlow : 0, zCanScrollVertically ? iReleaseVerticalGlow : 0, this.mReusableIntPair, this.mScrollOffset, i5)) {
            int[] iArr2 = this.mReusableIntPair;
            iReleaseHorizontalGlow -= iArr2[0];
            iReleaseVerticalGlow -= iArr2[1];
        }
        scrollByInternal(zCanScrollHorizontally ? iReleaseHorizontalGlow : 0, zCanScrollVertically ? iReleaseVerticalGlow : 0, i3, i4, motionEvent, i5);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void pullGlows(android.view.MotionEvent r8, float r9, int r10, float r11, float r12, int r13, float r14) {
        /*
            r7 = this;
            r0 = 0
            ...
            if (r1 >= 0) goto L33
            r7.ensureLeftGlow()
            android.widget.EdgeEffect r1 = r7.mLeftGlow
            float r5 = -r11
            int r6 = r7.getWidth()
            float r6 = (float) r6
            float r5 = r5 / r6
            ...
            float r12 = r12 / r6
            float r12 = r2 - r12
            androidx.core.widget.EdgeEffectCompat.onPullDistance(r1, r5, r12)
            if (r8 == 0) goto L31
            androidx.core.view.ScrollFeedbackProviderCompat r12 = r7.getScrollFeedbackProvider()
            int r1 = r8.getDeviceId()
            int r5 = r8.getSource()
            r12.onScrollLimit(r1, r5, r10, r3)
        L31:
            r10 = r3
            goto L5f
        L33:
            ...
            if (r1 <= 0) goto L5e
            r7.ensureRightGlow()
            android.widget.EdgeEffect r1 = r7.mRightGlow
            int r5 = r7.getWidth()
            float r5 = (float) r5
            float r5 = r11 / r5
            int r6 = r7.getHeight()
            ...
            int r1 = r8.getDeviceId()
            int r5 = r8.getSource()
            r12.onScrollLimit(r1, r5, r10, r4)
            goto L31
        L5e:
            r10 = r4
        L5f:
            ...
            float r1 = (float) r1
            float r9 = r9 / r1
            androidx.core.widget.EdgeEffectCompat.onPullDistance(r10, r12, r9)
            if (r8 == 0) goto Lb7
            androidx.core.view.ScrollFeedbackProviderCompat r9 = r7.getScrollFeedbackProvider()
            int r10 = r8.getDeviceId()
            int r8 = r8.getSource()
            r9.onScrollLimit(r10, r8, r13, r3)
            goto Lb7
        L8a:
            int r12 = (r14 > r0 ? 1 : (r14 == r0 ? 0 : -1))
            if (r12 <= 0) goto Lb6
            ...
            float r9 = r9 / r1
            float r2 = r2 - r9
            androidx.core.widget.EdgeEffectCompat.onPullDistance(r10, r12, r2)
            if (r8 == 0) goto Lb7
            androidx.core.view.ScrollFeedbackProviderCompat r9 = r7.getScrollFeedbackProvider()
            int r10 = r8.getDeviceId()
            int r8 = r8.getSource()
            r9.onScrollLimit(r10, r8, r13, r4)
            goto Lb7
        Lb6:
            r3 = r10
        Lb7:
        ...
        Lc3:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.pullGlows(android.view.MotionEvent, float, int, float, float, int, float):void");
    }
    ...
    */
    public boolean onGenericMotionEvent(android.view.MotionEvent r11) {
        /*
            r10 = this;
            androidx.recyclerview.widget.RecyclerView$LayoutManager r1 = r10.mLayout
            r7 = 0
            if (r1 != 0) goto L6
            return r7
        L6:
            boolean r1 = r10.mLayoutSuppressed
            if (r1 == 0) goto Lb
            return r7
        Lb:
        ...
        L2c:
            ...
            r1 = r7
        L2e:
            androidx.recyclerview.widget.RecyclerView$LayoutManager r4 = r10.mLayout
            boolean r4 = r4.canScrollHorizontally()
            if (r4 == 0) goto L45
            r2 = 10
            float r4 = r11.getAxisValue(r2)
            r5 = r3
            r3 = r2
            r2 = r5
            r5 = r4
        ...
        L76:
            ...
            r3 = r2
        L7a:
            boolean r8 = r10.mLowResRotaryEncoderFeature
            r9 = r4
            r4 = r2
            r2 = r9
            r9 = r8
        ...
        L82:
            ...
            goto L4a
        L87:
            float r1 = r10.mScaledVerticalScrollFactor
            float r2 = r2 * r1
            int r2 = (int) r2
            float r1 = r10.mScaledHorizontalScrollFactor
            float r5 = r5 * r1
            int r1 = (int) r5
            if (r9 == 0) goto Lb2
            androidx.recyclerview.widget.RecyclerView$ViewFlinger r3 = r10.mViewFlinger
            android.widget.OverScroller r3 = r3.mOverScroller
            int r4 = r3.getFinalY()
            int r5 = r3.getCurrY()
            int r4 = r4 - r5
            int r2 = r2 + r4
        ...
        Lb2:
            ...
            r0 = r10
            r5 = r11
            r0.nestedScrollByInternal(r1, r2, r3, r4, r5, r6)
        Lb8:
            if (r8 == 0) goto Lc1
            if (r9 != 0) goto Lc1
            androidx.core.view.DifferentialMotionFlingController r0 = r10.mDifferentialMotionFlingController
            r0.onMotionEvent(r11, r8)
        Lc1:
            return r7
        */
    ...
    /* JADX WARN: Removed duplicated region for block: B:47:0x00df A[PHI: r1
      0x00df: PHI (r1v45 int) = (r1v25 int), (r1v49 int) binds: [B:41:0x00c8, B:45:0x00db] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void scrollBy(int i, int i2) {
        ...
        if (zCanScrollHorizontally || zCanScrollVertically) {
            scrollByInternal(zCanScrollHorizontally ? i : 0, zCanScrollVertically ? i2 : 0, -1, -1, null, 0);
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    boolean scrollByInternal(int r18, int r19, int r20, int r21, android.view.MotionEvent r22, int r23) {
        /*
            Method dump skipped, instruction units count: 241
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.scrollByInternal(int, int, int, int, android.view.MotionEvent, int):boolean");
    }
