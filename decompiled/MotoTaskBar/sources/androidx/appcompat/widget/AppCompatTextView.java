...
public class AppCompatTextView extends TextView {
    ...
    abstract class SuperCallerApi26 implements SuperCaller {
        SuperCallerApi26() {
        }
    ...
    abstract class SuperCallerApi28 extends SuperCallerApi26 {
        SuperCallerApi28() {
            super();
        }
    ...
    public boolean setFontVariationSettings(String str) {
        ...
        Typeface typefaceCreateVariationInstance = AppCompatTextHelper.Api26Impl.createVariationInstance(typeface, str);
    ...
    public void setTypeface(Typeface typeface, int i) {
        ...
        if (typeface != null && i > 0) {
            typeface = TypefaceCompat.create(getContext(), typeface, i);
        }
